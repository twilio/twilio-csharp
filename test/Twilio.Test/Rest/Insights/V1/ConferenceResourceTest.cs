    ...
    public class ConferenceTest : TwilioTest
    {
        ...
        public void TestFetchResponse()
        {
            ...
            twilioRestClient.Request(Arg.Any<Request>())
                            .Returns(new Response(
                                         ...
                                         "{\"conference_sid\": \"CFaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"account_sid\": \"ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"friendly_name\": \"conference1\",\"start_time\": \"2021-10-08T02:58:51Z\",\"create_time\": \"2021-10-08T02:58:47Z\",\"end_time\": \"2021-10-08T03:00:02Z\",\"duration_seconds\": 76,\"connect_duration_seconds\": 72,\"status\": \"completed\",\"max_participants\": 250,\"max_concurrent_participants\": 4,\"unique_participants\": 4,\"end_reason\": \"last_participant_left\",\"ended_by\": \"CAaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"mixer_region\": \"us1\",\"mixer_region_requested\": \"us1\",\"recording_enabled\": false,\"processing_state\": \"complete\",\"detected_issues\": {\"call_quality\": 1,\"region_configuration\": 0,\"participant_behavior\": 3},\"tags\": [\"duplicate_identity\",\"detected_silence\",\"participant_behavior_issues\"],\"tag_info\": {\"duplicate_identity\": [{\"participant_identity\": \"client:+10000000000\",\"participant_sids\": [\"CPaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"CPaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaab\"]}]},\"url\": \"https://insights.twilio.com/v1/Conferences/CFaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"links\": {\"conference_participants\": \"https://insights.twilio.com/v1/Conferences/CFaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/Participants\"}}"
                                     ));
        ...
        public void TestReadWithDuplicateIdentityResponse()
        {
            ...
            twilioRestClient.Request(Arg.Any<Request>())
                            .Returns(new Response(
                                         System.Net.HttpStatusCode.OK,
                                         "{\"meta\": {\"page\": 0,\"page_size\": 25,\"first_page_url\": \"https://insights.twilio.com/v1/Conferences?Tags=duplicate_identity&PageSize=25&Page=0\",\"previous_page_url\": null,\"url\": \"https://insights.twilio.com/v1/Conferences?Tags=duplicate_identity&PageSize=25&Page=0\",\"next_page_url\": null,\"key\": \"conferences\"},\"conferences\": [{\"conference_sid\": \"CFaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"account_sid\": \"ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"friendly_name\": \"conference 1\",\"start_time\": \"2021-11-17T16:21:45Z\",\"create_time\": \"2021-11-17T16:21:40Z\",\"end_time\": \"2021-11-17T16:22:11Z\",\"duration_seconds\": 32,\"connect_duration_seconds\": 27,\"status\": \"not_started\",\"max_participants\": 250,\"max_concurrent_participants\": 3,\"unique_participants\": 4,\"end_reason\": \"last_participant_left\",\"ended_by\": \"CAaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"mixer_region\": \"us1\",\"mixer_region_requested\": null,\"recording_enabled\": false,\"processing_state\": \"complete\",\"detected_issues\": {\"call_quality\": 0,\"region_configuration\": 0,\"participant_behavior\": 0},\"tags\": [\"duplicate_identity\",\"detected_silence\",\"participant_behavior_issues\"],\"tag_info\": {\"duplicate_identity\": [{\"participant_identity\": \"client:+10000000000\",\"participant_sids\": [\"CPaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"CPaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaab\"]}]},\"url\": \"https://insights.twilio.com/v1/Conferences/CFaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"links\": {\"conference_participants\": \"https://insights.twilio.com/v1/Conferences/CFaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/Participants\"}}]}"
                                     ));
        ...
        public void TestReadWithDetectedIssueEndreasonResponse()
        {
            ...
            twilioRestClient.Request(Arg.Any<Request>())
                            .Returns(new Response(
                                         System.Net.HttpStatusCode.OK,
                                         "{\"meta\": {\"page\": 0,\"page_size\": 25,\"first_page_url\": \"https://insights.twilio.com/v1/Conferences?DetectedIssues=call_quality&EndReason=participant_with_end_conference_on_exit_left&PageSize=25&Page=0\",\"previous_page_url\": null,\"url\": \"https://insights.twilio.com/v1/Conferences?DetectedIssues=call_quality&EndReason=participant_with_end_conference_on_exit_left&PageSize=25&Page=0\",\"next_page_url\": null,\"key\": \"conferences\"},\"conferences\": [{\"conference_sid\": \"CFaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"account_sid\": \"ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"friendly_name\": \"conference 1\",\"start_time\": \"2021-11-17T16:21:45Z\",\"create_time\": \"2021-11-17T16:21:40Z\",\"end_time\": \"2021-11-17T16:22:11Z\",\"duration_seconds\": 32,\"connect_duration_seconds\": 27,\"status\": \"not_started\",\"max_participants\": 250,\"max_concurrent_participants\": 3,\"unique_participants\": 3,\"end_reason\": \"participant_with_end_conference_on_exit_left\",\"ended_by\": \"CAaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"mixer_region\": \"us1\",\"mixer_region_requested\": null,\"recording_enabled\": false,\"processing_state\": \"complete\",\"detected_issues\": {\"call_quality\": 3,\"region_configuration\": 0,\"participant_behavior\": 1},\"tags\": [\"high_packet_loss\",\"low_mos\",\"participant_behavior_issues\",\"quality_warnings\",\"high_jitter\",\"detected_silence\"],\"tag_info\": null,\"url\": \"https://insights.twilio.com/v1/Conferences/CFaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"links\": {\"conference_participants\": \"https://insights.twilio.com/v1/Conferences/CFaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/Participants\"}}]}"
                                     ));
