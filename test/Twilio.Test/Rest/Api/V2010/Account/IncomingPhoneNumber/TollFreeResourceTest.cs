...
namespace Twilio.Tests.Rest.Api.V2010.Account.IncomingPhoneNumber 
{
    ...
    public class TollFreeTest : TwilioTest 
    {
        ...
        public void TestReadRequest()
        {
            ...
            try
            {
                TollFreeResource.Read(client: twilioRestClient);
        ...
        public void TestReadFullResponse()
        {
            ...
            var response = TollFreeResource.Read(client: twilioRestClient);
        ...
        public void TestCreateRequest()
        {
            ...
            try
            {
                TollFreeResource.Create(new Twilio.Types.PhoneNumber("+987654321"), client: twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (ApiException) {}
            twilioRestClient.Received().Request(request);
        ...
        public void TestCreateResponse()
        {
            ...
            var response = TollFreeResource.Create(new Twilio.Types.PhoneNumber("+987654321"), client: twilioRestClient);
            Assert.NotNull(response);
        }
    }
