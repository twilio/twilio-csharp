...
namespace Twilio.Tests.Rest.Api.V2010.Account.IncomingPhoneNumber.AssignedAddOn 
{
    ...
    public class AssignedAddOnExtensionTest : TwilioTest 
    {
        ...
        public void TestFetchRequest()
        {
            ...
            try
            {
                AssignedAddOnExtensionResource.Fetch("PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "XEaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "XFaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", client: twilioRestClient);
        ...
        public void TestFetchResponse()
        {
            ...
            var response = AssignedAddOnExtensionResource.Fetch("PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "XEaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "XFaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", client: twilioRestClient);
        ...
        public void TestReadRequest()
        {
            ...
            try
            {
                AssignedAddOnExtensionResource.Read("PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "XEaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", client: twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (ApiException) {}
            twilioRestClient.Received().Request(request);
        ...
        public void TestReadFullResponse()
        {
            ...
            var response = AssignedAddOnExtensionResource.Read("PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "XEaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", client: twilioRestClient);
            Assert.NotNull(response);
        }
