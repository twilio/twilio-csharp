...
namespace Twilio.Tests.Rest.Api.V2010.Account.Recording 
{
    ...
    public class AddOnResultTest : TwilioTest 
    {
        ...
        public void TestFetchRequest()
        {
            ...
            try
            {
                AddOnResultResource.Fetch("REXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "XRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", client: twilioRestClient);
        ...
        public void TestFetchResponse()
        {
            ...
            var response = AddOnResultResource.Fetch("REXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "XRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", client: twilioRestClient);
        ...
        public void TestReadRequest()
        {
            ...
            try
            {
                AddOnResultResource.Read("REXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", client: twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (ApiException) {}
            twilioRestClient.Received().Request(request);
        ...
        public void TestReadFullResponse()
        {
            ...
            var response = AddOnResultResource.Read("REXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", client: twilioRestClient);
            Assert.NotNull(response);
        }
        ...
        public void TestDeleteRequest()
        {
            ...
            try
            {
                AddOnResultResource.Delete("REXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "XRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", client: twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (ApiException) {}
            twilioRestClient.Received().Request(request);
        ...
        public void TestDeleteResponse()
        {
            ...
            var response = AddOnResultResource.Delete("REXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "XRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", client: twilioRestClient);
            Assert.NotNull(response);
        }
    }
