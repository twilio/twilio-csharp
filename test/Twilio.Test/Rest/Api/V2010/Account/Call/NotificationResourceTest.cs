...
namespace Twilio.Tests.Rest.Api.V2010.Account.Call 
{
    ...
    public class NotificationTest : TwilioTest 
    {
        ...
        public void TestDeleteRequest()
        {
            ...
            try
            {
                NotificationResource.Delete("CAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "NOXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", client: twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (ApiException) {}
            twilioRestClient.Received().Request(request);
        ...
        public void TestDeleteResponse()
        {
            ...
            var response = NotificationResource.Delete("CAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "NOXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", client: twilioRestClient);
            Assert.NotNull(response);
        }
