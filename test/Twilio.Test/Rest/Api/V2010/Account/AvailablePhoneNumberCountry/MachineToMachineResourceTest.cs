...
namespace Twilio.Tests.Rest.Api.V2010.Account.AvailablePhoneNumberCountry
{
    ...
    public class MachineToMachineTest : TwilioTest
    {
        ...
        public void TestReadRequest()
        {
            ...
            try
            {
                MachineToMachineResource.Read("US", client: twilioRestClient);
        ...
        public void TestReadFullResponse()
        {
            ...
            var response = MachineToMachineResource.Read("US", client: twilioRestClient);
        ...
        public void TestReadEmptyResponse()
        {
            ...
            twilioRestClient.Request(Arg.Any<Request>())
                            .Returns(new Response(
                                         System.Net.HttpStatusCode.OK,
                                         "{\"available_phone_numbers\": [],\"uri\": \"/2010-04-01/Accounts/ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/AvailablePhoneNumbers/US/MachineToMachine.json\"}"
                                     ));
