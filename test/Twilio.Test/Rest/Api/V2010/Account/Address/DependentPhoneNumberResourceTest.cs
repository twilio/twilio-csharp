...
namespace Twilio.Tests.Rest.Api.V2010.Account.Address 
{
    ...
    public class DependentPhoneNumberTest : TwilioTest 
    {
        ...
        public void TestReadRequest()
        {
            ...
            try
            {
                DependentPhoneNumberResource.Read("ADXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", client: twilioRestClient);
        ...
        public void TestReadFullResponse()
        {
            ...
            var response = DependentPhoneNumberResource.Read("ADXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", client: twilioRestClient);
