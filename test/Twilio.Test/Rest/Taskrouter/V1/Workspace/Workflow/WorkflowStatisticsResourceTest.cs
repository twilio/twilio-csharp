...
namespace Twilio.Tests.Rest.Taskrouter.V1.Workspace.Workflow 
{
    ...
    public class WorkflowStatisticsTest : TwilioTest 
    {
        ...
        public void TestFetchRequest()
        {
            ...
            try
            {
                WorkflowStatisticsResource.Fetch("WSXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "WWXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", client: twilioRestClient);
