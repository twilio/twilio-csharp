...
namespace Twilio.Tests.Rest.Taskrouter.V1.Workspace.Worker 
{
    ...
    public class WorkersRealTimeStatisticsTest : TwilioTest 
    {
        ...
        public void TestFetchRequest()
        {
            ...
            try
            {
                WorkersRealTimeStatisticsResource.Fetch("WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", client: twilioRestClient);
        ...
        public void TestFetchResponse()
        {
            ...
            var response = WorkersRealTimeStatisticsResource.Fetch("WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", client: twilioRestClient);
