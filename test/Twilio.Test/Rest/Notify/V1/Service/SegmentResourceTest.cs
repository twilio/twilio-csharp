...
namespace Twilio.Tests.Rest.Notify.V1.Service 
{
    ...
    public class SegmentTest : TwilioTest 
    {
        ...
        public void TestReadRequest()
        {
            ...
            try
            {
                SegmentResource.Read("ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", client: twilioRestClient);
        ...
        public void TestReadEmptyResponse()
        {
            ...
            var response = SegmentResource.Read("ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", client: twilioRestClient);
