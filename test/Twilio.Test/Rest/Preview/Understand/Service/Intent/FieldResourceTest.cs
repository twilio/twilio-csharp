...
namespace Twilio.Tests.Rest.Preview.Understand.Service.Intent 
{
    ...
    public class FieldTest : TwilioTest 
    {
        ...
        public void TestFetchRequest()
        {
            ...
            try
            {
                FieldResource.Fetch("UAaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "UDaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "UEaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", client: twilioRestClient);
        ...
        public void TestCreateRequest()
        {
            ...
            try
            {
                FieldResource.Create("UAaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "UDaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "FieldType", "UniqueName", client: twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (ApiException) {}
            twilioRestClient.Received().Request(request);
        ...
        public void TestCreateResponse()
        {
            ...
            var response = FieldResource.Create("UAaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "UDaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "FieldType", "UniqueName", client: twilioRestClient);
            Assert.NotNull(response);
        }
        ...
        public void TestDeleteRequest()
        {
            ...
            try
            {
                FieldResource.Delete("UAaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "UDaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "UEaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", client: twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (ApiException) {}
            twilioRestClient.Received().Request(request);
