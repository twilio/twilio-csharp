...
namespace Twilio.Tests.Rest.Preview.Understand.Assistant 
{
    ...
    public class TaskTest : TwilioTest 
    {
        ...
        public void TestCreateRequest()
        {
            ...
            try
            {
                TaskResource.Create("UAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "unique_name", client: twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (ApiException) {}
            twilioRestClient.Received().Request(request);
        ...
        public void TestCreateResponse()
        {
            ...
            var response = TaskResource.Create("UAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "unique_name", client: twilioRestClient);
            Assert.NotNull(response);
        }
