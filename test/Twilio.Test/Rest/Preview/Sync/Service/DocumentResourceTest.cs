...
namespace Twilio.Tests.Rest.Preview.Sync.Service
{
    ...
    public class DocumentTest : TwilioTest
    {
        ...
        public void TestUpdateRequest()
        {
            ...
            try
            {
                DocumentResource.Update("ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "ETXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", new Dictionary<string, Object>(), client: twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (ApiException) {}
            twilioRestClient.Received().Request(request);
        ...
        public void TestUpdateResponse()
        {
            ...
            var response = DocumentResource.Update("ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "ETXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", new Dictionary<string, Object>(), client: twilioRestClient);
            Assert.NotNull(response);
        }
    }
