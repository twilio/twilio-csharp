...
namespace Twilio.Tests.Rest.Preview.Marketplace 
{
    ...
    public class AvailableAddOnTest : TwilioTest 
    {
        ...
        public void TestFetchRequest()
        {
            ...
            try
            {
                AvailableAddOnResource.Fetch("XBXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", client: twilioRestClient);
        ...
        public void TestFetchResponse()
        {
            ...
            var response = AvailableAddOnResource.Fetch("XBXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", client: twilioRestClient);
