...
namespace Twilio.Tests.Rest.Trunking.V1.Trunk 
{
    ...
    public class OriginationUrlTest : TwilioTest 
    {
        ...
        public void TestCreateRequest()
        {
            ...
            try
            {
                OriginationUrlResource.Create("TRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", 1, 1, true, "friendly_name", new Uri("https://example.com"), client: twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (ApiException) {}
            twilioRestClient.Received().Request(request);
        ...
        public void TestCreateResponse()
        {
            ...
            var response = OriginationUrlResource.Create("TRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", 1, 1, true, "friendly_name", new Uri("https://example.com"), client: twilioRestClient);
            Assert.NotNull(response);
        }
        ...
        public void TestReadEmptyResponse()
        {
            ...
            twilioRestClient.Request(Arg.Any<Request>())
                            .Returns(new Response(
                                         System.Net.HttpStatusCode.OK,
                                         "{\"meta\": {\"first_page_url\": \"https://trunking.twilio.com/v1/Trunks/TRaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/OriginationUrls?PageSize=50&Page=0\",\"key\": \"origination_urls\",\"next_page_url\": null,\"page\": 0,\"page_size\": 50,\"previous_page_url\": null,\"url\": \"https://trunking.twilio.com/v1/Trunks/TRaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/OriginationUrls?PageSize=50&Page=0\"},\"origination_urls\": []}"
                                     ));
