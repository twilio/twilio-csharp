...
namespace Twilio.Rest.Api.V2010.Account {
    ...
    public class NewKey : Resource {
        ...
        /**
         * Converts a JSON string into a NewKey object
         * 
         * @param json Raw JSON string
         * @return NewKey object represented by the provided JSON
         */
        public static NewKey FromJson(string json) {
            // Convert all checked exceptions to Runtime
            try {
                return JsonConvert.DeserializeObject<NewKey>(json);
