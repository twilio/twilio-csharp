...
namespace Twilio.Rest.Api.V2010.Account.Usage 
{
    ...
    {
        public sealed class RecordCategory : IStringEnum 
        {
            ...
            public RecordCategory(string value)
            {
                _value = value;
            }
            ...
            public static implicit operator RecordCategory(string value)
            {
                return new RecordCategory(value);
            }
            
            public static implicit operator string(RecordCategory value)
            {
        ...
        private RecordResource([JsonProperty("account_sid")]
                               ...
                               string apiVersion, 
                               [JsonProperty("category")]
                               RecordResource.RecordCategory category, 
                               [JsonProperty("count")]
                               string count, 
                               [JsonProperty("count_unit")]
                               string countUnit, 
