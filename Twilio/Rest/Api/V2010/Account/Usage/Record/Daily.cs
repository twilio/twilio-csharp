...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record {
    ...
    public class Daily : Resource {
        ...
        /**
         * Converts a JSON string into a Daily object
         * 
         * @param json Raw JSON string
         * @return Daily object represented by the provided JSON
         */
        public static Daily FromJson(string json) {
            // Convert all checked exceptions to Runtime
            try {
                return JsonConvert.DeserializeObject<Daily>(json);
        ...
        private readonly Daily.Category category;
        [JsonProperty("count")]
         ...
         * @return The category
         */
        public Daily.Category GetCategory() {
