    ...
    public class LastMonthResource : Resource 
    {
        ...
        private static Request BuildReadRequest(ReadLastMonthOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Get,
                Rest.Domain.Api,
                "/2010-04-01/Accounts/" + (options.AccountSid ?? client.AccountSid) + "/Usage/Records/LastMonth.json",
                client.Region,
        ...
        #if NET40
        public static async System.Threading.Tasks.Task<ResourceSet<LastMonthResource>> ReadAsync(ReadLastMonthOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// read
        /// </summary>
        public static ResourceSet<LastMonthResource> Read(string accountSid = null, LastMonthResource.CategoryEnum category = null, DateTime? startDate = null, DateTime? endDate = null, int? pageSize = null, long? limit = null, ITwilioRestClient client = null)
        {
            var options = new ReadLastMonthOptions{AccountSid = accountSid, Category = category, StartDate = startDate, EndDate = endDate, PageSize = pageSize, Limit = limit};
            return Read(options, client);
        }
    
        #if NET40
        public static async System.Threading.Tasks.Task<ResourceSet<LastMonthResource>> ReadAsync(string accountSid = null, LastMonthResource.CategoryEnum category = null, DateTime? startDate = null, DateTime? endDate = null, int? pageSize = null, long? limit = null, ITwilioRestClient client = null)
        {
            var options = new ReadLastMonthOptions{AccountSid = accountSid, Category = category, StartDate = startDate, EndDate = endDate, PageSize = pageSize, Limit = limit};
