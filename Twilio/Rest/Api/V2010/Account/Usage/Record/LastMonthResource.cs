...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record 
{
    ...
    {
        public sealed class LastMonthCategory : IStringEnum 
        {
            ...
            public LastMonthCategory() {}
            
            public LastMonthCategory(string value)
            {
                _value = value;
            }
            ...
            public static implicit operator LastMonthCategory(string value)
            {
                return new LastMonthCategory(value);
            }
            
            public static implicit operator string(LastMonthCategory value)
            {
        ...
        public LastMonthResource.LastMonthCategory category { get; set; }
        [JsonProperty("count")]
        ...
        private LastMonthResource([JsonProperty("account_sid")]
                                  ...
                                  string apiVersion, 
                                  [JsonProperty("category")]
                                  LastMonthResource.LastMonthCategory category, 
                                  [JsonProperty("count")]
                                  string count, 
                                  [JsonProperty("count_unit")]
                                  string countUnit, 
