...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record {
    ...
    public class Monthly : Resource {
         ...
         */
        public static MonthlyReader Read(string accountSid) {
        ...
        /**
         * Converts a JSON string into a Monthly object
         * 
         * @param json Raw JSON string
         * @return Monthly object represented by the provided JSON
         */
        public static Monthly FromJson(string json) {
            // Convert all checked exceptions to Runtime
            try {
                return JsonConvert.DeserializeObject<Monthly>(json);
        ...
        private readonly Monthly.Category category;
        [JsonProperty("count")]
         ...
         * @return The category
         */
        public Monthly.Category GetCategory() {
