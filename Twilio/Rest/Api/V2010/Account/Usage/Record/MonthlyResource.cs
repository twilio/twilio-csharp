...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record 
{
    ...
    public class MonthlyResource : Resource 
    {
        ...
        public static MonthlyReader Reader(string accountSid=null, MonthlyResource.Category category=null, DateTime? startDate=null, DateTime? endDate=null)
        {
            return new MonthlyReader(accountSid:accountSid, category:category, startDate:startDate, endDate:endDate);
        }
        ...
        public MonthlyResource.Category category { get; }
        [JsonProperty("count")]
