...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record 
{
    ...
    {
        public sealed class AllTimeCategory : IStringEnum 
        {
            ...
            public AllTimeCategory() {}
            
            public AllTimeCategory(string value)
            {
                _value = value;
            }
            ...
            public static implicit operator AllTimeCategory(string value)
            {
                return new AllTimeCategory(value);
            }
            
            public static implicit operator string(AllTimeCategory value)
            {
        ...
        public AllTimeResource()
        {
        
        }
    
        private AllTimeResource([JsonProperty("account_sid")]
                                string accountSid, 
                                [JsonProperty("api_version")]
                                string apiVersion, 
                                [JsonProperty("category")]
                                AllTimeResource.AllTimeCategory category, 
                                [JsonProperty("count")]
                                string count, 
                                [JsonProperty("count_unit")]
                                string countUnit, 
