...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record {
    ...
    public class MonthlyReader : Reader<MonthlyResource> {
         ...
         * @return this
         */
        public MonthlyReader ByStartDate(DateTime? startDate) {
         ...
         * @return this
         */
        public MonthlyReader ByEndDate(DateTime? endDate) {
        ...
        protected Page<MonthlyResource> PageForRequest(ITwilioRestClient client, Request request) {
            ...
            return Page<MonthlyResource>.FromJson("usage_records", response.GetContent());
        }
