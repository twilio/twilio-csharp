...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record {
    ...
    public class Yesterday : Resource {
        ...
        /**
         * Converts a JSON string into a Yesterday object
         * 
         * @param json Raw JSON string
         * @return Yesterday object represented by the provided JSON
         */
        public static Yesterday FromJson(string json) {
            // Convert all checked exceptions to Runtime
            try {
                return JsonConvert.DeserializeObject<Yesterday>(json);
        ...
        private readonly Yesterday.Category category;
        [JsonProperty("count")]
         ...
         * @return The category
         */
        public Yesterday.Category GetCategory() {
