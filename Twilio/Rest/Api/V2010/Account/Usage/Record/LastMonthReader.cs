...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record 
{
    ...
    public class LastMonthReader : Reader<LastMonthResource> 
    {
        ...
        public override System.Threading.Tasks.Task<ResourceSet<LastMonthResource>> ReadAsync(ITwilioRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
                Rest.Domain.Api,
                "/2010-04-01/Accounts/" + (AccountSid ?? client.AccountSid) + "/Usage/Records/LastMonth.json"
            );
