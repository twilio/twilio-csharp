...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record {
    ...
    public class YesterdayResource : Resource {
         ...
         * @return YesterdayResource object represented by the provided JSON
         */
        ...
        private readonly YesterdayResource.Category category;
        [JsonProperty("count")]
         ...
         * @return The category
         */
        public YesterdayResource.Category GetCategory() {
