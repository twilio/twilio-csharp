...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record 
{
    ...
    public class YesterdayResource : Resource 
    {
        ...
        public static YesterdayReader Reader(string accountSid=null, YesterdayResource.Category category=null, DateTime? startDate=null, DateTime? endDate=null)
        {
            return new YesterdayReader(accountSid:accountSid, category:category, startDate:startDate, endDate:endDate);
        }
        ...
        public YesterdayResource.Category category { get; }
        [JsonProperty("count")]
        ...
        private YesterdayResource([JsonProperty("account_sid")]
                                  ...
                                  string apiVersion, 
                                  [JsonProperty("category")]
                                  YesterdayResource.Category category, 
                                  [JsonProperty("count")]
                                  string count, 
                                  [JsonProperty("count_unit")]
                                  string countUnit, 
