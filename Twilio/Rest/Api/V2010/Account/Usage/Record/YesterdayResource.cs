...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record 
{
    ...
    {
        public sealed class YesterdayCategory : IStringEnum 
        {
            ...
            public YesterdayCategory() {}
            
            public YesterdayCategory(string value)
            {
                _value = value;
            }
            ...
            public static implicit operator YesterdayCategory(string value)
            {
                return new YesterdayCategory(value);
            }
            
            public static implicit operator string(YesterdayCategory value)
            {
        ...
        public YesterdayResource.YesterdayCategory category { get; set; }
        [JsonProperty("count")]
        ...
        private YesterdayResource([JsonProperty("account_sid")]
                                  ...
                                  string apiVersion, 
                                  [JsonProperty("category")]
                                  YesterdayResource.YesterdayCategory category, 
                                  [JsonProperty("count")]
                                  string count, 
                                  [JsonProperty("count_unit")]
                                  string countUnit, 
