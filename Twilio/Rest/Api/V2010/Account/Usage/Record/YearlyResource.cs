...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record {
    ...
    public class YearlyResource : Resource {
         ...
         */
        public static YearlyReader Reader(string accountSid) {
         ...
         * @return YearlyResource object represented by the provided JSON
         */
        ...
        private readonly YearlyResource.Category category;
        [JsonProperty("count")]
         ...
         * @return The category
         */
        public YearlyResource.Category GetCategory() {
