...
namespace Twilio.Rest.Api.V2010.Account 
{
    ...
    public class NewKeyCreator : Creator<NewKeyResource> 
    {
        ...
        public override async System.Threading.Tasks.Task<NewKeyResource> CreateAsync(ITwilioRestClient client)
        {
            var request = new Request(
                HttpMethod.Post,
                Rest.Domain.Api,
                "/2010-04-01/Accounts/" + (AccountSid ?? client.AccountSid) + "/Keys.json",
                client.Region
            );
