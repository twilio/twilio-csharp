...
namespace Twilio.Rest.Api.V2010.Account {
    ...
    public class SigningKey : SidResource {
        /**
         * fetch
         * 
        ...
        /**
         * Converts a JSON string into a SigningKey object
         * 
         * @param json Raw JSON string
         * @return SigningKey object represented by the provided JSON
         */
        public static SigningKey FromJson(string json) {
            // Convert all checked exceptions to Runtime
            try {
                return JsonConvert.DeserializeObject<SigningKey>(json);
