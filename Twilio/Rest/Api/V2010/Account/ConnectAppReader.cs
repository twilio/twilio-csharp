...
namespace Twilio.Rest.Api.V2010.Account 
{
    ...
    public class ConnectAppReader : Reader<ConnectAppResource> 
    {
        ...
        public override System.Threading.Tasks.Task<ResourceSet<ConnectAppResource>> ReadAsync(ITwilioRestClient client)
        {
            var request = new Request(
                HttpMethod.GET,
                Domains.API,
                "/2010-04-01/Accounts/" + (AccountSid ?? client.GetAccountSid()) + "/ConnectApps.json"
            );
            AddQueryParams(request);
            
            var page = PageForRequest(client, request);
            
            return System.Threading.Tasks.Task.FromResult(new ResourceSet<ConnectAppResource>(this, client, page));
        }
        #endif
