...
namespace Twilio.Rest.Taskrouter.V1.Workspace {
    ...
    public class TaskChannel : SidResource {
        /**
         * fetch
         * 
        ...
        /**
         * Converts a JSON string into a TaskChannel object
         * 
         * @param json Raw JSON string
         * @return TaskChannel object represented by the provided JSON
         */
        public static TaskChannel FromJson(string json) {
            // Convert all checked exceptions to Runtime
            try {
                return JsonConvert.DeserializeObject<TaskChannel>(json);
