...
namespace Twilio.Rest.Taskrouter.V1.Workspace {
    ...
    public class TaskChannelReader : Reader<TaskChannelResource> {
         ...
         */
        public override Task<ResourceSet<TaskChannelResource>> ExecuteAsync(ITwilioRestClient client) {
         ...
         * @return TaskChannelResource ResourceSet
         */
        public override ResourceSet<TaskChannelResource> Execute(ITwilioRestClient client) {
            Request request = new Request(
                Twilio.Http.HttpMethod.GET,
                Domains.TASKROUTER,
                "/v1/Workspaces/" + this.workspaceSid + "/TaskChannels"
