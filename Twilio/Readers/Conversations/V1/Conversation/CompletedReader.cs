...
namespace Twilio.Readers.Conversations.V1.Conversation {
    ...
    public class CompletedReader : Reader<CompletedResource> {
         ...
         * @return Next Page
         */
        public override Page<CompletedResource> nextPage(final String nextPageUri, final TwilioRestClient client) {
            Request request = new Request(
                System.Net.Http.HttpMethod.Get,
                nextPageUri
            );
        ...
        protected Page<CompletedResource> pageForRequest(TwilioRestClient client, Request request) {
            ...
            result.deserialize("conversations", response.GetContent(), CompletedResource.class, client.getObjectMapper());
