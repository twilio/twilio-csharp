...
namespace Twilio.Readers.Trunking.V1.Trunk {
    ...
    public class OriginationUrlReader : Reader<OriginationUrlResource> {
         ...
         */
        public override ResourceSet<OriginationUrlResource> execute(TwilioRestClient client) {
         ...
         * @return Next Page
         */
        public override Page<OriginationUrlResource> nextPage(final String nextPageUri, final TwilioRestClient client) {
            Request request = new Request(
                System.Net.Http.HttpMethod.Get,
                nextPageUri
            );
         ...
         */
        protected Page<OriginationUrlResource> pageForRequest(TwilioRestClient client, Request request) {
            ...
            Page<OriginationUrlResource> result = new Page<>();
            result.deserialize("origination_urls", response.GetContent(), OriginationUrlResource.class, client.getObjectMapper());
