...
namespace Twilio.Readers.IpMessaging.V1.Service {
    ...
    public class RoleReader : Reader<RoleResource> {
         ...
         */
        public override async Task<ResourceSet<RoleResource>> ExecuteAsync(TwilioRestClient client) {
         ...
         * @return Next Page
         */
        public override Page<RoleResource> NextPage(string nextPageUri, TwilioRestClient client) {
            Request request = new Request(
                System.Net.Http.HttpMethod.Get,
                nextPageUri
            );
         ...
         */
        protected async Task<Page<RoleResource>> PageForRequest(TwilioRestClient client, Request request) {
