...
namespace Twilio.Readers.IpMessaging.V1.Service {
    ...
    public class UserReader : Reader<User> {
         ...
         */
        [Override]
        public ResourceSet<User> execute(TwilioRestClient client) {
            ...
            Page<User> page = pageForRequest(client, request);
         ...
         */
        [Override]
        public Page<User> nextPage(final String nextPageUri, final TwilioRestClient client) {
            Request request = new Request(
                HttpMethod.GET,
                nextPageUri,
                client.getAccountSid()
         ...
         */
        protected Page<User> pageForRequest(final TwilioRestClient client, final Request request) {
            ...
            result.deserialize("users", response.getContent(), User.class, client.getObjectMapper());
