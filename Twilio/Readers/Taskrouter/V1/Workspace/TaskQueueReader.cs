...
namespace Twilio.Readers.Taskrouter.V1.Workspace {
    ...
    public class TaskQueueReader : Reader<TaskQueueResource> {
         ...
         */
        public override async Task<ResourceSet<TaskQueueResource>> ExecuteAsync(TwilioRestClient client) {
         ...
         * @return Next Page
         */
        public override Page<TaskQueueResource> NextPage(string nextPageUri, TwilioRestClient client) {
            Request request = new Request(
                System.Net.Http.HttpMethod.Get,
                nextPageUri
            );
         ...
         */
        protected async Task<Page<TaskQueueResource>> PageForRequest(TwilioRestClient client, Request request) {
