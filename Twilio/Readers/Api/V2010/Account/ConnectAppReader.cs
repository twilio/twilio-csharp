...
namespace Twilio.Readers.Api.V2010.Account {
    ...
    public class ConnectAppReader : Reader<ConnectAppResource> {
         ...
         */
        public override async Task<ResourceSet<ConnectAppResource>> ExecuteAsync(ITwilioRestClient client) {
         ...
         */
        protected async Task<Page<ConnectAppResource>> PageForRequest(ITwilioRestClient client, Request request) {
