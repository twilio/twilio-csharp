...
namespace Twilio.Readers.Api.V2010.Account {
    ...
    public class ApplicationReader : Reader<ApplicationResource> {
         ...
         */
        public ResourceSet<ApplicationResource> execute(TwilioRestClient client) {
         ...
         * @return Next Page
         */
        public Page<ApplicationResource> nextPage(string nextPageUri, TwilioRestClient client) {
            Request request = new Request(
                System.Net.Http.HttpMethod.Get,
                nextPageUri
            );
