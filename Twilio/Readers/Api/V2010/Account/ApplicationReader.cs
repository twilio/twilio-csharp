...
namespace Twilio.Readers.Api.V2010.Account {
    ...
    public class ApplicationReader : Reader<ApplicationResource> {
         ...
         */
        public override async Task<ResourceSet<ApplicationResource>> ExecuteAsync(ITwilioRestClient client) {
         ...
         */
        protected async Task<Page<ApplicationResource>> PageForRequest(ITwilioRestClient client, Request request) {
