...
namespace Twilio.Readers.Api.V2010.Account {
    ...
    public class AddressReader : Reader<AddressResource> {
         ...
         */
        public override async Task<ResourceSet<AddressResource>> ExecuteAsync(ITwilioRestClient client) {
         ...
         */
        protected async Task<Page<AddressResource>> PageForRequest(ITwilioRestClient client, Request request) {
