...
namespace Twilio.Readers.Api.V2010.Account {
    ...
    public class QueueReader : Reader<QueueResource> {
         ...
         */
        public override async Task<ResourceSet<QueueResource>> ExecuteAsync(ITwilioRestClient client) {
         ...
         */
        protected async Task<Page<QueueResource>> PageForRequest(ITwilioRestClient client, Request request) {
