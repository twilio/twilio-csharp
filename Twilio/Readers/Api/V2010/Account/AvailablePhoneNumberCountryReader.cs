...
namespace Twilio.Readers.Api.V2010.Account {
    ...
    public class AvailablePhoneNumberCountryReader : Reader<AvailablePhoneNumberCountryResource> {
         ...
         */
        public override async Task<ResourceSet<AvailablePhoneNumberCountryResource>> ExecuteAsync(ITwilioRestClient client) {
         ...
         */
        protected async Task<Page<AvailablePhoneNumberCountryResource>> PageForRequest(ITwilioRestClient client, Request request) {
