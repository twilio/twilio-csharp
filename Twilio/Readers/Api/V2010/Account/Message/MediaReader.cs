...
namespace Twilio.Readers.Api.V2010.Account.Message {
    ...
    public class MediaReader : Reader<MediaResource> {
         ...
         */
        public override async Task<ResourceSet<MediaResource>> ExecuteAsync(ITwilioRestClient client) {
         ...
         */
        protected async Task<Page<MediaResource>> PageForRequest(ITwilioRestClient client, Request request) {
