...
namespace Twilio.Readers.Api.V2010.Account.Usage {
    ...
    public class TriggerReader : Reader<TriggerResource> {
         ...
         */
        public override async Task<ResourceSet<TriggerResource>> ExecuteAsync(TwilioRestClient client) {
         ...
         * @return Next Page
         */
        public override Page<TriggerResource> NextPage(string nextPageUri, TwilioRestClient client) {
            Request request = new Request(
                System.Net.Http.HttpMethod.Get,
                nextPageUri
            );
         ...
         */
        protected async Task<Page<TriggerResource>> PageForRequest(TwilioRestClient client, Request request) {
