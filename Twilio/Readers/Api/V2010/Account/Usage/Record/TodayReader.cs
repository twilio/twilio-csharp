...
namespace Twilio.Readers.Api.V2010.Account.Usage.Record {
    ...
    public class TodayReader : Reader<TodayResource> {
         ...
         * @return this
         */
        public TodayReader ByStartDate(string startDate) {
         ...
         * @return this
         */
        public TodayReader ByEndDate(string endDate) {
         ...
         */
        public override Task<ResourceSet<TodayResource>> ExecuteAsync(ITwilioRestClient client) {
            ...
            return System.Threading.Tasks.Task.FromResult(
                    new ResourceSet<TodayResource>(this, client, page));
        }
        #endif
         ...
         * @return TodayResource ResourceSet
         */
        public override ResourceSet<TodayResource> Execute(ITwilioRestClient client) {
            Request request = new Request(
                Twilio.Http.HttpMethod.GET,
                Domains.API,
                "/2010-04-01/Accounts/" + (this.accountSid != null ? this.accountSid : client.GetAccountSid()) + "/Usage/Records/Today.json"
         ...
         * @return Next Page
         */
        public override Page<TodayResource> NextPage(string nextPageUri, ITwilioRestClient client) {
            Request request = new Request(
                Twilio.Http.HttpMethod.GET,
                nextPageUri
            );
        ...
        protected Page<TodayResource> PageForRequest(ITwilioRestClient client, Request request) {
            ...
            Page<TodayResource> result = new Page<TodayResource>();
