...
namespace Twilio.Readers.Api.V2010.Account.Usage.Record {
    ...
    public class TodayReader : Reader<TodayResource> {
         ...
         */
        public override async Task<ResourceSet<TodayResource>> ExecuteAsync(ITwilioRestClient client) {
            ...
            Page<TodayResource> page = await PageForRequest(client, request);
         ...
         */
        protected async Task<Page<TodayResource>> PageForRequest(ITwilioRestClient client, Request request) {
