...
namespace Twilio.Readers.Api.V2010.Account.Usage.Record {
    ...
    public class TodayReader : Reader<TodayResource> {
         ...
         */
        public override async Task<ResourceSet<TodayResource>> ExecuteAsync(TwilioRestClient client) {
         ...
         * @return Next Page
         */
        public override Page<TodayResource> NextPage(string nextPageUri, TwilioRestClient client) {
            Request request = new Request(
                System.Net.Http.HttpMethod.Get,
                nextPageUri
            );
         ...
         */
        protected async Task<Page<TodayResource>> PageForRequest(TwilioRestClient client, Request request) {
