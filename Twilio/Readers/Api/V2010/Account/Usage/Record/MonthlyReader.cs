...
namespace Twilio.Readers.Api.V2010.Account.Usage.Record {
    ...
    public class MonthlyReader : Reader<MonthlyResource> {
         ...
         */
        public override async Task<ResourceSet<MonthlyResource>> ExecuteAsync(ITwilioRestClient client) {
         ...
         */
        protected async Task<Page<MonthlyResource>> PageForRequest(ITwilioRestClient client, Request request) {
