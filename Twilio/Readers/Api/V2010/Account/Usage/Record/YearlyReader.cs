...
using Twilio.Http;
using Twilio.Resources.Api.V2010.account.usage.record.Yearly;
...
namespace Twilio.Readers.Api.V2010.Account.Usage.Record {
    ...
    public class YearlyReader : Reader<Yearly> {
         ...
         */
        [Override]
        public ResourceSet<Yearly> execute(TwilioRestClient client) {
