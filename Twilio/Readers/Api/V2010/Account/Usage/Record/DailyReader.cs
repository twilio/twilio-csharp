...
namespace Twilio.Readers.Api.V2010.Account.Usage.Record {
    ...
    public class DailyReader : Reader<DailyResource> {
         ...
         */
        public override async Task<ResourceSet<DailyResource>> ExecuteAsync(ITwilioRestClient client) {
         ...
         */
        protected async Task<Page<DailyResource>> PageForRequest(ITwilioRestClient client, Request request) {
