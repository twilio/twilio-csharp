...
namespace Twilio.Readers.Api.V2010.Account.Usage.Record {
    ...
    public class YesterdayReader : Reader<YesterdayResource> {
         ...
         */
        public override async Task<ResourceSet<YesterdayResource>> ExecuteAsync(TwilioRestClient client) {
         ...
         * @return Next Page
         */
        public override Page<YesterdayResource> NextPage(string nextPageUri, TwilioRestClient client) {
            Request request = new Request(
                System.Net.Http.HttpMethod.Get,
                nextPageUri
            );
         ...
         */
        protected async Task<Page<YesterdayResource>> PageForRequest(TwilioRestClient client, Request request) {
