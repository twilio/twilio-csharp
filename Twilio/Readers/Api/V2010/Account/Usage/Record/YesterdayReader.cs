...
namespace Twilio.Readers.Api.V2010.Account.Usage.Record {
    ...
    public class YesterdayReader : Reader<YesterdayResource> {
         ...
         */
        public override ResourceSet<YesterdayResource> execute(TwilioRestClient client) {
         ...
         * @return Next Page
         */
        public override Page<YesterdayResource> nextPage(final String nextPageUri, final TwilioRestClient client) {
            Request request = new Request(
                System.Net.Http.HttpMethod.Get,
                nextPageUri
            );
         ...
         */
        protected Page<YesterdayResource> pageForRequest(TwilioRestClient client, Request request) {
            ...
            Page<YesterdayResource> result = new Page<>();
            result.deserialize("usage_records", response.GetContent(), YesterdayResource.class, client.getObjectMapper());
