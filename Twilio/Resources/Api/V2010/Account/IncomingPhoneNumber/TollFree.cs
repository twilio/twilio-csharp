...
namespace Twilio.Resources.Api.V2010.Account.Incomingphonenumber {
    ...
    public class TollFree : Resource {
         ...
         */
        public static TollFreeCreator create(String ownerAccountSid, com.twilio.types.PhoneNumber phoneNumber) {
            return new TollFreeCreator(ownerAccountSid, phoneNumber);
        }
    
        /**
         * Converts a JSON string into a TollFree object
         * 
         * @param json Raw JSON string
         * @return TollFree object represented by the provided JSON
         */
        public static TollFree fromJson(string json) {
            // Convert all checked exceptions to Runtime
            try {
                return JsonConvert.DeserializeObject<TollFree>(json);
        ...
        private readonly TollFree.AddressRequirement addressRequirements;
        ...
        private TollFree([JsonProperty("account_sid")]
                         String accountSid, 
                         [JsonProperty("address_requirements")]
                         TollFree.AddressRequirement addressRequirements, 
                         [JsonProperty("api_version")]
                         String apiVersion, 
                         [JsonProperty("beta")]
                         Boolean beta, 
         ...
         */
        public TollFree.AddressRequirement GetAddressRequirements() {
