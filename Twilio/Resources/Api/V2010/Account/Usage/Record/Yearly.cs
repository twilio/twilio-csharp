...
namespace Twilio.Resources.Api.V2010.Account.Usage.Record {
    ...
    public class Yearly : Resource {
        ...
        /**
         * Converts a JSON string into a Yearly object
         * 
         * @param json Raw JSON string
         * @return Yearly object represented by the provided JSON
         */
        public static Yearly fromJson(string json) {
            // Convert all checked exceptions to Runtime
            try {
                return JsonConvert.DeserializeObject<Yearly>(json);
        ...
        private readonly Yearly.Category category;
        [JsonProperty("count")]
         ...
         * @return The category
         */
        public Yearly.Category GetCategory() {
