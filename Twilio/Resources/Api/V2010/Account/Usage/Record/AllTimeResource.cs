...
namespace Twilio.Resources.Api.V2010.Account.Usage.Record {
    ...
    public class AllTimeResource : Resource {
         ...
         * @return AllTimeResource object represented by the provided JSON
         */
        ...
        private readonly AllTimeResource.Category category;
        [JsonProperty("count")]
        ...
        private AllTimeResource([JsonProperty("account_sid")]
                                ...
                                string apiVersion, 
                                [JsonProperty("category")]
                                AllTimeResource.Category category, 
                                [JsonProperty("count")]
                                string count, 
                                [JsonProperty("count_unit")]
                                string countUnit, 
         ...
         * @return The category
         */
        public AllTimeResource.Category GetCategory() {
