...
namespace Twilio.Resources.Api.V2010.Account.Usage.Record {
    ...
    public class Today : Resource {
         ...
         */
        public static TodayReader read(String accountSid) {
            return new TodayReader(accountSid);
        }
    
        /**
         * Converts a JSON string into a Today object
         * 
         * @param json Raw JSON string
         * @return Today object represented by the provided JSON
         */
        public static Today fromJson(string json) {
            // Convert all checked exceptions to Runtime
            try {
                return JsonConvert.DeserializeObject<Today>(json);
        ...
        private readonly Today.Category category;
        [JsonProperty("count")]
         ...
         * @return The category
         */
        public Today.Category GetCategory() {
