...
namespace Twilio.Resources.Api.V2010.Account.Usage.Record {
    ...
    public class DailyResource : Resource {
        ...
        private readonly DailyResource.Category category;
        [JsonProperty("count")]
        ...
        private DailyResource([JsonProperty("account_sid")]
                              string accountSid, 
                              [JsonProperty("api_version")]
                              string apiVersion, 
                              [JsonProperty("category")]
                              DailyResource.Category category, 
                              [JsonProperty("count")]
                              string count, 
                              [JsonProperty("count_unit")]
                              string countUnit, 
         ...
         * @return The category
         */
        public DailyResource.Category GetCategory() {
