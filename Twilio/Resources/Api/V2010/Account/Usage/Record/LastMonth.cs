...
namespace Twilio.Resources.Api.V2010.Account.Usage.Record {
    ...
    public class LastMonth : Resource {
        ...
        /**
         * Converts a JSON string into a LastMonth object
         * 
         * @param json Raw JSON string
         * @return LastMonth object represented by the provided JSON
         */
        public static LastMonth fromJson(string json) {
            // Convert all checked exceptions to Runtime
            try {
                return JsonConvert.DeserializeObject<LastMonth>(json);
        ...
        private readonly LastMonth.Category category;
        [JsonProperty("count")]
         ...
         * @return The category
         */
        public LastMonth.Category GetCategory() {
