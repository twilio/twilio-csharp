...
namespace Twilio
{
    ...
    namespace Pricing
    {
        ...
        /// </summary>
        public partial class TwilioPricingClient : TwilioClient
        {
            /// <summary>
            ...
            /// <param name="accountSid">The AccountSid to authenticate with.</param>
            /// <param name="authToken">The AuthToken to authenticate with.</param>
            public TwilioPricingClient(string accountSid, string authToken) : base(accountSid, authToken, accountSid, "v1", "https://pricing.twilio.com/") { }
        }
    }
}
