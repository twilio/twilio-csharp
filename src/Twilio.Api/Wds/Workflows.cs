...
namespace Twilio.Wds
{
    public partial class TwilioWdsClient
    {
        ...
        public virtual Workflow AddWorkflow(string workspaceSid, string friendlyName, string configuration, string assignmentCallbackUrl, string fallbackAssignmentCallbackUrl, int? taskReservationTimeout)
        {
            ...
            request.Resource = "Accounts/{AccountSid}/Workspaces/{WorkspaceSid}/Workflows.json";
        ...
        public virtual DeleteStatus DeleteWorkflow(string workspaceSid, string workflowSid)
        {
            Require.Argument("WorkspaceSid", workspaceSid);
            Require.Argument("WorkflowSid", workflowSid);

            var request = new RestRequest(Method.DELETE);
            request.Resource = "Accounts/{AccountSid}/Workspaces/{WorkspaceSid}/Workflows/{WorkflowSid}.json";
        ...
        public virtual WorkflowResult ListWorkflows(string workspaceSid, string friendlyName, string afterSid, string beforeSid, int? count)
        {
            ...
            return Execute<WorkflowResult>(request);
        }
        ...
        /// <param name="taskReservationTimeout">Optional task reservation timeout.</param>
        public virtual Workflow UpdateWorkflow(string workspaceSid, string workflowSid, string friendlyName, string assignmentCallbackUrl, string fallbackAssignmentCallbackUrl, string configuration, int? taskReservationTimeout)
        {
            Require.Argument("WorkspaceSid", workspaceSid);
            Require.Argument("WorkflowSid", workflowSid);
