...
namespace Twilio.TaskRouter.Tests
{
    ...
    public class WorkerTests
    {
        ...
        public void ShouldAddNewWorker()
        {
            ...
            Assert.AreEqual("Workspaces/{WorkspaceSid}/Workers.json", savedRequest.Resource);
        ...
        public void ShouldDeleteWorker()
        {
            ...
            Assert.IsNotNull(savedRequest);
            Assert.AreEqual("Workspaces/{WorkspaceSid}/Workers/{WorkerSid}.json", savedRequest.Resource);
