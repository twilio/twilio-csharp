...
namespace Twilio.IpMessaging
{
    ...
    public partial class IpMessagingClient : TwilioClient
    {
        ...
        public IpMessagingClient(string accountSid, string authToken) : base(accountSid, authToken, accountSid, "v1", "https://ip-messaging.twilio.com/") { }
        ...
        public IpMessagingClient(string accountSid, string authToken, string accountResourceSid, string apiVersion, string baseUrl) :
