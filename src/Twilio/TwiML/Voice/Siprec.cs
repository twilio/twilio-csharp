...
namespace Twilio.TwiML.Voice
{
    ...
    /// <summary>Siprec TwiML Noun</summary>
    public class Siprec : TwiML
    {
        ...
        /// <summary>Friendly name given to SIPREC</summary>
        public string Name { get; set; }

        /// <summary>Unique name for Connector</summary>
        public string ConnectorName { get; set; }

        /// <summary>Track to be streamed to remote service</summary>
        public Siprec.TrackEnum Track { get; set; }

        /// <summary>Create a new Siprec</summary>
