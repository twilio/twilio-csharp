...
namespace Twilio.TwiML.Voice
{
    ...
    /// <summary>Record TwiML Verb</summary>
    public class Record : TwiML
    {
        ...
        /// <summary>Timeout to begin recording</summary>
        public int? Timeout { get; set; }

        /// <summary>Finish recording on key</summary>
        public string FinishOnKey { get; set; }

        /// <summary>Max time to record in seconds</summary>
        public int? MaxLength { get; set; }

        /// <summary>Play beep</summary>
        ...
        /// <summary>Transcribe the recording</summary>
        public bool? Transcribe { get; set; }

        /// <summary>Transcribe callback URL</summary>
