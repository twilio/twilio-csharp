...
namespace Twilio.TwiML.Voice
{
    ...
    /// <summary>Controling Volume, Speaking Rate, and Pitch in Say</summary>
    public class SsmlProsody : TwiML
    {
        /// <summary>Words to speak</summary>
        public string Words { get; set; }

        /// <summary>Specify the volume, available values: default, silent, x-soft, soft, medium, loud, x-loud, +ndB, -ndB</summary>
        public string Volume { get; set; }

        /// <summary>Specify the rate, available values: x-slow, slow, medium, fast, x-fast, n%</summary>
        public string Rate { get; set; }

        /// <summary>Specify the pitch, available values: default, x-low, low, medium, high, x-high, +n%, -n%</summary>
        public string Pitch { get; set; }

        /// <summary>Create a new SsmlProsody</summary>
