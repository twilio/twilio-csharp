...
namespace Twilio.TwiML.Voice
{
    ...
    /// <summary>Conference TwiML Noun</summary>
    public class Conference : TwiML
    {
        ...
        /// <summary>Join the conference muted</summary>
        public bool? Muted { get; set; }

        /// <summary>Play beep when joining</summary>
        public Conference.BeepEnum Beep { get; set; }

        /// <summary>Start the conference on enter</summary>
        public bool? StartConferenceOnEnter { get; set; }

        /// <summary>End the conferenceon exit</summary>
        public bool? EndConferenceOnExit { get; set; }

        /// <summary>Wait URL</summary>
        public Uri WaitUrl { get; set; }

        /// <summary>Wait URL method</summary>
        public Twilio.Http.HttpMethod WaitMethod { get; set; }

        /// <summary>Maximum number of participants</summary>
        public int? MaxParticipants { get; set; }

        /// <summary>Record the conference</summary>
        public Conference.RecordEnum Record { get; set; }

        /// <summary>Conference region</summary>
        public Conference.RegionEnum Region { get; set; }

        /// <summary>Call coach</summary>
        public string Coach { get; set; }

        /// <summary>Trim the conference recording</summary>
        public Conference.TrimEnum Trim { get; set; }

        /// <summary>Events to call status callback URL</summary>
        ...
        /// <summary>Event callback URL</summary>
        public Uri EventCallbackUrl { get; set; }

        /// <summary>Size of jitter buffer for participant</summary>
        public Conference.JitterBufferSizeEnum JitterBufferSize { get; set; }

        /// <summary>A label for participant</summary>
        public string ParticipantLabel { get; set; }

        /// <summary>Create a new Conference</summary>
