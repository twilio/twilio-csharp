...
namespace Twilio.TwiML.Voice
{
    ...
    /// <summary>Emphasizing Words in Say</summary>
    public class SsmlEmphasis : TwiML
    {
        ...
        /// <summary>Words to emphasize</summary>
        public string Words { get; set; }

        /// <summary>Specify the degree of emphasis</summary>
        public SsmlEmphasis.LevelEnum Level { get; set; }

        /// <summary>Create a new SsmlEmphasis</summary>
