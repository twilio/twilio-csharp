...
namespace Twilio.TwiML.Voice
{
    ...
    /// <summary>Controlling How Special Types of Words Are Spoken in Say</summary>
    public class SsmlSayAs : TwiML
    {
        ...
        /// <summary>Words to be interpreted</summary>
        public string Words { get; set; }

        /// <summary>Specify the type of words are spoken</summary>
        public SsmlSayAs.InterpretAsEnum InterpretAs { get; set; }

        /// <summary>Specify the format of the date when interpret-as is set to date</summary>
        public SsmlSayAs.FormatEnum Format { get; set; }

        /// <summary>Create a new SsmlSayAs</summary>
