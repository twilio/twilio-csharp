...
namespace Twilio.TwiML.Voice
{
    ...
    /// <summary>Improving Pronunciation by Specifying Parts of Speech in Say</summary>
    public class SsmlW : TwiML
    {
        /// <summary>Words to speak</summary>
        public string Words { get; set; }

        /// <summary>Customize the pronunciation of words by specifying the word’s part of speech or alternate meaning</summary>
        public string Role { get; set; }

        /// <summary>Create a new SsmlW</summary>
