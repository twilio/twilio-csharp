...
namespace Twilio.TwiML.Voice
{
    ...
    /// <summary>Pronouncing Acronyms and Abbreviations in Say</summary>
    public class SsmlSub : TwiML
    {
        /// <summary>Words to be substituted</summary>
        public string Words { get; set; }

        /// <summary>Substitute a different word (or pronunciation) for selected text such as an acronym or abbreviation</summary>
        public string Alias { get; set; }

        /// <summary>Create a new SsmlSub</summary>
