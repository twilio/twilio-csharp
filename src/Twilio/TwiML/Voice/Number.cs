...
namespace Twilio.TwiML.Voice
{
    ...
    /// <summary>Number TwiML Noun</summary>
    public class Number : TwiML
    {
        ...
        /// <summary>DTMF tones to play when the call is answered</summary>
        public string SendDigits { get; set; }

        /// <summary>TwiML URL</summary>
        public Uri Url { get; set; }

        /// <summary>TwiML URL method</summary>
        public Twilio.Http.HttpMethod Method { get; set; }

        /// <summary>Events to call status callback</summary>
        public IEnumerable<Number.EventEnum> StatusCallbackEvent { get; set; }

        /// <summary>Status callback URL</summary>
        public Uri StatusCallback { get; set; }

        /// <summary>Status callback URL method</summary>
        public Twilio.Http.HttpMethod StatusCallbackMethod { get; set; }

        /// <summary>BYOC trunk SID (Beta)</summary>
        public string Byoc { get; set; }

        /// <summary>Enable machine detection or end of greeting detection</summary>
        public string MachineDetection { get; set; }

        /// <summary>HTTP Method to use with amd_status_callback</summary>
        public Twilio.Http.HttpMethod AmdStatusCallbackMethod { get; set; }

        /// <summary>The URL we should call to send amd status information to your application</summary>
        public string AmdStatusCallback { get; set; }

        /// <summary>Number of seconds to wait for machine detection</summary>
        public int? MachineDetectionTimeout { get; set; }

        /// <summary>Number of milliseconds for measuring stick for the length of the speech activity</summary>
        public int? MachineDetectionSpeechThreshold { get; set; }

        /// <summary>Number of milliseconds of silence after speech activity</summary>
        public int? MachineDetectionSpeechEndThreshold { get; set; }

        /// <summary>Number of milliseconds of initial silence</summary>
        public int? MachineDetectionSilenceTimeout { get; set; }

        /// <summary>Create a new Number</summary>
