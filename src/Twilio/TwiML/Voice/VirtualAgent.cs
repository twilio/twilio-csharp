...
namespace Twilio.TwiML.Voice
{
    ...
    /// <summary>VirtualAgent TwiML Noun</summary>
    public class VirtualAgent : TwiML
    {
        /// <summary>Defines the conversation profile Dialogflow needs to use</summary>
        public string ConnectorName { get; set; }

        /// <summary>Language to be used by Dialogflow to transcribe speech</summary>
        public string Language { get; set; }

        /// <summary>Whether sentiment analysis needs to be enabled or not</summary>
        public bool? SentimentAnalysis { get; set; }

        /// <summary>URL to post status callbacks from Twilio</summary>
        public string StatusCallback { get; set; }

        /// <summary>HTTP method to use when requesting the status callback URL</summary>
        public Twilio.Http.HttpMethod StatusCallbackMethod { get; set; }

        /// <summary>Create a new VirtualAgent</summary>
        ...
        /// <summary>Create a new &lt;Config/&gt; element and append it as a child of this element.</summary>
        ...
        /// <summary>Append a &lt;Config/&gt; element as a child of this element</summary>
