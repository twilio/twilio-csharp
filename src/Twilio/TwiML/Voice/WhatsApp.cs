...
namespace Twilio.TwiML.Voice
{
    ...
    public class WhatsApp : TwiML
    {
        ...
        /// </summary>
        public IEnumerable<WhatsApp.EventEnum> StatusCallbackEvent { get; set; }
        /// <summary>
        /// Status Callback URL
        /// </summary>
        ...
        public WhatsApp(Types.PhoneNumber phoneNumber = null,
                        Uri url = null,
                        Twilio.Http.HttpMethod method = null,
                        IEnumerable<WhatsApp.EventEnum> statusCallbackEvent = null,
                        Uri statusCallback = null,
                        Twilio.Http.HttpMethod statusCallbackMethod = null) : base("WhatsApp")
        {
        ...
        public new WhatsApp Append(TwiML childElem)
        {
            return (WhatsApp) base.Append(childElem);
        }
        ...
        public new WhatsApp SetOption(string key, object value)
        {
            return (WhatsApp) base.SetOption(key, value);
        }
    }
