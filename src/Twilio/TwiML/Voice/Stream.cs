...
namespace Twilio.TwiML.Voice
{
    ...
    /// <summary>Stream TwiML Noun</summary>
    public class Stream : TwiML
    {
        ...
        /// <summary>Friendly name given to the Stream</summary>
        public string Name { get; set; }

        /// <summary>Unique name for Stream Connector</summary>
        public string ConnectorName { get; set; }

        /// <summary>URL of the remote service where the Stream is routed</summary>
        public string Url { get; set; }

        /// <summary>Track to be streamed to remote service</summary>
