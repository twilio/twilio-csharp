...
namespace Twilio.TwiML.Voice
{
    ...
    /// <summary>Conversation TwiML Noun</summary>
    public class Conversation : TwiML
    {
        ...
        /// <summary>Service instance Sid</summary>
        public string ServiceInstanceSid { get; set; }

        /// <summary>Inbound autocreation</summary>
        public bool? InboundAutocreation { get; set; }

        /// <summary>Routing assignment timeout</summary>
        public int? RoutingAssignmentTimeout { get; set; }

        /// <summary>Inbound timeout</summary>
