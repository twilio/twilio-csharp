...
namespace Twilio.TwiML.Voice
{
    ...
    /// <summary>Pay Twiml Verb</summary>
    public class Pay : TwiML
    {
        ...
        /// <summary>Input type Twilio should accept</summary>
        public Pay.InputEnum Input { get; set; }

        /// <summary>Action URL</summary>
        public Uri Action { get; set; }

        /// <summary>Bank account type for ach transactions. If set, payment method attribute must be provided and value should be set to ach-debit. defaults to consumer-checking</summary>
        public Pay.BankAccountTypeEnum BankAccountType { get; set; }

        /// <summary>Status callback URL</summary>
        public Uri StatusCallback { get; set; }

        /// <summary>Status callback method</summary>
        public Pay.StatusCallbackMethodEnum StatusCallbackMethod { get; set; }

        /// <summary>Time to wait to gather input</summary>
        public int? Timeout { get; set; }

        /// <summary>Maximum number of allowed retries when gathering input</summary>
        public int? MaxAttempts { get; set; }

        /// <summary>Prompt for security code</summary>
        public bool? SecurityCode { get; set; }

        /// <summary>Prompt for postal code and it should be true/false or default postal code</summary>
        public string PostalCode { get; set; }

        /// <summary>Prompt for minimum postal code length</summary>
        public int? MinPostalCodeLength { get; set; }

        /// <summary>Unique name for payment connector</summary>
        public string PaymentConnector { get; set; }

        /// <summary>Payment method to be used. defaults to credit-card</summary>
        ...
        /// <summary>Amount to process. If value is greater than 0 then make the payment else create a payment token</summary>
        public string ChargeAmount { get; set; }

        /// <summary>Currency of the amount attribute</summary>
        public string Currency { get; set; }

        /// <summary>Details regarding the payment</summary>
        public string Description { get; set; }

        /// <summary>Comma separated accepted card types</summary>
        public IEnumerable<Pay.ValidCardTypesEnum> ValidCardTypes { get; set; }

        /// <summary>Language to use</summary>
        public Pay.LanguageEnum Language { get; set; }

        /// <summary>Create a new Pay</summary>
        ...
        /// <summary>Create a new &lt;Parameter/&gt; element and append it as a child of this element.</summary>
        ...
        /// <summary>Append a &lt;Parameter/&gt; element as a child of this element</summary>
