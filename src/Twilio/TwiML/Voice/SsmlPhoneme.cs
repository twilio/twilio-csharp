...
namespace Twilio.TwiML.Voice
{
    ...
    /// <summary>Using Phonetic Pronunciation in Say</summary>
    public class SsmlPhoneme : TwiML
    {
        ...
        /// <summary>Specify the phonetic alphabet</summary>
        public SsmlPhoneme.AlphabetEnum Alphabet { get; set; }

        /// <summary>Specifiy the phonetic symbols for pronunciation</summary>
        public string Ph { get; set; }

        /// <summary>Create a new SsmlPhoneme</summary>
