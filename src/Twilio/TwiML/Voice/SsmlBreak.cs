...
namespace Twilio.TwiML.Voice
{
    ...
    /// <summary>Adding a Pause in Say</summary>
    public class SsmlBreak : TwiML
    {
        ...
        /// <summary>Set a pause based on strength</summary>
        public SsmlBreak.StrengthEnum Strength { get; set; }

        /// <summary>Set a pause to a specific length of time in seconds or milliseconds, available values: [number]s, [number]ms</summary>
        public string Time { get; set; }

        /// <summary>Create a new SsmlBreak</summary>
