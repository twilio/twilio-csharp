...
namespace Twilio.TwiML.Voice
{
    ...
    /// <summary>Gather TwiML Verb</summary>
    public class Gather : TwiML
    {
        ...
        /// <summary>Time to wait to gather speech input and it should be either auto or a positive integer.</summary>
        public string SpeechTimeout { get; set; }

        /// <summary>Max allowed time for speech input</summary>
        public int? MaxSpeechTime { get; set; }

        /// <summary>Profanity Filter on speech</summary>
        public bool? ProfanityFilter { get; set; }

        /// <summary>Finish gather on key</summary>
        public string FinishOnKey { get; set; }

        /// <summary>Number of digits to collect</summary>
        public int? NumDigits { get; set; }

        /// <summary>Partial result callback URL</summary>
        public Uri PartialResultCallback { get; set; }

        /// <summary>Partial result callback URL method</summary>
        ...
        /// <summary>Speech recognition hints</summary>
        public string Hints { get; set; }

        /// <summary>Stop playing media upon speech</summary>
        public bool? BargeIn { get; set; }

        /// <summary>Allow debug for gather</summary>
        public bool? Debug { get; set; }

        /// <summary>Force webhook to the action URL event if there is no input</summary>
        public bool? ActionOnEmptyResult { get; set; }

        /// <summary>Specify the model that is best suited for your use case</summary>
        public Gather.SpeechModelEnum SpeechModel { get; set; }

        /// <summary>Use enhanced speech model</summary>
        public bool? Enhanced { get; set; }

        /// <summary>Create a new Gather</summary>
