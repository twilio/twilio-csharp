...
namespace Twilio.Rest.Proxy.V1
{
    public class ServiceResource : Resource
    {
        ...
        ///<summary> The SID of the Chat Service Instance </summary> 
        ...
        ///<summary> Default TTL for a Session, in seconds </summary> 
        ...
        ///<summary> The URL we call on each interaction </summary> 
        [JsonProperty("intercept_callback_url")]
        public Uri InterceptCallbackUrl { get; private set; }

        ///<summary> The URL we call when an inbound call or SMS action occurs on a closed or non-existent Session </summary> 
