...
namespace Twilio.Rest.Chat.V2.Service
{
    ...
    public class DeleteRoleOptions : IOptions<RoleResource>
    {
        ...
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.twilio.com/docs/chat/rest/service-resource) to delete the Role resource from. </param>        /// <param name="pathSid"> The SID of the Role resource to delete. </param>
    ...
    public class FetchRoleOptions : IOptions<RoleResource>
    {
        ...
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.twilio.com/docs/chat/rest/service-resource) to fetch the Role resource from. </param>        /// <param name="pathSid"> The SID of the Role resource to fetch. </param>
