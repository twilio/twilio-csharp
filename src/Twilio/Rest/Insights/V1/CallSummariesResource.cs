...
namespace Twilio.Rest.Insights.V1
{
    public class CallSummariesResource : Resource
    {
        ...
        public class CallSummaryAgentSessionSummary
        {
            ...
            public CallSummariesResource.CallSummaryCrelaySessionState SessionState {get; private set;}
            ...
            public class Builder
            {
                ...
                public Builder WithSessionState(CallSummariesResource.CallSummaryCrelaySessionState sessionState)
                {
        ...
        /// <param name="pageSize"> How many resources to return in each list page. The default is 25, and the maximum is 25. </param>
