...
namespace Twilio.Rest.Insights.V1
{
    ...
    public class CallSummariesResource : Resource
    {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of CallSummaries </returns>
        public static ResourceSet<CallSummariesResource> Read(List<string> from = null,
                                                              List<string> to = null,
                                                              List<string> fromCarrier = null,
                                                              List<string> toCarrier = null,
                                                              List<string> fromCountryCode = null,
                                                              List<string> toCountryCode = null,
                                                              bool? branded = null,
                                                              bool? verifiedCaller = null,
                                                              bool? hasTag = null,
                                                              string startTime = null,
                                                              string endTime = null,
                                                              List<CallSummariesResource.CallTypeEnum> callType = null,
                                                              List<CallSummariesResource.CallStateEnum> callState = null,
                                                              List<CallSummariesResource.CallDirectionEnum> direction = null,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of CallSummaries </returns>
        public static async System.Threading.Tasks.Task<ResourceSet<CallSummariesResource>> ReadAsync(List<string> from = null,
                                                                                                      List<string> to = null,
                                                                                                      List<string> fromCarrier = null,
                                                                                                      List<string> toCarrier = null,
                                                                                                      List<string> fromCountryCode = null,
