...
namespace Twilio.Rest.Bulkexports.V1
{
    public class ExportResource : Resource
    {
        ...
        public static TwilioResponse<ExportResource> FetchWithHeaders(FetchExportOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
            return new TwilioResponse<ExportResource>(resource, response.Headers, response.StatusCode);
        }
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<ExportResource>> FetchWithHeadersAsync(FetchExportOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<ExportResource> FetchWithHeaders(
                    string pathResourceType, 
                ITwilioRestClient client = null)
        {
            var options = new FetchExportOptions(pathResourceType){  };
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<ExportResource>> FetchWithHeadersAsync(string pathResourceType, ITwilioRestClient client = null)
        {
            var options = new FetchExportOptions(pathResourceType){  };
