...
namespace Twilio.Rest.Preview.Sync.Service.SyncList
{
    public class SyncListPermissionResource : Resource
    {
        ...
        ///<summary> Sync List SID. </summary> 
        [JsonProperty("list_sid")]
        public string ListSid { get; private set; }

        ///<summary> Identity of the user to whom the Sync List Permission applies. </summary> 
        ...
        ///<summary> URL of this Sync List Permission. </summary> 
        [JsonProperty("url")]
