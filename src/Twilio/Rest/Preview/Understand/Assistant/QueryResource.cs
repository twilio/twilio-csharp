...
namespace Twilio.Rest.Preview.Understand.Assistant
{
    public class QueryResource : Resource
    {
        ...
        /// <param name="tasks"> Constraints the query to a set of tasks. Useful when you need to constrain the paths the user can take. Tasks should be comma separated *task-unique-name-1*, *task-unique-name-2* </param>
        /// <param name="modelBuild"> The Model Build Sid or unique name of the Model Build to be queried. </param>
        /// <param name="field"> Constraints the query to a given Field with an task. Useful when you know the Field you are expecting. It accepts one field in the format *task-unique-name-1*:*field-unique-name* </param>
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Query </returns>
        ...
        /// <param name="language"> An ISO language-country string of the sample. </param>
        /// <param name="modelBuild"> The Model Build Sid or unique name of the Model Build to be queried. </param>
        /// <param name="status"> A string that described the query status. The values can be: pending_review, reviewed, discarded </param>
        ...
        ///<summary> The unique ID of the Account that created this Query. </summary> 
        ...
        ///<summary> The natural language analysis results which include the Task recognized, the confidence score and a list of identified Fields. </summary> 
        ...
        ///<summary> The unique ID of the Model Build queried. </summary> 
        ...
        ///<summary> The communication channel where this end-user input came from </summary> 
