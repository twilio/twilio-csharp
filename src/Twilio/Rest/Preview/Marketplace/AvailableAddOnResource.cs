    ...
    public class AvailableAddOnResource : Resource 
    {
        private static Request BuildFetchRequest(FetchAvailableAddOnOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Get,
                Rest.Domain.Preview,
                "/marketplace/AvailableAddOns/" + options.Sid + "",
                client.Region,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of AvailableAddOn </returns> 
        public static AvailableAddOnResource Fetch(string sid, ITwilioRestClient client = null)
        {
            var options = new FetchAvailableAddOnOptions(sid);
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of AvailableAddOn </returns> 
        public static async System.Threading.Tasks.Task<AvailableAddOnResource> FetchAsync(string sid, ITwilioRestClient client = null)
        {
            var options = new FetchAvailableAddOnOptions(sid);
