    ...
    public class InstalledAddOnExtensionResource : Resource 
    {
        private static Request BuildFetchRequest(FetchInstalledAddOnExtensionOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Get,
                Rest.Domain.Preview,
                "/marketplace/InstalledAddOns/" + options.InstalledAddOnSid + "/Extensions/" + options.Sid + "",
                client.Region,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of InstalledAddOnExtension </returns> 
        public static InstalledAddOnExtensionResource Fetch(string installedAddOnSid, string sid, ITwilioRestClient client = null)
        {
            var options = new FetchInstalledAddOnExtensionOptions(installedAddOnSid, sid);
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of InstalledAddOnExtension </returns> 
        public static async System.Threading.Tasks.Task<InstalledAddOnExtensionResource> FetchAsync(string installedAddOnSid, string sid, ITwilioRestClient client = null)
        {
            var options = new FetchInstalledAddOnExtensionOptions(installedAddOnSid, sid);
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of InstalledAddOnExtension </returns> 
        public static InstalledAddOnExtensionResource Update(string installedAddOnSid, string sid, bool? enabled, ITwilioRestClient client = null)
        {
            var options = new UpdateInstalledAddOnExtensionOptions(installedAddOnSid, sid, enabled);
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of InstalledAddOnExtension </returns> 
        public static async System.Threading.Tasks.Task<InstalledAddOnExtensionResource> UpdateAsync(string installedAddOnSid, string sid, bool? enabled, ITwilioRestClient client = null)
        {
            var options = new UpdateInstalledAddOnExtensionOptions(installedAddOnSid, sid, enabled);
        ...
        private static Request BuildReadRequest(ReadInstalledAddOnExtensionOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Get,
                Rest.Domain.Preview,
                "/marketplace/InstalledAddOns/" + options.InstalledAddOnSid + "/Extensions",
                client.Region,
                queryParams: options.GetParams()
            );
        }
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of InstalledAddOnExtension </returns> 
        public static ResourceSet<InstalledAddOnExtensionResource> Read(string installedAddOnSid, int? pageSize = null, long? limit = null, ITwilioRestClient client = null)
        {
            var options = new ReadInstalledAddOnExtensionOptions(installedAddOnSid){PageSize = pageSize, Limit = limit};
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of InstalledAddOnExtension </returns> 
        public static async System.Threading.Tasks.Task<ResourceSet<InstalledAddOnExtensionResource>> ReadAsync(string installedAddOnSid, int? pageSize = null, long? limit = null, ITwilioRestClient client = null)
        {
            var options = new ReadInstalledAddOnExtensionOptions(installedAddOnSid){PageSize = pageSize, Limit = limit};
