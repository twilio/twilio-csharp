...
namespace Twilio.Rest.Preview.Wireless.Sim
{
    public class UsageResource : Resource
    {
        ...
        public static async System.Threading.Tasks.Task<UsageResource> FetchAsync(FetchUsageOptions options, ITwilioRestClient client = null,  CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
