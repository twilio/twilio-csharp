    ...
    public class BrandedChannelResource : Resource
    {
        private static Request BuildFetchRequest(FetchBrandedChannelOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Get,
                Rest.Domain.Preview,
                "/TrustedComms/Businesses/" + options.PathBusinessSid + "/Brands/" + options.PathBrandSid + "/BrandedChannels/" + options.PathSid + "",
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of BrandedChannel </returns>
        public static BrandedChannelResource Fetch(string pathBusinessSid,
                                                   string pathBrandSid,
                                                   string pathSid,
                                                   ITwilioRestClient client = null)
        {
            var options = new FetchBrandedChannelOptions(pathBusinessSid, pathBrandSid, pathSid);
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of BrandedChannel </returns>
        public static async System.Threading.Tasks.Task<BrandedChannelResource> FetchAsync(string pathBusinessSid,
                                                                                           string pathBrandSid,
                                                                                           string pathSid,
                                                                                           ITwilioRestClient client = null)
        {
