...
namespace Twilio.Rest.Sync.V1.Service
{
    ...
    public class SyncListResource : Resource
    {
        ...
        /// <param name="hideExpired"> Hide expired Sync Lists and show only active ones. </param>
        /// <param name="pageSize"> Page size </param>
        /// <param name="limit"> Record limit </param>
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of SyncList </returns>
        public static ResourceSet<SyncListResource> Read(string pathServiceSid,
                                                         SyncListResource.HideExpiredTypeEnum hideExpired = null,
                                                         int? pageSize = null,
                                                         long? limit = null,
                                                         ITwilioRestClient client = null)
        {
            var options = new ReadSyncListOptions(pathServiceSid){HideExpired = hideExpired, PageSize = pageSize, Limit = limit};
