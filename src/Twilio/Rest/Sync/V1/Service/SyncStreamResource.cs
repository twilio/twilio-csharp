...
namespace Twilio.Rest.Sync.V1.Service
{
    public class SyncStreamResource : Resource
    {
        ...
        public static TwilioResponse<SyncStreamResource> CreateWithHeaders(CreateSyncStreamOptions options, ITwilioRestClient client = null) 
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildCreateRequest(options, client));
            var resource = FromJson(response.Content);
            return new TwilioResponse<SyncStreamResource>(resource, response.Headers, response.StatusCode);
        }

        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<SyncStreamResource>> CreateWithHeadersAsync(CreateSyncStreamOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildCreateRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<SyncStreamResource> CreateWithHeaders(
            string pathServiceSid,
            string uniqueName = null,
            int? ttl = null,
        ITwilioRestClient client = null)
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<SyncStreamResource>> CreateWithHeadersAsync(
            string pathServiceSid,
            string uniqueName = null,
            int? ttl = null,
        ITwilioRestClient client = null)
        ...
        public static TwilioResponse<bool> DeleteWithHeaders(DeleteSyncStreamOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildDeleteRequest(options, client));
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<bool>> DeleteWithHeadersAsync(DeleteSyncStreamOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildDeleteRequest(options, client));
            var success = (int)response.StatusCode >= 200 && (int)response.StatusCode < 400;
        ...
        public static TwilioResponse<SyncStreamResource> FetchWithHeaders(FetchSyncStreamOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<SyncStreamResource>> FetchWithHeadersAsync(FetchSyncStreamOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<SyncStreamResource> FetchWithHeaders(
                    string pathServiceSid, 
                    string pathSid, 
                ITwilioRestClient client = null)
        {
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<SyncStreamResource>> FetchWithHeadersAsync(string pathServiceSid, string pathSid, ITwilioRestClient client = null)
        {
            var options = new FetchSyncStreamOptions(pathServiceSid, pathSid){  };
        ...
        public static ResourceSetResponse<SyncStreamResource> ReadWithHeaders(ReadSyncStreamOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildReadRequest(options, client));
            var page = Page<SyncStreamResource>.FromJson("streams", response.Content);
            var records = new ResourceSet<SyncStreamResource>(page, options, client);
            return new ResourceSetResponse<SyncStreamResource>(records, response.Headers, response.StatusCode);
        }

        public static ResourceSetResponse<SyncStreamResource> ReadWithHeaders(
            string pathServiceSid,
            long? pageSize = null,
            long? limit = null,
            ITwilioRestClient client = null)
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<ResourceSetResponse<SyncStreamResource>> ReadWithHeadersAsync(ReadSyncStreamOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildReadRequest(options, client));
        ...
        public static TwilioResponse<SyncStreamResource> UpdateWithHeaders(UpdateSyncStreamOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildUpdateRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<SyncStreamResource>> UpdateWithHeadersAsync(UpdateSyncStreamOptions options,
        ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildUpdateRequest(options, client));
        ...
        public static TwilioResponse<SyncStreamResource> UpdateWithHeaders(
            string pathServiceSid,
            string pathSid,
            int? ttl = null,
        ITwilioRestClient client = null)
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<SyncStreamResource>> UpdateWithHeadersAsync(
            string pathServiceSid,
            string pathSid,
            int? ttl = null,
        ITwilioRestClient client = null)
