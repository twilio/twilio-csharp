...
namespace Twilio.Rest.Assistants.V1
{
    public class ToolResource : Resource
    {
        ...
        public static async System.Threading.Tasks.Task<ToolResource> CreateAsync(CreateToolOptions options, ITwilioRestClient client = null,  CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of Tool </returns>
        public static async System.Threading.Tasks.Task<ToolResource> FetchAsync(FetchToolOptions options, ITwilioRestClient client = null,  CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of Tool </returns>
        public static async System.Threading.Tasks.Task<ToolResource> FetchAsync(string pathId, ITwilioRestClient client = null,  CancellationToken cancellationToken = default)
        {
            var options = new FetchToolOptions(pathId){  };
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of Tool </returns>
        public static async System.Threading.Tasks.Task<ResourceSet<ToolResource>> ReadAsync(ReadToolOptions options, ITwilioRestClient client = null,  CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
