...
namespace Twilio.Rest.Assistants.V1
{
    public class PolicyResource : Resource
    {
        ...
        public static async System.Threading.Tasks.Task<ResourceSet<PolicyResource>> ReadAsync(ReadPolicyOptions options, ITwilioRestClient client = null,  System.Threading.CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
