...
namespace Twilio.Rest.Assistants.V1.Knowledge
{
    public class KnowledgeStatusResource : Resource
    {
        ...
        public static async System.Threading.Tasks.Task<KnowledgeStatusResource> FetchAsync(FetchKnowledgeStatusOptions options, ITwilioRestClient client = null,  CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of KnowledgeStatus </returns>
        public static async System.Threading.Tasks.Task<KnowledgeStatusResource> FetchAsync(string pathId, ITwilioRestClient client = null,  CancellationToken cancellationToken = default)
        {
            var options = new FetchKnowledgeStatusOptions(pathId){  };
