...
namespace Twilio.Rest.Api.V2010.Account.Call
{
    public class NotificationResource : Resource
    {
        ...
        ///<summary> A unique error code corresponding to the notification </summary> 
        [JsonProperty("error_code")]
        public string ErrorCode { get; private set; }

        ///<summary> An integer log level </summary> 
        [JsonProperty("log")]
        public string Log { get; private set; }

        ///<summary> The date the notification was generated </summary> 
        ...
        ///<summary> A URL for more information about the error code </summary> 
        [JsonProperty("more_info")]
        public Uri MoreInfo { get; private set; }

        ///<summary> HTTP method used with the request url </summary> 
        [JsonProperty("request_method")]
        public Twilio.Http.HttpMethod RequestMethod { get; private set; }

        ///<summary> URL of the resource that generated the notification </summary> 
        [JsonProperty("request_url")]
        public Uri RequestUrl { get; private set; }

        ///<summary> Twilio-generated HTTP variables sent to the server </summary> 
