...
namespace Twilio.Rest.Api.V2010.Account.Call
{
    public class StreamResource : Resource
    {
        ...
        public static async System.Threading.Tasks.Task<StreamResource> CreateAsync(CreateStreamOptions options, ITwilioRestClient client = null , System.Threading.CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
