...
namespace Twilio.Rest.Api.V2010.Account.Call
{
    public class StreamResource : Resource
    {
        ...
        private static Request BuildCreateRequest(CreateStreamOptions options, ITwilioRestClient client)
        {
        ...
        public static StreamResource Create(CreateStreamOptions options, ITwilioRestClient client = null)
        {
        ...
        public static async System.Threading.Tasks.Task<StreamResource> CreateAsync(CreateStreamOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        public static StreamResource Create(
                                          ...
                                          string name = null,
                                          StreamResource.TrackEnum track = null,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of Stream </returns>
        public static async System.Threading.Tasks.Task<StreamResource> CreateAsync(
                                                                                  string pathCallSid,
                                                                                  Uri url,
                                                                                  string pathAccountSid = null,
                                                                                  string name = null,
        ...
        public static TwilioResponse<StreamResource> CreateWithHeaders(CreateStreamOptions options, ITwilioRestClient client = null) 
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildCreateRequest(options, client));
            var resource = FromJson(response.Content);
            return new TwilioResponse<StreamResource>(resource, response.Headers, response.StatusCode);
        }

        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<StreamResource>> CreateWithHeadersAsync(CreateStreamOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildCreateRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<StreamResource> CreateWithHeaders(
            string pathCallSid,
            Uri url,
            string pathAccountSid = null,
            string name = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<StreamResource>> CreateWithHeadersAsync(
            string pathCallSid,
            Uri url,
            string pathAccountSid = null,
            string name = null,
        ...
        private static Request BuildUpdateRequest(UpdateStreamOptions options, ITwilioRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Stream </returns>
        public static StreamResource Update(UpdateStreamOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// <returns> Task that resolves to A single instance of Stream </returns>
        #if !NET35
        public static async System.Threading.Tasks.Task<StreamResource> UpdateAsync(UpdateStreamOptions options,
                                                                                                    ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Stream </returns>
        public static StreamResource Update(
                                          string pathCallSid,
                                          string pathSid,
                                          StreamResource.UpdateStatusEnum status,
                                          string pathAccountSid = null,
                                            ITwilioRestClient client = null)
        {
            var options = new UpdateStreamOptions(pathCallSid, pathSid, status){ PathAccountSid = pathAccountSid };
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of Stream </returns>
        public static async System.Threading.Tasks.Task<StreamResource> UpdateAsync(
                                                                              string pathCallSid,
                                                                              string pathSid,
                                                                              StreamResource.UpdateStatusEnum status,
                                                                              string pathAccountSid = null,
        ...
        public static TwilioResponse<StreamResource> UpdateWithHeaders(UpdateStreamOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildUpdateRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<StreamResource>> UpdateWithHeadersAsync(UpdateStreamOptions options,
        ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildUpdateRequest(options, client));
        ...
        public static TwilioResponse<StreamResource> UpdateWithHeaders(
            string pathCallSid,
            string pathSid,
            StreamResource.UpdateStatusEnum status,
            string pathAccountSid = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<StreamResource>> UpdateWithHeadersAsync(
            string pathCallSid,
            string pathSid,
            StreamResource.UpdateStatusEnum status,
            string pathAccountSid = null,
        ...
        public static StreamResource FromJson(string json)
        {
            try
            {
                return JsonConvert.DeserializeObject<StreamResource>(json);
            }
    ...
    public static string ToJson(object model)
    {
        ...
        [JsonProperty("status")]
        public StreamResource.StatusEnum Status { get; private set; }
