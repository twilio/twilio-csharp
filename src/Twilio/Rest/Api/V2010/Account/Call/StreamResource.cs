    ...
    public class StreamResource : Resource
    {
        ...
        private static Request BuildCreateRequest(CreateStreamOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Post,
                Rest.Domain.Api,
                "/2010-04-01/Accounts/" + (options.PathAccountSid ?? client.AccountSid) + "/Calls/" + options.PathCallSid + "/Streams.json",
        ...
        public static async System.Threading.Tasks.Task<StreamResource> CreateAsync(CreateStreamOptions options,
        ...
        /// <param name="pathAccountSid"> The SID of the Account that created this resource </param>
        /// <param name="name"> The name of this resource </param>
        /// <param name="url"> Url where WebSocket connection will be established. </param>
        /// <param name="track"> One of `inbound_track`, `outbound_track`, `both_tracks`. </param>
        /// <param name="statusCallback"> Absolute URL of the status callback. </param>
        /// <param name="statusCallbackMethod"> The http method for the status_callback. </param>
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Stream </returns>
        public static StreamResource Create(string pathCallSid,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of Stream </returns>
        public static async System.Threading.Tasks.Task<StreamResource> CreateAsync(string pathCallSid,
                                                                                    string pathAccountSid = null,
                                                                                    string name = null,
                                                                                    Uri url = null,
                                                                                    StreamResource.TrackEnum track = null,
        ...
        private static Request BuildUpdateRequest(UpdateStreamOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Post,
                Rest.Domain.Api,
                "/2010-04-01/Accounts/" + (options.PathAccountSid ?? client.AccountSid) + "/Calls/" + options.PathCallSid + "/Streams/" + options.PathSid + ".json",
                postParams: options.GetParams(),
                headerParams: null
            );
        }
        ...
        /// </summary>
        /// <param name="pathCallSid"> The SID of the Call the resource is associated with </param>
        /// <param name="pathSid"> The SID of the Stream resource, or the `name` </param>
        /// <param name="status"> The status. Must have the value `stopped` </param>
        /// <param name="pathAccountSid"> The SID of the Account that created this resource </param>
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Stream </returns>
        public static StreamResource Update(string pathCallSid,
                                            string pathSid,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of Stream </returns>
        public static async System.Threading.Tasks.Task<StreamResource> UpdateAsync(string pathCallSid,
                                                                                    string pathSid,
                                                                                    StreamResource.UpdateStatusEnum status,
                                                                                    string pathAccountSid = null,
                                                                                    ITwilioRestClient client = null)
