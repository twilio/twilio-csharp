...
namespace Twilio.Rest.Api.V2010.Account.Call
{
    public class SiprecResource : Resource
    {
        ...
        public static async System.Threading.Tasks.Task<SiprecResource> CreateAsync(CreateSiprecOptions options, ITwilioRestClient client = null , System.Threading.CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
