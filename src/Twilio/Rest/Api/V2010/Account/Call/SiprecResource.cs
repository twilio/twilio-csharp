    ...
    public class SiprecResource : Resource
    {
        ...
        private static Request BuildCreateRequest(CreateSiprecOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Post,
                Rest.Domain.Api,
                "/2010-04-01/Accounts/" + (options.PathAccountSid ?? client.AccountSid) + "/Calls/" + options.PathCallSid + "/Siprec.json",
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Siprec </returns>
        public static SiprecResource Create(string pathCallSid,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of Siprec </returns>
        public static async System.Threading.Tasks.Task<SiprecResource> CreateAsync(string pathCallSid,
                                                                                    string pathAccountSid = null,
                                                                                    string name = null,
                                                                                    string connectorName = null,
                                                                                    SiprecResource.TrackEnum track = null,
        ...
        private static Request BuildUpdateRequest(UpdateSiprecOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Post,
                Rest.Domain.Api,
                "/2010-04-01/Accounts/" + (options.PathAccountSid ?? client.AccountSid) + "/Calls/" + options.PathCallSid + "/Siprec/" + options.PathSid + ".json",
                postParams: options.GetParams(),
                headerParams: null
            );
        }
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Siprec </returns>
        public static SiprecResource Update(string pathCallSid,
                                            string pathSid,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of Siprec </returns>
        public static async System.Threading.Tasks.Task<SiprecResource> UpdateAsync(string pathCallSid,
                                                                                    string pathSid,
                                                                                    SiprecResource.UpdateStatusEnum status,
                                                                                    string pathAccountSid = null,
                                                                                    ITwilioRestClient client = null)
