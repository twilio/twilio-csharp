...
namespace Twilio.Rest.Api.V2010.Account.Call
{
    public class SiprecResource : Resource
    {
        ...
        public static TwilioResponse<SiprecResource> CreateWithHeaders(CreateSiprecOptions options, ITwilioRestClient client = null) 
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildCreateRequest(options, client));
            var resource = FromJson(response.Content);
            return new TwilioResponse<SiprecResource>(resource, response.Headers, response.StatusCode);
        }

        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<SiprecResource>> CreateWithHeadersAsync(CreateSiprecOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildCreateRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<SiprecResource> CreateWithHeaders(
            string pathCallSid,
            string pathAccountSid = null,
            string name = null,
            string connectorName = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<SiprecResource>> CreateWithHeadersAsync(
            string pathCallSid,
            string pathAccountSid = null,
            string name = null,
            string connectorName = null,
        ...
        public static TwilioResponse<SiprecResource> UpdateWithHeaders(UpdateSiprecOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildUpdateRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<SiprecResource>> UpdateWithHeadersAsync(UpdateSiprecOptions options,
        ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildUpdateRequest(options, client));
        ...
        public static TwilioResponse<SiprecResource> UpdateWithHeaders(
            string pathCallSid,
            string pathSid,
            SiprecResource.UpdateStatusEnum status,
            string pathAccountSid = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<SiprecResource>> UpdateWithHeadersAsync(
            string pathCallSid,
            string pathSid,
            SiprecResource.UpdateStatusEnum status,
            string pathAccountSid = null,
