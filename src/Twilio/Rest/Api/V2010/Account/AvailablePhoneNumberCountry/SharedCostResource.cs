...
namespace Twilio.Rest.Api.V2010.Account.AvailablePhoneNumberCountry
{
    public class SharedCostResource : Resource
    {
        ...
        public static ResourceSet<SharedCostResource> Read(ReadSharedCostOptions options, ITwilioRestClient client = null)
        {
        ...
        public static async System.Threading.Tasks.Task<ResourceSet<SharedCostResource>> ReadAsync(ReadSharedCostOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        public static ResourceSetResponse<SharedCostResource> ReadWithHeaders(ReadSharedCostOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildReadRequest(options, client));
            var page = Page<SharedCostResource>.FromJson("available_phone_numbers", response.Content);
            var records = new ResourceSet<SharedCostResource>(page, options, client);
            return new ResourceSetResponse<SharedCostResource>(records, response.Headers, response.StatusCode);
        }

        public static ResourceSetResponse<SharedCostResource> ReadWithHeaders(
            string pathCountryCode,
            string pathAccountSid = null,
            int? areaCode = null,
            string contains = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<ResourceSetResponse<SharedCostResource>> ReadWithHeadersAsync(ReadSharedCostOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildReadRequest(options, client));
        ...
        public static Page<SharedCostResource> GetPage(string targetUrl, ITwilioRestClient client)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        public static Page<SharedCostResource> NextPage(Page<SharedCostResource> page, ITwilioRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<SharedCostResource> PreviousPage(Page<SharedCostResource> page, ITwilioRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
