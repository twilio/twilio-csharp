...
namespace Twilio.Rest.Api.V2010.Account.AvailablePhoneNumberCountry
{
    public class SharedCostResource : Resource
    {
        ...
        public static async System.Threading.Tasks.Task<ResourceSet<SharedCostResource>> ReadAsync(ReadSharedCostOptions options, ITwilioRestClient client = null,  System.Threading.CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
