...
namespace Twilio.Rest.Api.V2010.Account.AvailablePhoneNumberCountry
{
    public class NationalResource : Resource
    {
        ...
        public static ResourceSetResponse<NationalResource> ReadWithHeaders(ReadNationalOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildReadRequest(options, client));
            var page = Page<NationalResource>.FromJson("available_phone_numbers", response.Content);
            var records = new ResourceSet<NationalResource>(page, options, client);
            return new ResourceSetResponse<NationalResource>(records, response.Headers, response.StatusCode);
        }

        public static ResourceSetResponse<NationalResource> ReadWithHeaders(
            string pathCountryCode,
            string pathAccountSid = null,
            int? areaCode = null,
            string contains = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<ResourceSetResponse<NationalResource>> ReadWithHeadersAsync(ReadNationalOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildReadRequest(options, client));
