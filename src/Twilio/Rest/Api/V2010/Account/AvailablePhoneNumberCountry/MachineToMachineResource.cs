...
namespace Twilio.Rest.Api.V2010.Account.AvailablePhoneNumberCountry
{
    public class MachineToMachineResource : Resource
    {
        ...
        public static async System.Threading.Tasks.Task<ResourceSet<MachineToMachineResource>> ReadAsync(ReadMachineToMachineOptions options, ITwilioRestClient client = null,  CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
