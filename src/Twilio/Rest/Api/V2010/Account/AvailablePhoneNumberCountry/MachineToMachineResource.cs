...
namespace Twilio.Rest.Api.V2010.Account.AvailablePhoneNumberCountry
{
    public class MachineToMachineResource : Resource
    {
        ...
        public static ResourceSet<MachineToMachineResource> Read(ReadMachineToMachineOptions options, ITwilioRestClient client = null)
        {
        ...
        public static async System.Threading.Tasks.Task<ResourceSet<MachineToMachineResource>> ReadAsync(ReadMachineToMachineOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// <param name="contains"> Matching pattern to identify phone numbers. This pattern can be between 2 and 16 characters long and allows all digits (0-9) and all non-diacritic latin alphabet letters (a-z, A-Z). It accepts four meta-characters: `*`, `%`, `+`, `$`. The `*` and `%` meta-characters can appear multiple times in the pattern. To match wildcards at the beginning or end of the pattern, use `*` to match any single character or `%` to match a sequence of characters. If you use the wildcard patterns, it must include at least two non-meta-characters, and wildcards cannot be used between non-meta-characters. To match the beginning of a pattern, start the pattern with `+`. To match the end of the pattern, append the pattern with `$`. These meta-characters can't be adjacent to each other. </param>
        ...
        public static ResourceSetResponse<MachineToMachineResource> ReadWithHeaders(ReadMachineToMachineOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildReadRequest(options, client));
            var page = Page<MachineToMachineResource>.FromJson("available_phone_numbers", response.Content);
            var records = new ResourceSet<MachineToMachineResource>(page, options, client);
            return new ResourceSetResponse<MachineToMachineResource>(records, response.Headers, response.StatusCode);
        }

        public static ResourceSetResponse<MachineToMachineResource> ReadWithHeaders(
            string pathCountryCode,
            string pathAccountSid = null,
            int? areaCode = null,
            string contains = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<ResourceSetResponse<MachineToMachineResource>> ReadWithHeadersAsync(ReadMachineToMachineOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildReadRequest(options, client));
        ...
        public static Page<MachineToMachineResource> PreviousPage(Page<MachineToMachineResource> page, ITwilioRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
