...
namespace Twilio.Rest.Api.V2010.Account.Sip.Domain.AuthTypes.AuthTypeCalls
{
    public class AuthCallsCredentialListMappingResource : Resource
    {
        ...
        public static TwilioResponse<AuthCallsCredentialListMappingResource> CreateWithHeaders(CreateAuthCallsCredentialListMappingOptions options, ITwilioRestClient client = null) 
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildCreateRequest(options, client));
            var resource = FromJson(response.Content);
            return new TwilioResponse<AuthCallsCredentialListMappingResource>(resource, response.Headers, response.StatusCode);
        }

        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<AuthCallsCredentialListMappingResource>> CreateWithHeadersAsync(CreateAuthCallsCredentialListMappingOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildCreateRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<AuthCallsCredentialListMappingResource> CreateWithHeaders(
            string pathDomainSid,
            string credentialListSid,
            string pathAccountSid = null,
        ITwilioRestClient client = null)
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<AuthCallsCredentialListMappingResource>> CreateWithHeadersAsync(
            string pathDomainSid,
            string credentialListSid,
            string pathAccountSid = null,
        ITwilioRestClient client = null)
        ...
        public static TwilioResponse<bool> DeleteWithHeaders(DeleteAuthCallsCredentialListMappingOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildDeleteRequest(options, client));
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<bool>> DeleteWithHeadersAsync(DeleteAuthCallsCredentialListMappingOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildDeleteRequest(options, client));
            var success = (int)response.StatusCode >= 200 && (int)response.StatusCode < 400;
        ...
        public static TwilioResponse<AuthCallsCredentialListMappingResource> FetchWithHeaders(FetchAuthCallsCredentialListMappingOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<AuthCallsCredentialListMappingResource>> FetchWithHeadersAsync(FetchAuthCallsCredentialListMappingOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<AuthCallsCredentialListMappingResource> FetchWithHeaders(
                    string pathDomainSid, 
                    string pathSid, 
                    string pathAccountSid = null, 
                ITwilioRestClient client = null)
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<AuthCallsCredentialListMappingResource>> FetchWithHeadersAsync(string pathDomainSid, string pathSid, string pathAccountSid = null, ITwilioRestClient client = null)
        {
            var options = new FetchAuthCallsCredentialListMappingOptions(pathDomainSid, pathSid){ PathAccountSid = pathAccountSid };
        ...
        public static ResourceSetResponse<AuthCallsCredentialListMappingResource> ReadWithHeaders(ReadAuthCallsCredentialListMappingOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildReadRequest(options, client));
            var page = Page<AuthCallsCredentialListMappingResource>.FromJson("contents", response.Content);
            var records = new ResourceSet<AuthCallsCredentialListMappingResource>(page, options, client);
            return new ResourceSetResponse<AuthCallsCredentialListMappingResource>(records, response.Headers, response.StatusCode);
        }

        public static ResourceSetResponse<AuthCallsCredentialListMappingResource> ReadWithHeaders(
            string pathDomainSid,
            string pathAccountSid = null,
            long? pageSize = null,
            long? limit = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<ResourceSetResponse<AuthCallsCredentialListMappingResource>> ReadWithHeadersAsync(ReadAuthCallsCredentialListMappingOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildReadRequest(options, client));
