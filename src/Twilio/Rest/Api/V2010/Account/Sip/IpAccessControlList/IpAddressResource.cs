...
namespace Twilio.Rest.Api.V2010.Account.Sip.IpAccessControlList
{
    public class IpAddressResource : Resource
    {
        ...
        public static TwilioResponse<IpAddressResource> CreateWithHeaders(CreateIpAddressOptions options, ITwilioRestClient client = null) 
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildCreateRequest(options, client));
            var resource = FromJson(response.Content);
            return new TwilioResponse<IpAddressResource>(resource, response.Headers, response.StatusCode);
        }

        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<IpAddressResource>> CreateWithHeadersAsync(CreateIpAddressOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildCreateRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<IpAddressResource> CreateWithHeaders(
            string pathIpAccessControlListSid,
            string friendlyName,
            string ipAddress,
            string pathAccountSid = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<IpAddressResource>> CreateWithHeadersAsync(
            string pathIpAccessControlListSid,
            string friendlyName,
            string ipAddress,
            string pathAccountSid = null,
        ...
        public static TwilioResponse<bool> DeleteWithHeaders(DeleteIpAddressOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildDeleteRequest(options, client));
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<bool>> DeleteWithHeadersAsync(DeleteIpAddressOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildDeleteRequest(options, client));
            var success = (int)response.StatusCode >= 200 && (int)response.StatusCode < 400;
        ...
        public static TwilioResponse<bool> DeleteWithHeaders(string pathIpAccessControlListSid, string pathSid, string pathAccountSid = null, ITwilioRestClient client = null)
        {
            var options = new DeleteIpAddressOptions(pathIpAccessControlListSid, pathSid)         { PathAccountSid = pathAccountSid }   ;
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<bool>> DeleteWithHeadersAsync(string pathIpAccessControlListSid, string pathSid, string pathAccountSid = null, ITwilioRestClient client = null)
        {
            var options = new DeleteIpAddressOptions(pathIpAccessControlListSid, pathSid)  { PathAccountSid = pathAccountSid };
        ...
        public static TwilioResponse<IpAddressResource> FetchWithHeaders(FetchIpAddressOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<IpAddressResource>> FetchWithHeadersAsync(FetchIpAddressOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<IpAddressResource> FetchWithHeaders(
                    string pathIpAccessControlListSid, 
                    string pathSid, 
                    string pathAccountSid = null, 
                ITwilioRestClient client = null)
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<IpAddressResource>> FetchWithHeadersAsync(string pathIpAccessControlListSid, string pathSid, string pathAccountSid = null, ITwilioRestClient client = null)
        {
            var options = new FetchIpAddressOptions(pathIpAccessControlListSid, pathSid){ PathAccountSid = pathAccountSid };
        ...
        public static ResourceSetResponse<IpAddressResource> ReadWithHeaders(ReadIpAddressOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildReadRequest(options, client));
            var page = Page<IpAddressResource>.FromJson("ip_addresses", response.Content);
            var records = new ResourceSet<IpAddressResource>(page, options, client);
            return new ResourceSetResponse<IpAddressResource>(records, response.Headers, response.StatusCode);
        }

        public static ResourceSetResponse<IpAddressResource> ReadWithHeaders(
            string pathIpAccessControlListSid,
            string pathAccountSid = null,
            long? pageSize = null,
            long? limit = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<ResourceSetResponse<IpAddressResource>> ReadWithHeadersAsync(ReadIpAddressOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildReadRequest(options, client));
        ...
        public static TwilioResponse<IpAddressResource> UpdateWithHeaders(UpdateIpAddressOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildUpdateRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<IpAddressResource>> UpdateWithHeadersAsync(UpdateIpAddressOptions options,
        ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildUpdateRequest(options, client));
        ...
        public static TwilioResponse<IpAddressResource> UpdateWithHeaders(
            string pathIpAccessControlListSid,
            string pathSid,
            string pathAccountSid = null,
            string ipAddress = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<IpAddressResource>> UpdateWithHeadersAsync(
            string pathIpAccessControlListSid,
            string pathSid,
            string pathAccountSid = null,
            string ipAddress = null,
