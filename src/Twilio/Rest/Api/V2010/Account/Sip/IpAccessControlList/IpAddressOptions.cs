...
namespace Twilio.Rest.Api.V2010.Account.Sip.IpAccessControlList
{
    ...
    public class CreateIpAddressOptions : IOptions<IpAddressResource>
    {
        ...
        /// <param name="pathIpAccessControlListSid"> The IpAccessControlList Sid with which to associate the created IpAddress resource. </param>        /// <param name="friendlyName"> A human readable descriptive text for this resource, up to 255 characters long. </param>        /// <param name="ipAddress"> An IP address in dotted decimal notation from which you want to accept traffic. Any SIP requests from this IP address will be allowed by Twilio. IPv4 only supported today. </param>
    ...
    public class DeleteIpAddressOptions : IOptions<IpAddressResource>
    {
        ...
        /// <param name="pathIpAccessControlListSid"> The IpAccessControlList Sid that identifies the IpAddress resources to delete. </param>        /// <param name="pathSid"> A 34 character string that uniquely identifies the resource to delete. </param>
    ...
    public class FetchIpAddressOptions : IOptions<IpAddressResource>
    {
        ...
        /// <param name="pathIpAccessControlListSid"> The IpAccessControlList Sid that identifies the IpAddress resources to fetch. </param>        /// <param name="pathSid"> A 34 character string that uniquely identifies the IpAddress resource to fetch. </param>
    ...
    public class UpdateIpAddressOptions : IOptions<IpAddressResource>
    {
        ...
        /// <param name="pathIpAccessControlListSid"> The IpAccessControlList Sid that identifies the IpAddress resources to update. </param>        /// <param name="pathSid"> A 34 character string that identifies the IpAddress resource to update. </param>
