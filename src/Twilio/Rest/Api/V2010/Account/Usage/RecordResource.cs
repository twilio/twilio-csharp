...
namespace Twilio.Rest.Api.V2010.Account.Usage
{
    public class RecordResource : Resource
    {
        ...
        public static ResourceSetResponse<RecordResource> ReadWithHeaders(ReadRecordOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildReadRequest(options, client));
            var page = Page<RecordResource>.FromJson("usage_records", response.Content);
            var records = new ResourceSet<RecordResource>(page, options, client);
            return new ResourceSetResponse<RecordResource>(records, response.Headers, response.StatusCode);
        }

        public static ResourceSetResponse<RecordResource> ReadWithHeaders(
            string pathAccountSid = null,
            string category = null,
            DateTime? startDate = null,
            DateTime? endDate = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<ResourceSetResponse<RecordResource>> ReadWithHeadersAsync(ReadRecordOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildReadRequest(options, client));
