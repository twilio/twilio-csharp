...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record
{
    public class YesterdayResource : Resource
    {
        ...
        public static async System.Threading.Tasks.Task<ResourceSet<YesterdayResource>> ReadAsync(ReadYesterdayOptions options, ITwilioRestClient client = null,  System.Threading.CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
