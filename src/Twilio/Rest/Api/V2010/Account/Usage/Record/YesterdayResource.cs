...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record
{
    public class YesterdayResource : Resource
    {
        ...
        public static ResourceSetResponse<YesterdayResource> ReadWithHeaders(ReadYesterdayOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildReadRequest(options, client));
            var page = Page<YesterdayResource>.FromJson("usage_records", response.Content);
            var records = new ResourceSet<YesterdayResource>(page, options, client);
            return new ResourceSetResponse<YesterdayResource>(records, response.Headers, response.StatusCode);
        }

        public static ResourceSetResponse<YesterdayResource> ReadWithHeaders(
            string pathAccountSid = null,
            string category = null,
            DateTime? startDate = null,
            DateTime? endDate = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<ResourceSetResponse<YesterdayResource>> ReadWithHeadersAsync(ReadYesterdayOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildReadRequest(options, client));
