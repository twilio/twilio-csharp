...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record
{
    public class ThisMonthResource : Resource
    {
        ...
        public static async System.Threading.Tasks.Task<ResourceSet<ThisMonthResource>> ReadAsync(ReadThisMonthOptions options, ITwilioRestClient client = null,  CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
