...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record
{
    public class ThisMonthResource : Resource
    {
        ...
        public static ResourceSetResponse<ThisMonthResource> ReadWithHeaders(ReadThisMonthOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildReadRequest(options, client));
            var page = Page<ThisMonthResource>.FromJson("usage_records", response.Content);
            var records = new ResourceSet<ThisMonthResource>(page, options, client);
            return new ResourceSetResponse<ThisMonthResource>(records, response.Headers, response.StatusCode);
        }

        public static ResourceSetResponse<ThisMonthResource> ReadWithHeaders(
            string pathAccountSid = null,
            string category = null,
            DateTime? startDate = null,
            DateTime? endDate = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<ResourceSetResponse<ThisMonthResource>> ReadWithHeadersAsync(ReadThisMonthOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildReadRequest(options, client));
