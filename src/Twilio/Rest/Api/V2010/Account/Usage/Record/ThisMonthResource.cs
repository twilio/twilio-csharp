...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record 
{
    ...
    public class ThisMonthResource : Resource 
    {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of ThisMonth </returns> 
        public static ResourceSet<ThisMonthResource> Read(string pathAccountSid = null, 
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of ThisMonth </returns> 
        public static async System.Threading.Tasks.Task<ResourceSet<ThisMonthResource>> ReadAsync(string pathAccountSid = null, 
                                                                                                  ThisMonthResource.CategoryEnum category = null, 
                                                                                                  DateTime? startDate = null, 
                                                                                                  DateTime? endDate = null, 
                                                                                                  int? pageSize = null, 
