...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record 
{
    ...
    public class LastMonthResource : Resource 
    {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of LastMonth </returns> 
        public static ResourceSet<LastMonthResource> Read(string pathAccountSid = null, LastMonthResource.CategoryEnum category = null, DateTime? startDate = null, DateTime? endDate = null, int? pageSize = null, long? limit = null, ITwilioRestClient client = null)
        {
