...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record 
{
    ...
    public class AllTimeResource : Resource 
    {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of AllTime </returns> 
        public static ResourceSet<AllTimeResource> Read(string pathAccountSid = null, AllTimeResource.CategoryEnum category = null, DateTime? startDate = null, DateTime? endDate = null, int? pageSize = null, long? limit = null, ITwilioRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of AllTime </returns> 
        public static async System.Threading.Tasks.Task<ResourceSet<AllTimeResource>> ReadAsync(string pathAccountSid = null, AllTimeResource.CategoryEnum category = null, DateTime? startDate = null, DateTime? endDate = null, int? pageSize = null, long? limit = null, ITwilioRestClient client = null)
        {
            var options = new ReadAllTimeOptions{PathAccountSid = pathAccountSid, Category = category, StartDate = startDate, EndDate = endDate, PageSize = pageSize, Limit = limit};
        ...
        public static Page<AllTimeResource> GetPage(string targetUrl, ITwilioRestClient client)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        public static Page<AllTimeResource> PreviousPage(Page<AllTimeResource> page, ITwilioRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
