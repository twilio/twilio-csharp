...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record
{
    public class AllTimeResource : Resource
    {
        ...
        public static async System.Threading.Tasks.Task<ResourceSet<AllTimeResource>> ReadAsync(ReadAllTimeOptions options, ITwilioRestClient client = null,  System.Threading.CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
