...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record
{
    public class MonthlyResource : Resource
    {
        ...
        public static async System.Threading.Tasks.Task<ResourceSet<MonthlyResource>> ReadAsync(ReadMonthlyOptions options, ITwilioRestClient client = null,  System.Threading.CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
