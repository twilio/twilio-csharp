...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record
{
    public class MonthlyResource : Resource
    {
        ...
        public static ResourceSetResponse<MonthlyResource> ReadWithHeaders(ReadMonthlyOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildReadRequest(options, client));
            var page = Page<MonthlyResource>.FromJson("usage_records", response.Content);
            var records = new ResourceSet<MonthlyResource>(page, options, client);
            return new ResourceSetResponse<MonthlyResource>(records, response.Headers, response.StatusCode);
        }

        public static ResourceSetResponse<MonthlyResource> ReadWithHeaders(
            string pathAccountSid = null,
            string category = null,
            DateTime? startDate = null,
            DateTime? endDate = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<ResourceSetResponse<MonthlyResource>> ReadWithHeadersAsync(ReadMonthlyOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildReadRequest(options, client));
