...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record 
{
    ...
    public class MonthlyResource : Resource 
    {
        ...
        private static Request BuildReadRequest(ReadMonthlyOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Get,
                Rest.Domain.Api,
        ...
        public static ResourceSet<MonthlyResource> Read(ReadMonthlyOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildReadRequest(options, client));

            var page = Page<MonthlyResource>.FromJson("usage_records", response.Content);
            return new ResourceSet<MonthlyResource>(page, options, client);
        }
        ...
        public static async System.Threading.Tasks.Task<ResourceSet<MonthlyResource>> ReadAsync(ReadMonthlyOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Monthly </returns> 
        public static ResourceSet<MonthlyResource> Read(string pathAccountSid = null, MonthlyResource.CategoryEnum category = null, DateTime? startDate = null, DateTime? endDate = null, int? pageSize = null, long? limit = null, ITwilioRestClient client = null)
        {
            var options = new ReadMonthlyOptions{PathAccountSid = pathAccountSid, Category = category, StartDate = startDate, EndDate = endDate, PageSize = pageSize, Limit = limit};
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of Monthly </returns> 
        public static async System.Threading.Tasks.Task<ResourceSet<MonthlyResource>> ReadAsync(string pathAccountSid = null, MonthlyResource.CategoryEnum category = null, DateTime? startDate = null, DateTime? endDate = null, int? pageSize = null, long? limit = null, ITwilioRestClient client = null)
        {
            var options = new ReadMonthlyOptions{PathAccountSid = pathAccountSid, Category = category, StartDate = startDate, EndDate = endDate, PageSize = pageSize, Limit = limit};
        ...
        public static Page<MonthlyResource> GetPage(string targetUrl, ITwilioRestClient client)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        public static Page<MonthlyResource> NextPage(Page<MonthlyResource> page, ITwilioRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
                page.GetNextPageUrl(
        ...
        public MonthlyResource.CategoryEnum Category { get; private set; }
        /// <summary>
        /// The count
        /// </summary>
        [JsonProperty("count")]
