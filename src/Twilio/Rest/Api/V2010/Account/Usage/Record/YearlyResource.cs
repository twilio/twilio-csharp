...
namespace Twilio.Rest.Api.V2010.Account.Usage.Record
{
    public class YearlyResource : Resource
    {
        ...
        public static ResourceSetResponse<YearlyResource> ReadWithHeaders(ReadYearlyOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildReadRequest(options, client));
            var page = Page<YearlyResource>.FromJson("usage_records", response.Content);
            var records = new ResourceSet<YearlyResource>(page, options, client);
            return new ResourceSetResponse<YearlyResource>(records, response.Headers, response.StatusCode);
        }

        public static ResourceSetResponse<YearlyResource> ReadWithHeaders(
            string pathAccountSid = null,
            string category = null,
            DateTime? startDate = null,
            DateTime? endDate = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<ResourceSetResponse<YearlyResource>> ReadWithHeadersAsync(ReadYearlyOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildReadRequest(options, client));
