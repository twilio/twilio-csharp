    ...
    public class AssignedAddOnExtensionResource : Resource 
    {
        private static Request BuildFetchRequest(FetchAssignedAddOnExtensionOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Get,
                Rest.Domain.Api,
                "/2010-04-01/Accounts/" + (options.AccountSid ?? client.AccountSid) + "/IncomingPhoneNumbers/" + options.ResourceSid + "/AssignedAddOns/" + options.AssignedAddOnSid + "/Extensions/" + options.Sid + ".json",
                client.Region,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of AssignedAddOnExtension </returns> 
        public static AssignedAddOnExtensionResource Fetch(string resourceSid, string assignedAddOnSid, string sid, string accountSid = null, ITwilioRestClient client = null)
        {
            var options = new FetchAssignedAddOnExtensionOptions(resourceSid, assignedAddOnSid, sid){AccountSid = accountSid};
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of AssignedAddOnExtension </returns> 
        public static async System.Threading.Tasks.Task<AssignedAddOnExtensionResource> FetchAsync(string resourceSid, string assignedAddOnSid, string sid, string accountSid = null, ITwilioRestClient client = null)
        {
            var options = new FetchAssignedAddOnExtensionOptions(resourceSid, assignedAddOnSid, sid){AccountSid = accountSid};
        ...
        private static Request BuildReadRequest(ReadAssignedAddOnExtensionOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Get,
                Rest.Domain.Api,
                "/2010-04-01/Accounts/" + (options.AccountSid ?? client.AccountSid) + "/IncomingPhoneNumbers/" + options.ResourceSid + "/AssignedAddOns/" + options.AssignedAddOnSid + "/Extensions.json",
                client.Region,
                queryParams: options.GetParams()
            );
        }
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of AssignedAddOnExtension </returns> 
        public static ResourceSet<AssignedAddOnExtensionResource> Read(string resourceSid, string assignedAddOnSid, string accountSid = null, int? pageSize = null, long? limit = null, ITwilioRestClient client = null)
        {
            var options = new ReadAssignedAddOnExtensionOptions(resourceSid, assignedAddOnSid){AccountSid = accountSid, PageSize = pageSize, Limit = limit};
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of AssignedAddOnExtension </returns> 
        public static async System.Threading.Tasks.Task<ResourceSet<AssignedAddOnExtensionResource>> ReadAsync(string resourceSid, string assignedAddOnSid, string accountSid = null, int? pageSize = null, long? limit = null, ITwilioRestClient client = null)
        {
            var options = new ReadAssignedAddOnExtensionOptions(resourceSid, assignedAddOnSid){AccountSid = accountSid, PageSize = pageSize, Limit = limit};
