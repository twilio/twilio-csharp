    ...
    public class AssignedAddOnResource : Resource 
    {
        private static Request BuildFetchRequest(FetchAssignedAddOnOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Get,
                Rest.Domain.Api,
                "/2010-04-01/Accounts/" + (options.AccountSid ?? client.AccountSid) + "/IncomingPhoneNumbers/" + options.ResourceSid + "/AssignedAddOns/" + options.Sid + ".json",
                client.Region,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of AssignedAddOn </returns> 
        public static AssignedAddOnResource Fetch(string resourceSid, string sid, string accountSid = null, ITwilioRestClient client = null)
        {
            var options = new FetchAssignedAddOnOptions(resourceSid, sid){AccountSid = accountSid};
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of AssignedAddOn </returns> 
        public static async System.Threading.Tasks.Task<AssignedAddOnResource> FetchAsync(string resourceSid, string sid, string accountSid = null, ITwilioRestClient client = null)
        {
            var options = new FetchAssignedAddOnOptions(resourceSid, sid){AccountSid = accountSid};
        ...
        private static Request BuildReadRequest(ReadAssignedAddOnOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Get,
                Rest.Domain.Api,
                "/2010-04-01/Accounts/" + (options.AccountSid ?? client.AccountSid) + "/IncomingPhoneNumbers/" + options.ResourceSid + "/AssignedAddOns.json",
                client.Region,
                queryParams: options.GetParams()
            );
        }
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of AssignedAddOn </returns> 
        public static ResourceSet<AssignedAddOnResource> Read(string resourceSid, string accountSid = null, int? pageSize = null, long? limit = null, ITwilioRestClient client = null)
        {
            var options = new ReadAssignedAddOnOptions(resourceSid){AccountSid = accountSid, PageSize = pageSize, Limit = limit};
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of AssignedAddOn </returns> 
        public static async System.Threading.Tasks.Task<ResourceSet<AssignedAddOnResource>> ReadAsync(string resourceSid, string accountSid = null, int? pageSize = null, long? limit = null, ITwilioRestClient client = null)
        {
            var options = new ReadAssignedAddOnOptions(resourceSid){AccountSid = accountSid, PageSize = pageSize, Limit = limit};
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of AssignedAddOn </returns> 
        public static AssignedAddOnResource Create(string resourceSid, string installedAddOnSid, string accountSid = null, ITwilioRestClient client = null)
        {
            var options = new CreateAssignedAddOnOptions(resourceSid, installedAddOnSid){AccountSid = accountSid};
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of AssignedAddOn </returns> 
        public static async System.Threading.Tasks.Task<AssignedAddOnResource> CreateAsync(string resourceSid, string installedAddOnSid, string accountSid = null, ITwilioRestClient client = null)
        {
            var options = new CreateAssignedAddOnOptions(resourceSid, installedAddOnSid){AccountSid = accountSid};
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of AssignedAddOn </returns> 
        public static bool Delete(string resourceSid, string sid, string accountSid = null, ITwilioRestClient client = null)
        {
            var options = new DeleteAssignedAddOnOptions(resourceSid, sid){AccountSid = accountSid};
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of AssignedAddOn </returns> 
        public static async System.Threading.Tasks.Task<bool> DeleteAsync(string resourceSid, string sid, string accountSid = null, ITwilioRestClient client = null)
        {
            var options = new DeleteAssignedAddOnOptions(resourceSid, sid){AccountSid = accountSid};
