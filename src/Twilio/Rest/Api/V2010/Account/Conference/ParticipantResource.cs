...
namespace Twilio.Rest.Api.V2010.Account.Conference
{
    public class ParticipantResource : Resource
    {
        ...
        /// <param name="waitUrl"> The URL that Twilio calls using the `wait_method` before the conference has started. The URL may return an MP3 file, a WAV file, or a TwiML document. The default value is the URL of our standard hold music. If you do not want anything to play while waiting for the conference to start, specify an empty string by setting `wait_url` to `''`. For more details on the allowable verbs within the `waitUrl`, see the `waitUrl` attribute in the [<Conference> TwiML instruction](https://www.twilio.com/docs/voice/twiml/conference#attributes-waiturl). </param>
        ...
        /// <param name="recordingConfigurationId"> The identifier of the configuration to be used when creating and processing the recording </param>
        ...
        /// <param name="passports"> The STIR/SHAKEN passport for this call, provided as a base64 encoded string. Multiple passports (at max 5) are comma separated and provided as base64 encoded string </param>
        /// <param name="clientNotificationUrl"> The URL that we should use to deliver `push call notification`. </param>
        ...
        /// <param name="emergencyCallerPosition"> The emergency caller's GPS coordinates in decimal degrees format. Format: \\\"latitude longitude\\\" (space-separated) - Latitude: decimal degrees, range -90.0 to +90.0 (negative for South, positive for North) - Longitude: decimal degrees, range -180.0 to +180.0 (negative for West, positive for East) - Precision: up to 6 decimal places recommended for meter-level accuracy  Note: If the value exceeds 150 characters, only the first 150 characters will be used.  </param>
        /// <param name="emergencyCallerLocation"> The emergency caller's physical location description within a building or facility.  Note: If the value exceeds 20 characters, only the first 20 characters will be used.  </param>
        /// <param name="emergencyName"> The emergency caller's organization or entity name.  Note: If the value exceeds 20 characters, only the first 20 characters will be used.  </param>
        /// <param name="emergencyAddress"> The emergency caller's street address including street number and street name.  Note: If the value exceeds 60 characters, only the first 60 characters will be used.  </param>
        /// <param name="emergencyZipCode"> The emergency caller's postal code or ZIP code.  Note: If the value exceeds 20 characters, only the first 20 characters will be used.  </param>
        /// <param name="emergencyCity"> The emergency caller's city or municipality name. Should be the official city name as recognized by local authorities. Used in combination with state and country for emergency call routing.  Note: If the value exceeds 20 characters, only the first 20 characters will be used.  </param>
        /// <param name="emergencyState"> The emergency caller's state or province.  Note: If the value exceeds 20 characters, only the first 20 characters will be used.  </param>
        /// <param name="emergencyCountry"> The emergency caller's country. Currently supported US and CA only.  Note: If the value exceeds 20 characters, only the first 20 characters will be used.  </param>
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Participant </returns>
        ...
        public static TwilioResponse<bool> DeleteWithHeaders(string pathConferenceSid, string pathCallSid, string pathAccountSid = null, ITwilioRestClient client = null)
        {
            var options = new DeleteParticipantOptions(pathConferenceSid, pathCallSid)         { PathAccountSid = pathAccountSid }   ;
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<bool>> DeleteWithHeadersAsync(string pathConferenceSid, string pathCallSid, string pathAccountSid = null, ITwilioRestClient client = null)
        {
            var options = new DeleteParticipantOptions(pathConferenceSid, pathCallSid)  { PathAccountSid = pathAccountSid };
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<ParticipantResource>> FetchWithHeadersAsync(string pathConferenceSid, string pathCallSid, string pathAccountSid = null, ITwilioRestClient client = null)
        {
            var options = new FetchParticipantOptions(pathConferenceSid, pathCallSid){ PathAccountSid = pathAccountSid };
        ...
        public static TwilioResponse<ParticipantResource> UpdateWithHeaders(UpdateParticipantOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildUpdateRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<ParticipantResource>> UpdateWithHeadersAsync(UpdateParticipantOptions options,
        ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildUpdateRequest(options, client));
        ...
        public static TwilioResponse<ParticipantResource> UpdateWithHeaders(
            string pathConferenceSid,
            string pathCallSid,
            string pathAccountSid = null,
            bool? muted = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<ParticipantResource>> UpdateWithHeadersAsync(
            string pathConferenceSid,
            string pathCallSid,
            string pathAccountSid = null,
            bool? muted = null,
