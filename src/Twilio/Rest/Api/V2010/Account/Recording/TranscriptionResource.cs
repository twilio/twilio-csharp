...
namespace Twilio.Rest.Api.V2010.Account.Recording
{
    public class TranscriptionResource : Resource
    {
        ...
        public static TwilioResponse<bool> DeleteWithHeaders(string pathRecordingSid, string pathSid, string pathAccountSid = null, ITwilioRestClient client = null)
        {
            var options = new DeleteTranscriptionOptions(pathRecordingSid, pathSid)         { PathAccountSid = pathAccountSid }   ;
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<bool>> DeleteWithHeadersAsync(string pathRecordingSid, string pathSid, string pathAccountSid = null, ITwilioRestClient client = null)
        {
            var options = new DeleteTranscriptionOptions(pathRecordingSid, pathSid)  { PathAccountSid = pathAccountSid };
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<TranscriptionResource>> FetchWithHeadersAsync(string pathRecordingSid, string pathSid, string pathAccountSid = null, ITwilioRestClient client = null)
        {
            var options = new FetchTranscriptionOptions(pathRecordingSid, pathSid){ PathAccountSid = pathAccountSid };
        ...
        public static ResourceSetResponse<TranscriptionResource> ReadWithHeaders(ReadTranscriptionOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildReadRequest(options, client));
            var page = Page<TranscriptionResource>.FromJson("transcriptions", response.Content);
            var records = new ResourceSet<TranscriptionResource>(page, options, client);
            return new ResourceSetResponse<TranscriptionResource>(records, response.Headers, response.StatusCode);
        }

        public static ResourceSetResponse<TranscriptionResource> ReadWithHeaders(
            string pathRecordingSid,
            string pathAccountSid = null,
            long? pageSize = null,
            long? limit = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<ResourceSetResponse<TranscriptionResource>> ReadWithHeadersAsync(ReadTranscriptionOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildReadRequest(options, client));
