...
namespace Twilio.Rest.Api.V2010.Account
{
    ...
    public class CallResource : Resource
    {
        ...
        /// <param name="startTimeBefore"> Only include calls that started before this date </param>
        /// <param name="startTime"> Only include calls that started on this date </param>
        /// <param name="startTimeAfter"> Only include calls that started after this date </param>
        /// <param name="endTimeBefore"> Only include calls that ended before this date </param>
        /// <param name="endTime"> Only include calls that ended on this date </param>
        /// <param name="endTimeAfter"> Only include calls that ended after this date </param>
