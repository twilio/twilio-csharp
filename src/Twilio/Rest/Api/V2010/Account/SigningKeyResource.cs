...
namespace Twilio.Rest.Api.V2010.Account 
{
    ...
    public class SigningKeyResource : Resource 
    {
        ...
        {
            var options = new FetchSigningKeyOptions(sid){PathAccountSid = accountSid};
        ...
        {
            var options = new UpdateSigningKeyOptions(sid){PathAccountSid = accountSid, FriendlyName = friendlyName};
        ...
        {
            var options = new DeleteSigningKeyOptions(sid){PathAccountSid = accountSid};
        ...
        {
            var options = new ReadSigningKeyOptions{PathAccountSid = accountSid, PageSize = pageSize, Limit = limit};
