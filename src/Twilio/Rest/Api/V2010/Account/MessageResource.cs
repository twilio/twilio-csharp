...
namespace Twilio.Rest.Api.V2010.Account
{
    public class MessageResource : Resource
    {
        ...
        ///<summary> The SID of the [Messaging Service](https://www.twilio.com/docs/sms/services/api) associated with the Message resource. The value is `null` if a Messaging Service was not used. </summary> 
