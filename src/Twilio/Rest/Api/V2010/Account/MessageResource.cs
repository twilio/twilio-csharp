...
namespace Twilio.Rest.Api.V2010.Account
{
    public class MessageResource : Resource
    {
        ...
        ///<summary> The recipient's phone number (in [E.164](https://en.wikipedia.org/wiki/E.164) format) or [channel address](https://www.twilio.com/docs/sms/channels#channel-addresses) (e.g. `whatsapp:+15552229999`) </summary> 
        [JsonProperty("to")]
        ...
        ///<summary> The SID of the [Messaging Service](https://www.twilio.com/docs/messaging/services/api) associated with the Message resource. The value is `null` if a Messaging Service was not used. </summary> 
