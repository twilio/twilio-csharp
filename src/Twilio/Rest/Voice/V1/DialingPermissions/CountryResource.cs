...
namespace Twilio.Rest.Voice.V1.DialingPermissions
{
    public class CountryResource : Resource
    {
        ...
        ///<summary> The E.164 assigned country codes(s) </summary> 
        ...
        ///<summary> Whether dialing to high-risk special services numbers is enabled </summary> 
        [JsonProperty("high_risk_special_numbers_enabled")]
        public bool? HighRiskSpecialNumbersEnabled { get; private set; }

        ///<summary> Whether dialing to high-risk toll fraud numbers is enabled, else `false` </summary> 
