...
namespace Twilio.Rest.Trusthub.V1
{
    ...
    public class TrustProductsResource : Resource
    {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of TrustProducts </returns>
        public static ResourceSet<TrustProductsResource> Read(ReadTrustProductsOptions options,
                                                              ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of TrustProducts </returns>
        public static ResourceSet<TrustProductsResource> Read(TrustProductsResource.StatusEnum status = null,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of TrustProducts </returns>
        public static async System.Threading.Tasks.Task<ResourceSet<TrustProductsResource>> ReadAsync(TrustProductsResource.StatusEnum status = null,
                                                                                                      string friendlyName = null,
                                                                                                      string policySid = null,
                                                                                                      int? pageSize = null,
                                                                                                      long? limit = null,
