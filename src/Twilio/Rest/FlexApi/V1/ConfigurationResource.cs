...
namespace Twilio.Rest.FlexApi.V1
{
    public class ConfigurationResource : Resource
    {
        ...
        ///<summary> The ISO 8601 date and time in GMT when the Configuration resource was created </summary> 
        [JsonProperty("date_created")]
        public DateTime? DateCreated { get; private set; }

        ///<summary> The ISO 8601 date and time in GMT when the Configuration resource was last updated </summary> 
        ...
        ///<summary> The list of public attributes </summary> 
        ...
        ///<summary> Object that controls workspace reporting </summary> 
        [JsonProperty("flex_insights_hr")]
        public object FlexInsightsHr { get; private set; }

        ///<summary> Setting to enable Flex UI redirection </summary> 
        ...
        ///<summary> Flex Conversations channels' attachments configurations </summary> 
