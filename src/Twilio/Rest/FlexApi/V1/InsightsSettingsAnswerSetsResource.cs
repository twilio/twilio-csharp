...
namespace Twilio.Rest.FlexApi.V1
{
    public class InsightsSettingsAnswerSetsResource : Resource
    {
        ...
        public static TwilioResponse<InsightsSettingsAnswerSetsResource> FetchWithHeaders(FetchInsightsSettingsAnswerSetsOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
            return new TwilioResponse<InsightsSettingsAnswerSetsResource>(resource, response.Headers, response.StatusCode);
        }
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<InsightsSettingsAnswerSetsResource>> FetchWithHeadersAsync(FetchInsightsSettingsAnswerSetsOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<InsightsSettingsAnswerSetsResource> FetchWithHeaders(
                    string authorization = null, 
                ITwilioRestClient client = null)
        {
            var options = new FetchInsightsSettingsAnswerSetsOptions(){ Authorization = authorization };
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<InsightsSettingsAnswerSetsResource>> FetchWithHeadersAsync(string authorization = null, ITwilioRestClient client = null)
        {
            var options = new FetchInsightsSettingsAnswerSetsOptions(){ Authorization = authorization };
