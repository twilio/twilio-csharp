...
namespace Twilio.Rest.FlexApi.V1
{
    ...
    public class UpdatePluginVersionArchiveOptions : IOptions<PluginVersionArchiveResource>
    {
        ...
        public UpdatePluginVersionArchiveOptions(string pathPluginSid, string pathSid)
        {
