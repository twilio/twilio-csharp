...
namespace Twilio.Rest.FlexApi.V1
{
    public class InsightsSettingsCommentResource : Resource
    {
        ...
        public static TwilioResponse<InsightsSettingsCommentResource> FetchWithHeaders(FetchInsightsSettingsCommentOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
            return new TwilioResponse<InsightsSettingsCommentResource>(resource, response.Headers, response.StatusCode);
        }
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<InsightsSettingsCommentResource>> FetchWithHeadersAsync(FetchInsightsSettingsCommentOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<InsightsSettingsCommentResource> FetchWithHeaders(
                    string authorization = null, 
                ITwilioRestClient client = null)
        {
            var options = new FetchInsightsSettingsCommentOptions(){ Authorization = authorization };
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<InsightsSettingsCommentResource>> FetchWithHeadersAsync(string authorization = null, ITwilioRestClient client = null)
        {
            var options = new FetchInsightsSettingsCommentOptions(){ Authorization = authorization };
