...
namespace Twilio.Rest.Messaging.V3
{
    public class TypingIndicatorResource : Resource
    {
        ...
        public class TypingIndicatorRequest
        {
            ...
            {
                private TypingIndicatorRequest _typingIndicatorRequest = new TypingIndicatorRequest();
                public Builder()
                {
                }
                public Builder WithChannel(TypingIndicatorResource.ChannelEnum channel)
                {
                ...
                {
                    return _typingIndicatorRequest;
                }
            }
        }
        ...
        public static TypingIndicatorResource Create(
                                          TypingIndicatorResource.TypingIndicatorRequest typingIndicatorRequest,
                                            ITwilioRestClient client = null)
        {
            var options = new CreateTypingIndicatorOptions(typingIndicatorRequest){  };
