...
namespace Twilio.Rest.Messaging.V1
{
    public class LinkshorteningMessagingServiceDomainAssociationResource : Resource
    {
        ...
        public static TwilioResponse<LinkshorteningMessagingServiceDomainAssociationResource> FetchWithHeaders(FetchLinkshorteningMessagingServiceDomainAssociationOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
            return new TwilioResponse<LinkshorteningMessagingServiceDomainAssociationResource>(resource, response.Headers, response.StatusCode);
        }
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<LinkshorteningMessagingServiceDomainAssociationResource>> FetchWithHeadersAsync(FetchLinkshorteningMessagingServiceDomainAssociationOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<LinkshorteningMessagingServiceDomainAssociationResource> FetchWithHeaders(
                    string pathMessagingServiceSid, 
                ITwilioRestClient client = null)
        {
            var options = new FetchLinkshorteningMessagingServiceDomainAssociationOptions(pathMessagingServiceSid){  };
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<LinkshorteningMessagingServiceDomainAssociationResource>> FetchWithHeadersAsync(string pathMessagingServiceSid, ITwilioRestClient client = null)
        {
            var options = new FetchLinkshorteningMessagingServiceDomainAssociationOptions(pathMessagingServiceSid){  };
