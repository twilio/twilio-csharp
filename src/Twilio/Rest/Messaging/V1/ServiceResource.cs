...
namespace Twilio.Rest.Messaging.V1
{
    public class ServiceResource : Resource
    {
        ...
        /// <param name="validityPeriod"> How long, in seconds, messages sent from the Service are valid. Can be an integer from `1` to `36,000`. Default value is `36,000`. </param>
