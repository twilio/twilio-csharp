...
namespace Twilio.Rest.Serverless.V1.Service.Function
{
    public class FunctionVersionResource : Resource
    {
        ...
        ///<summary> The URL-friendly string by which the Function Version resource can be referenced </summary> 
        [JsonProperty("path")]
        ...
        ///<summary> The ISO 8601 date and time in GMT when the Function Version resource was created </summary> 
