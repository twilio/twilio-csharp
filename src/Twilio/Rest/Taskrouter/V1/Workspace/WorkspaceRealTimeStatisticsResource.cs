...
namespace Twilio.Rest.Taskrouter.V1.Workspace
{
    public class WorkspaceRealTimeStatisticsResource : Resource
    {
        ...
        public static async System.Threading.Tasks.Task<WorkspaceRealTimeStatisticsResource> FetchAsync(FetchWorkspaceRealTimeStatisticsOptions options, ITwilioRestClient client = null,  CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
