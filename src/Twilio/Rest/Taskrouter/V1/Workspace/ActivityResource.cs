...
namespace Twilio.Rest.Taskrouter.V1.Workspace
{
    public class ActivityResource : Resource
    {
        ...
        public static TwilioResponse<ActivityResource> CreateWithHeaders(CreateActivityOptions options, ITwilioRestClient client = null) 
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildCreateRequest(options, client));
            var resource = FromJson(response.Content);
            return new TwilioResponse<ActivityResource>(resource, response.Headers, response.StatusCode);
        }

        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<ActivityResource>> CreateWithHeadersAsync(CreateActivityOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildCreateRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<ActivityResource> CreateWithHeaders(
            string pathWorkspaceSid,
            string friendlyName,
            bool? available = null,
        ITwilioRestClient client = null)
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<ActivityResource>> CreateWithHeadersAsync(
            string pathWorkspaceSid,
            string friendlyName,
            bool? available = null,
        ITwilioRestClient client = null)
        ...
        public static TwilioResponse<bool> DeleteWithHeaders(DeleteActivityOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildDeleteRequest(options, client));
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<bool>> DeleteWithHeadersAsync(DeleteActivityOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildDeleteRequest(options, client));
            var success = (int)response.StatusCode >= 200 && (int)response.StatusCode < 400;
        ...
        public static TwilioResponse<ActivityResource> FetchWithHeaders(FetchActivityOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<ActivityResource>> FetchWithHeadersAsync(FetchActivityOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<ActivityResource> FetchWithHeaders(
                    string pathWorkspaceSid, 
                    string pathSid, 
                ITwilioRestClient client = null)
        {
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<ActivityResource>> FetchWithHeadersAsync(string pathWorkspaceSid, string pathSid, ITwilioRestClient client = null)
        {
            var options = new FetchActivityOptions(pathWorkspaceSid, pathSid){  };
        ...
        public static ResourceSetResponse<ActivityResource> ReadWithHeaders(ReadActivityOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildReadRequest(options, client));
            var page = Page<ActivityResource>.FromJson("activities", response.Content);
            var records = new ResourceSet<ActivityResource>(page, options, client);
            return new ResourceSetResponse<ActivityResource>(records, response.Headers, response.StatusCode);
        }

        public static ResourceSetResponse<ActivityResource> ReadWithHeaders(
            string pathWorkspaceSid,
            string friendlyName = null,
            string available = null,
            long? pageSize = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<ResourceSetResponse<ActivityResource>> ReadWithHeadersAsync(ReadActivityOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildReadRequest(options, client));
        ...
        public static TwilioResponse<ActivityResource> UpdateWithHeaders(UpdateActivityOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildUpdateRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<ActivityResource>> UpdateWithHeadersAsync(UpdateActivityOptions options,
        ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildUpdateRequest(options, client));
        ...
        public static TwilioResponse<ActivityResource> UpdateWithHeaders(
            string pathWorkspaceSid,
            string pathSid,
            string friendlyName = null,
        ITwilioRestClient client = null)
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<ActivityResource>> UpdateWithHeadersAsync(
            string pathWorkspaceSid,
            string pathSid,
            string friendlyName = null,
        ITwilioRestClient client = null)
