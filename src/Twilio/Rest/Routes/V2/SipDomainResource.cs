...
namespace Twilio.Rest.Routes.V2
{
    ...
    {
        private static Request BuildCreateRequest(CreateSipDomainOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Post,
                Rest.Domain.Routes,
        ...
        /// create
        /// </summary>
        /// <param name="options"> Create SipDomain parameters </param>
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of SipDomain </returns>
        public static SipDomainResource Create(CreateSipDomainOptions options, ITwilioRestClient client = null)
        {
        ...
        public static async System.Threading.Tasks.Task<SipDomainResource> CreateAsync(CreateSipDomainOptions options,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of SipDomain </returns>
        public static SipDomainResource Create(string pathSipDomain,
                                               string voiceRegion = null,
                                               string friendlyName = null,
                                               ITwilioRestClient client = null)
        {
            var options = new CreateSipDomainOptions(pathSipDomain){VoiceRegion = voiceRegion, FriendlyName = friendlyName};
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of SipDomain </returns>
        public static async System.Threading.Tasks.Task<SipDomainResource> CreateAsync(string pathSipDomain,
                                                                                       string voiceRegion = null,
                                                                                       string friendlyName = null,
                                                                                       ITwilioRestClient client = null)
        {
