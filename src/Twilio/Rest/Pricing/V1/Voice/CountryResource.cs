...
namespace Twilio.Rest.Pricing.V1.Voice
{
    public class CountryResource : Resource
    {
        ...
        public class PricingV1VoiceVoiceCountryInstanceOutboundPrefixPrices
        {
            ...
            {
                private PricingV1VoiceVoiceCountryInstanceOutboundPrefixPrices _pricingV1VoiceVoiceCountryInstanceOutboundPrefixPrices = new PricingV1VoiceVoiceCountryInstanceOutboundPrefixPrices();
                public Builder()
                {
                }
                public Builder WithPrefixes(List<string> prefixes)
                {
                    _pricingV1VoiceVoiceCountryInstanceOutboundPrefixPrices.Prefixes= prefixes;
                    return this;
                }
                public Builder WithBasePrice(decimal basePrice)
                {
                    _pricingV1VoiceVoiceCountryInstanceOutboundPrefixPrices.BasePrice= basePrice;
                    return this;
                }
                public Builder WithCurrentPrice(decimal currentPrice)
                {
                    _pricingV1VoiceVoiceCountryInstanceOutboundPrefixPrices.CurrentPrice= currentPrice;
                    return this;
                }
                public Builder WithFriendlyName(string friendlyName)
                {
                    _pricingV1VoiceVoiceCountryInstanceOutboundPrefixPrices.FriendlyName= friendlyName;
                    return this;
                }
                public PricingV1VoiceVoiceCountryInstanceOutboundPrefixPrices Build()
                {
                    return _pricingV1VoiceVoiceCountryInstanceOutboundPrefixPrices;
                }
            }
        }
        public class PricingV1VoiceVoiceCountryInstanceInboundCallPrices
        {
            ...
            public class Builder
            {
                private PricingV1VoiceVoiceCountryInstanceInboundCallPrices _pricingV1VoiceVoiceCountryInstanceInboundCallPrices = new PricingV1VoiceVoiceCountryInstanceInboundCallPrices();
                public Builder()
                {
                }
                public Builder WithBasePrice(decimal basePrice)
                {
                    _pricingV1VoiceVoiceCountryInstanceInboundCallPrices.BasePrice= basePrice;
                    return this;
                }
                public Builder WithCurrentPrice(decimal currentPrice)
                {
                    _pricingV1VoiceVoiceCountryInstanceInboundCallPrices.CurrentPrice= currentPrice;
                    return this;
                }
                public Builder WithNumberType(string numberType)
                {
                    _pricingV1VoiceVoiceCountryInstanceInboundCallPrices.NumberType= numberType;
                    return this;
                }
                public PricingV1VoiceVoiceCountryInstanceInboundCallPrices Build()
                {
                    return _pricingV1VoiceVoiceCountryInstanceInboundCallPrices;
                }
            }
        }
