...
namespace Twilio.Rest.Pricing.V2
{
    public class NumberResource : Resource
    {
        ...
        public static TwilioResponse<NumberResource> FetchWithHeaders(FetchNumberOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
            return new TwilioResponse<NumberResource>(resource, response.Headers, response.StatusCode);
        }
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<NumberResource>> FetchWithHeadersAsync(FetchNumberOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<NumberResource> FetchWithHeaders(
                    Types.PhoneNumber pathDestinationNumber, 
                    Types.PhoneNumber originationNumber = null, 
                ITwilioRestClient client = null)
        {
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<NumberResource>> FetchWithHeadersAsync(Types.PhoneNumber pathDestinationNumber, Types.PhoneNumber originationNumber = null, ITwilioRestClient client = null)
        {
            var options = new FetchNumberOptions(pathDestinationNumber){ OriginationNumber = originationNumber };
