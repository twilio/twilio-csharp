...
namespace Twilio.Rest.Pricing.V2.Voice
{
    public class CountryResource : Resource
    {
        ...
        public class PricingV2TrunkingCountryInstanceOriginatingCallPrices
        {
            ...
            public class Builder
            {
                private PricingV2TrunkingCountryInstanceOriginatingCallPrices _pricingV2TrunkingCountryInstanceOriginatingCallPrices = new PricingV2TrunkingCountryInstanceOriginatingCallPrices();
                public Builder()
                {
                }
                public Builder WithBasePrice(decimal basePrice)
                {
                    _pricingV2TrunkingCountryInstanceOriginatingCallPrices.BasePrice= basePrice;
                    return this;
                }
                public Builder WithCurrentPrice(decimal currentPrice)
                {
                    _pricingV2TrunkingCountryInstanceOriginatingCallPrices.CurrentPrice= currentPrice;
                    return this;
                }
                public Builder WithNumberType(string numberType)
                {
                    _pricingV2TrunkingCountryInstanceOriginatingCallPrices.NumberType= numberType;
                    return this;
                }
                public PricingV2TrunkingCountryInstanceOriginatingCallPrices Build()
                {
                    return _pricingV2TrunkingCountryInstanceOriginatingCallPrices;
                }
            }
        }
