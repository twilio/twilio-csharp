...
namespace Twilio.Rest.Pricing.V2.Voice
{
    public class NumberResource : Resource
    {
        ...
        public class PricingV2VoiceVoiceNumberOutboundCallPrices
        {
            ...
            public PricingV2VoiceVoiceNumberOutboundCallPrices() { }
            public class Builder
            {
                private PricingV2VoiceVoiceNumberOutboundCallPrices _pricingV2VoiceVoiceNumberOutboundCallPrices = new PricingV2VoiceVoiceNumberOutboundCallPrices();
                public Builder()
                {
                }
                public Builder WithBasePrice(decimal basePrice)
                {
                    _pricingV2VoiceVoiceNumberOutboundCallPrices.BasePrice= basePrice;
                    return this;
                }
                public Builder WithCurrentPrice(decimal currentPrice)
                {
                    _pricingV2VoiceVoiceNumberOutboundCallPrices.CurrentPrice= currentPrice;
                    return this;
                }
                public Builder WithOriginationPrefixes(List<string> originationPrefixes)
                {
                    _pricingV2VoiceVoiceNumberOutboundCallPrices.OriginationPrefixes= originationPrefixes;
                    return this;
                }
                public PricingV2VoiceVoiceNumberOutboundCallPrices Build()
                {
                    return _pricingV2VoiceVoiceNumberOutboundCallPrices;
                }
            }
        }
        public class PricingV2VoiceVoiceNumberInboundCallPrice
        {
            ...
            public class Builder
            {
                private PricingV2VoiceVoiceNumberInboundCallPrice _pricingV2VoiceVoiceNumberInboundCallPrice = new PricingV2VoiceVoiceNumberInboundCallPrice();
                public Builder()
                {
                }
                public Builder WithBasePrice(decimal basePrice)
                {
                    _pricingV2VoiceVoiceNumberInboundCallPrice.BasePrice= basePrice;
                    return this;
                }
                public Builder WithCurrentPrice(decimal currentPrice)
                {
                    _pricingV2VoiceVoiceNumberInboundCallPrice.CurrentPrice= currentPrice;
                    return this;
                }
                public Builder WithNumberType(string numberType)
                {
                    _pricingV2VoiceVoiceNumberInboundCallPrice.NumberType= numberType;
                    return this;
                }
                public PricingV2VoiceVoiceNumberInboundCallPrice Build()
                {
                    return _pricingV2VoiceVoiceNumberInboundCallPrice;
                }
            }
        }
