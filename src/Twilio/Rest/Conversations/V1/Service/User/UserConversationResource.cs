    ...
    public class UserConversationResource : Resource
    {
        ...
        private static Request BuildUpdateRequest(UpdateUserConversationOptions options, ITwilioRestClient client)
        {
            return new Request(
                ...
                "/v1/Services/" + options.PathChatServiceSid + "/Users/" + options.PathUserSid + "/Conversations/" + options.PathConversationSid + "",
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of UserConversation </returns>
        public static UserConversationResource Update(string pathChatServiceSid,
                                                      string pathUserSid,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of UserConversation </returns>
        public static async System.Threading.Tasks.Task<UserConversationResource> UpdateAsync(string pathChatServiceSid,
                                                                                              string pathUserSid,
                                                                                              string pathConversationSid,
                                                                                              UserConversationResource.NotificationLevelEnum notificationLevel = null,
                                                                                              DateTime? lastReadTimestamp = null,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of UserConversation </returns>
        public static UserConversationResource Fetch(string pathChatServiceSid,
                                                     string pathUserSid,
                                                     string pathConversationSid,
                                                     ITwilioRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of UserConversation </returns>
        public static async System.Threading.Tasks.Task<UserConversationResource> FetchAsync(string pathChatServiceSid,
                                                                                             string pathUserSid,
                                                                                             string pathConversationSid,
                                                                                             ITwilioRestClient client = null)
        {
        ...
        private static Request BuildReadRequest(ReadUserConversationOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Get,
                Rest.Domain.Conversations,
                "/v1/Services/" + options.PathChatServiceSid + "/Users/" + options.PathUserSid + "/Conversations",
                queryParams: options.GetParams(),
                headerParams: null
            );
        }
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of UserConversation </returns>
        public static ResourceSet<UserConversationResource> Read(string pathChatServiceSid,
                                                                 string pathUserSid,
                                                                 int? pageSize = null,
                                                                 long? limit = null,
                                                                 ITwilioRestClient client = null)
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of UserConversation </returns>
        public static async System.Threading.Tasks.Task<ResourceSet<UserConversationResource>> ReadAsync(string pathChatServiceSid,
                                                                                                         string pathUserSid,
                                                                                                         int? pageSize = null,
                                                                                                         long? limit = null,
                                                                                                         ITwilioRestClient client = null)
