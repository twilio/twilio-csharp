...
namespace Twilio.Rest.Conversations.V1.Service
{
    ...
    public class DeleteRoleOptions : IOptions<RoleResource>
    {
        ...
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.twilio.com/docs/conversations/api/service-resource) to delete the Role resource from. </param>        /// <param name="pathSid"> The SID of the Role resource to delete. </param>
    ...
    public class FetchRoleOptions : IOptions<RoleResource>
    {
        ...
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.twilio.com/docs/conversations/api/service-resource) to fetch the Role resource from. </param>        /// <param name="pathSid"> The SID of the Role resource to fetch. </param>
    ...
    public class UpdateRoleOptions : IOptions<RoleResource>
    {
        ...
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.twilio.com/docs/conversations/api/service-resource) to update the Role resource in. </param>        /// <param name="pathSid"> The SID of the Role resource to update. </param>        /// <param name="permission"> A permission that you grant to the role. Only one permission can be granted per parameter. To assign more than one permission, repeat this parameter for each permission value. Note that the update action replaces all previously assigned permissions with those defined in the update action. To remove a permission, do not include it in the subsequent update action. The values for this parameter depend on the role's `type`. </param>
