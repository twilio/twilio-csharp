...
namespace Twilio.Rest.Conversations.V1.Service.Conversation.Message
{
    public class DeliveryReceiptResource : Resource
    {
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<DeliveryReceiptResource>> FetchWithHeadersAsync(string pathChatServiceSid, string pathConversationSid, string pathMessageSid, string pathSid, ITwilioRestClient client = null)
        {
            var options = new FetchDeliveryReceiptOptions(pathChatServiceSid, pathConversationSid, pathMessageSid, pathSid){  };
