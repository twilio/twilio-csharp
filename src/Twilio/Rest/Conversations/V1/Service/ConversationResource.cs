...
namespace Twilio.Rest.Conversations.V1.Service
{
    ...
    public class ConversationResource : Resource
    {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Conversation </returns>
        public static ConversationResource Create(string pathChatServiceSid,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of Conversation </returns>
        public static async System.Threading.Tasks.Task<ConversationResource> CreateAsync(string pathChatServiceSid,
                                                                                          string friendlyName = null,
                                                                                          string uniqueName = null,
                                                                                          string attributes = null,
                                                                                          string messagingServiceSid = null,
        ...
        private static Request BuildUpdateRequest(UpdateConversationOptions options, ITwilioRestClient client)
        {
            return new Request(
                HttpMethod.Post,
                Rest.Domain.Conversations,
                "/v1/Services/" + options.PathChatServiceSid + "/Conversations/" + options.PathSid + "",
                postParams: options.GetParams(),
                headerParams: options.GetHeaderParams()
            );
        }
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Conversation </returns>
        public static ConversationResource Update(string pathChatServiceSid,
                                                  string pathSid,
                                                  string friendlyName = null,
                                                  DateTime? dateCreated = null,
                                                  DateTime? dateUpdated = null,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of Conversation </returns>
        public static async System.Threading.Tasks.Task<ConversationResource> UpdateAsync(string pathChatServiceSid,
                                                                                          string pathSid,
                                                                                          string friendlyName = null,
                                                                                          DateTime? dateCreated = null,
                                                                                          DateTime? dateUpdated = null,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Conversation </returns>
        public static ConversationResource Fetch(string pathChatServiceSid, string pathSid, ITwilioRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of Conversation </returns>
        public static async System.Threading.Tasks.Task<ConversationResource> FetchAsync(string pathChatServiceSid,
                                                                                         string pathSid,
                                                                                         ITwilioRestClient client = null)
        {
            var options = new FetchConversationOptions(pathChatServiceSid, pathSid);
