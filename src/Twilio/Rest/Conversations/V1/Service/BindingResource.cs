...
namespace Twilio.Rest.Conversations.V1.Service
{
    public class BindingResource : Resource
    {
        ...
        public static TwilioResponse<bool> DeleteWithHeaders(string pathChatServiceSid, string pathSid, ITwilioRestClient client = null)
        {
            var options = new DeleteBindingOptions(pathChatServiceSid, pathSid)        ;
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<bool>> DeleteWithHeadersAsync(string pathChatServiceSid, string pathSid, ITwilioRestClient client = null)
        {
            var options = new DeleteBindingOptions(pathChatServiceSid, pathSid) ;
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<BindingResource>> FetchWithHeadersAsync(string pathChatServiceSid, string pathSid, ITwilioRestClient client = null)
        {
            var options = new FetchBindingOptions(pathChatServiceSid, pathSid){  };
