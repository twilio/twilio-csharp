...
namespace Twilio.Rest.Accounts.V1
{
    public class BulkContactsResource : Resource
    {
        ...
        public static TwilioResponse<BulkContactsResource> CreateWithHeaders(CreateBulkContactsOptions options, ITwilioRestClient client = null) 
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildCreateRequest(options, client));
            var resource = FromJson(response.Content);
            return new TwilioResponse<BulkContactsResource>(resource, response.Headers, response.StatusCode);
        }

        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<BulkContactsResource>> CreateWithHeadersAsync(CreateBulkContactsOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildCreateRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<BulkContactsResource> CreateWithHeaders(
            List<object> items,
        ITwilioRestClient client = null)
        {
        var options = new CreateBulkContactsOptions(items){  };
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<BulkContactsResource>> CreateWithHeadersAsync(
            List<object> items,
        ITwilioRestClient client = null)
        {
        var options = new CreateBulkContactsOptions(items){  };
