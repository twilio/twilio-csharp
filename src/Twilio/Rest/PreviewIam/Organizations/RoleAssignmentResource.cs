...
namespace Twilio.Rest.PreviewIam.Organizations
{
    public class RoleAssignmentResource : Resource
    {
        ...
        private static BearerTokenRequest BuildCreateRequest(CreateRoleAssignmentOptions options, TwilioBearerTokenRestClient client)
        {
        ...
        public static RoleAssignmentResource Create(CreateRoleAssignmentOptions options, TwilioBearerTokenRestClient client = null)
        {
        ...
        public static async System.Threading.Tasks.Task<RoleAssignmentResource> CreateAsync(CreateRoleAssignmentOptions options, TwilioBearerTokenRestClient client = null)
        {
            client = client ?? TwilioOrgsTokenAuthClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of RoleAssignment </returns>
        private static BearerTokenRequest BuildDeleteRequest(DeleteRoleAssignmentOptions options, TwilioBearerTokenRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of RoleAssignment </returns>
        public static bool Delete(DeleteRoleAssignmentOptions options, TwilioBearerTokenRestClient client = null)
        {
            client = client ?? TwilioOrgsTokenAuthClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of RoleAssignment </returns>
        public static bool Delete(string pathOrganizationSid, string pathRoleAssignmentSid, TwilioBearerTokenRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of RoleAssignment </returns>
        public static async System.Threading.Tasks.Task<bool> DeleteAsync(string pathOrganizationSid, string pathRoleAssignmentSid, TwilioBearerTokenRestClient client = null)
        {
            var options = new DeleteRoleAssignmentOptions(pathOrganizationSid, pathRoleAssignmentSid) ;
        ...
        private static BearerTokenRequest BuildReadRequest(ReadRoleAssignmentOptions options, TwilioBearerTokenRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of RoleAssignment </returns>
        public static BearerTokenResourceSet<RoleAssignmentResource> Read(ReadRoleAssignmentOptions options, TwilioBearerTokenRestClient client = null)
        {
            client = client ?? TwilioOrgsTokenAuthClient.GetRestClient();
            var response = client.Request(BuildReadRequest(options, client));
            var page = Page<RoleAssignmentResource>.FromJson("content", response.Content);
            return new BearerTokenResourceSet<RoleAssignmentResource>(page, options, client);
        }
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of RoleAssignment </returns>
        public static async System.Threading.Tasks.Task<BearerTokenResourceSet<RoleAssignmentResource>> ReadAsync(ReadRoleAssignmentOptions options, TwilioBearerTokenRestClient client = null)
        {
            client = client ?? TwilioOrgsTokenAuthClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of RoleAssignment </returns>
        public static BearerTokenResourceSet<RoleAssignmentResource> Read(
                                                     string pathOrganizationSid,
                                                     int? pageSize = null,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of RoleAssignment </returns>
        public static async System.Threading.Tasks.Task<BearerTokenResourceSet<RoleAssignmentResource>> ReadAsync(
                                                                                             string pathOrganizationSid,
                                                                                             int? pageSize = null,
                                                                                             string identity = null,
                                                                                             string scope = null,
        ...
        public static Page<RoleAssignmentResource> GetPage(string targetUrl, TwilioBearerTokenRestClient client)
        {
            client = client ?? TwilioOrgsTokenAuthClient.GetRestClient();
        ...
        public static Page<RoleAssignmentResource> NextPage(Page<RoleAssignmentResource> page, TwilioBearerTokenRestClient client)
        {
            var request = new BearerTokenRequest(
                HttpMethod.Get,
        ...
        public static Page<RoleAssignmentResource> PreviousPage(Page<RoleAssignmentResource> page, TwilioBearerTokenRestClient client)
        {
            var request = new BearerTokenRequest(
                HttpMethod.Get,
