...
namespace Twilio.Rest.Numbers.V1
{
    public class EligibilityResource : Resource
    {
        ...
        public static async System.Threading.Tasks.Task<EligibilityResource> CreateAsync(CreateEligibilityOptions options, ITwilioRestClient client = null,  CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
