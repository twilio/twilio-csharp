...
namespace Twilio.Rest.Numbers.V1
{
    public class SigningRequestConfigurationResource : Resource
    {
        ...
        public static async System.Threading.Tasks.Task<SigningRequestConfigurationResource> CreateAsync(CreateSigningRequestConfigurationOptions options, ITwilioRestClient client = null,  CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of SigningRequestConfiguration </returns>
        public static async System.Threading.Tasks.Task<ResourceSet<SigningRequestConfigurationResource>> ReadAsync(ReadSigningRequestConfigurationOptions options, ITwilioRestClient client = null,  CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
