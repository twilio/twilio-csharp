...
namespace Twilio.Rest.Numbers.V2.RegulatoryCompliance
{
    ...
    public class SupportingDocumentResource : Resource
    {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of SupportingDocument </returns>
        public static ResourceSet<SupportingDocumentResource> Read(ReadSupportingDocumentOptions options,
                                                                   ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of SupportingDocument </returns>
        public static ResourceSet<SupportingDocumentResource> Read(int? pageSize = null,
                                                                   long? limit = null,
                                                                   ITwilioRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of SupportingDocument </returns>
        public static async System.Threading.Tasks.Task<ResourceSet<SupportingDocumentResource>> ReadAsync(int? pageSize = null,
                                                                                                           long? limit = null,
                                                                                                           ITwilioRestClient client = null)
        {
            var options = new ReadSupportingDocumentOptions(){PageSize = pageSize, Limit = limit};
        ...
        public static Page<SupportingDocumentResource> NextPage(Page<SupportingDocumentResource> page,
        ...
        public static Page<SupportingDocumentResource> PreviousPage(Page<SupportingDocumentResource> page,
                                                                    ITwilioRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
