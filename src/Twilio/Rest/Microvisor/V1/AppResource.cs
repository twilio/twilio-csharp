...
namespace Twilio.Rest.Microvisor.V1
{
    ...
    public class AppResource : Resource
    {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of App </returns>
        public static ResourceSet<AppResource> Read(int? pageSize = null,
                                                    long? limit = null,
                                                    ITwilioRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of App </returns>
        public static async System.Threading.Tasks.Task<ResourceSet<AppResource>> ReadAsync(int? pageSize = null,
                                                                                            long? limit = null,
                                                                                            ITwilioRestClient client = null)
        {
            var options = new ReadAppOptions(){PageSize = pageSize, Limit = limit};
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of App </returns>
        public static AppResource Fetch(string pathSid, ITwilioRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of App </returns>
        public static async System.Threading.Tasks.Task<AppResource> FetchAsync(string pathSid,
                                                                                ITwilioRestClient client = null)
        {
            var options = new FetchAppOptions(pathSid);
