...
namespace Twilio.Rest.Microvisor.V1.Device
{
    public class DeviceSecretResource : Resource
    {
        ...
        public static async System.Threading.Tasks.Task<DeviceSecretResource> CreateAsync(CreateDeviceSecretOptions options, ITwilioRestClient client = null,  CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of DeviceSecret </returns>
        public static async System.Threading.Tasks.Task<DeviceSecretResource> FetchAsync(FetchDeviceSecretOptions options, ITwilioRestClient client = null,  CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of DeviceSecret </returns>
        public static async System.Threading.Tasks.Task<ResourceSet<DeviceSecretResource>> ReadAsync(ReadDeviceSecretOptions options, ITwilioRestClient client = null,  CancellationToken cancellationToken = default)
        {
            client = client ?? TwilioClient.GetRestClient();
