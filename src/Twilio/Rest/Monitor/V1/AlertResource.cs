...
namespace Twilio.Rest.Monitor.V1
{
    public class AlertResource : Resource
    {
        ...
        ///<summary> The API version used when the alert was generated </summary> 
        ...
        ///<summary> The date and time when the alert was generated specified in ISO 8601 format </summary> 
        ...
        ///<summary> The error code for the condition that generated the alert </summary> 
        ...
        ///<summary> The URL of the page in our Error Dictionary with more information about the error condition </summary> 
        [JsonProperty("more_info")]
        public string MoreInfo { get; private set; }

        ///<summary> The method used by the request that generated the alert </summary> 
        [JsonProperty("request_method")]
        public Twilio.Http.HttpMethod RequestMethod { get; private set; }

        ///<summary> The URL of the request that generated the alert </summary> 
        [JsonProperty("request_url")]
        public string RequestUrl { get; private set; }

        ///<summary> The variables passed in the request that generated the alert </summary> 
        [JsonProperty("request_variables")]
        public string RequestVariables { get; private set; }

        ///<summary> The SID of the resource for which the alert was generated </summary> 
        [JsonProperty("resource_sid")]
        public string ResourceSid { get; private set; }

        ///<summary> The response body of the request that generated the alert </summary> 
        [JsonProperty("response_body")]
        public string ResponseBody { get; private set; }

        ///<summary> The response headers of the request that generated the alert </summary> 
        ...
        ///<summary> The request headers of the request that generated the alert </summary> 
        [JsonProperty("request_headers")]
        public string RequestHeaders { get; private set; }

        ///<summary> The SID of the service or resource that generated the alert </summary> 
