...
namespace Twilio.Rest.IpMessaging.V2.Service.Channel
{
    public class MessageResource : Resource
    {
        ...
        public static TwilioResponse<bool> DeleteWithHeaders(string pathServiceSid, string pathChannelSid, string pathSid, MessageResource.WebhookEnabledTypeEnum xTwilioWebhookEnabled = null, ITwilioRestClient client = null)
        {
            var options = new DeleteMessageOptions(pathServiceSid, pathChannelSid, pathSid)            { XTwilioWebhookEnabled = xTwilioWebhookEnabled }   ;
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<bool>> DeleteWithHeadersAsync(string pathServiceSid, string pathChannelSid, string pathSid, MessageResource.WebhookEnabledTypeEnum xTwilioWebhookEnabled = null, ITwilioRestClient client = null)
        {
            var options = new DeleteMessageOptions(pathServiceSid, pathChannelSid, pathSid)  { XTwilioWebhookEnabled = xTwilioWebhookEnabled };
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<MessageResource>> FetchWithHeadersAsync(string pathServiceSid, string pathChannelSid, string pathSid, ITwilioRestClient client = null)
        {
            var options = new FetchMessageOptions(pathServiceSid, pathChannelSid, pathSid){  };
