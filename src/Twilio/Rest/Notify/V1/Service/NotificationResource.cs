...
namespace Twilio.Rest.Notify.V1.Service
{
    public class NotificationResource : Resource
    {
        ...
        ///<summary> The list of identity values of the Users to notify </summary> 
        [JsonProperty("identities")]
        public List<string> Identities { get; private set; }

        ///<summary> The tags that select the Bindings to notify </summary> 
        [JsonProperty("tags")]
        public List<string> Tags { get; private set; }

        ///<summary> The list of Segments to notify </summary> 
        ...
        ///<summary> How long, in seconds, the notification is valid </summary> 
        [JsonProperty("ttl")]
        ...
        ///<summary> The name of the sound to be played for the notification </summary> 
        [JsonProperty("sound")]
        public string Sound { get; private set; }

        ///<summary> The actions to display for the notification </summary> 
        [JsonProperty("action")]
        public string Action { get; private set; }

        ///<summary> The custom key-value pairs of the notification's payload </summary> 
        [JsonProperty("data")]
        public object Data { get; private set; }

        ///<summary> The APNS-specific payload that overrides corresponding attributes in a generic payload for APNS Bindings </summary> 
        [JsonProperty("apn")]
        public object Apn { get; private set; }

        ///<summary> The GCM-specific payload that overrides corresponding attributes in generic payload for GCM Bindings </summary> 
        [JsonProperty("gcm")]
        public object Gcm { get; private set; }

        ///<summary> The FCM-specific payload that overrides corresponding attributes in generic payload for FCM Bindings </summary> 
        [JsonProperty("fcm")]
        public object Fcm { get; private set; }

        ///<summary> The SMS-specific payload that overrides corresponding attributes in generic payload for SMS Bindings </summary> 
        [JsonProperty("sms")]
