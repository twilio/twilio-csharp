...
namespace Twilio.Rest.Verify.V2.Service
{
    public class EntityResource : Resource
    {
        ...
        ///<summary> A string that uniquely identifies this Entity. </summary> 
        [JsonProperty("sid")]
        ...
        ///<summary> The date this Entity was created </summary> 
        [JsonProperty("date_created")]
        public DateTime? DateCreated { get; private set; }

        ///<summary> The date this Entity was updated </summary> 
