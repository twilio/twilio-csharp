...
namespace Twilio.Rest.Verify.V2.Service
{
    public class VerificationResource : Resource
    {
        ...
        /// <param name="customMessage"> The text of a custom message to use for the verification [DEPRECATED]. </param>
        ...
        /// <param name="templateSid"> The message [template](https://www.twilio.com/docs/verify/api/templates). If provided, will override the default template for the Service. SMS and Voice channels only. If the `Templates` parameter is also provided, `Templates` takes precedence over this parameter. </param>
        ...
        /// <param name="tags"> A string containing a JSON map of key value pairs of tags to be recorded as metadata for the message. The tags will also be included as part of the verification and message status event type payloads. The object may contain up to 10 tags. Keys and values can each be up to 128 characters in length. **This value should not contain PII.** </param>
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Verification </returns>
