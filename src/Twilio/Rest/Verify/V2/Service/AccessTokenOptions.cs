...
namespace Twilio.Rest.Verify.V2.Service
{
    ...
    public class CreateAccessTokenOptions : IOptions<AccessTokenResource>
    {
        ...
        /// <param name="pathServiceSid"> The unique SID identifier of the Service. </param>        /// <param name="identity"> The unique external identifier for the Entity of the Service. This identifier should be immutable, not PII, and generated by your external system, such as your user&#39;s UUID, GUID, or SID. </param>        /// <param name="factorType">  </param>
    ...
    public class FetchAccessTokenOptions : IOptions<AccessTokenResource>
    {
        ...
        /// <param name="pathServiceSid"> The unique SID identifier of the Service. </param>        /// <param name="pathSid"> A 34 character string that uniquely identifies this Access Token. </param>
