...
namespace Twilio.Rest.Verify.V2.Service.Entity
{
    public class NewFactorResource : Resource
    {
        ...
        ///<summary> A string that uniquely identifies this Factor. </summary> 
        [JsonProperty("sid")]
        ...
        ///<summary> Binding of the factor </summary> 
        [JsonProperty("binding")]
        public object Binding { get; private set; }

        ///<summary> The date this Factor was created </summary> 
        [JsonProperty("date_created")]
        public DateTime? DateCreated { get; private set; }

        ///<summary> The date this Factor was updated </summary> 
        ...
        ///<summary> Configurations for a `factor_type`. </summary> 
        [JsonProperty("config")]
        public object Config { get; private set; }

        ///<summary> Metadata of the factor. </summary> 
