...
namespace Twilio.Rest.Verify.V2.Service.Entity.Challenge
{
    public class NotificationResource : Resource
    {
        ...
        ///<summary> A string that uniquely identifies this Notification. </summary> 
        [JsonProperty("sid")]
        ...
        ///<summary> The date this Notification was created </summary> 
