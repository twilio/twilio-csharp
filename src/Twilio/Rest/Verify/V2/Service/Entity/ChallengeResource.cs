...
namespace Twilio.Rest.Verify.V2.Service.Entity
{
    public class ChallengeResource : Resource
    {
        ...
        ///<summary> A string that uniquely identifies this Challenge. </summary> 
        [JsonProperty("sid")]
        ...
        ///<summary> Factor Sid. </summary> 
        [JsonProperty("factor_sid")]
        public string FactorSid { get; private set; }

        ///<summary> The date this Challenge was created </summary> 
        [JsonProperty("date_created")]
        public DateTime? DateCreated { get; private set; }

        ///<summary> The date this Challenge was updated </summary> 
        [JsonProperty("date_updated")]
        public DateTime? DateUpdated { get; private set; }

        ///<summary> The date this Challenge was responded </summary> 
        [JsonProperty("date_responded")]
        public DateTime? DateResponded { get; private set; }

        ///<summary> The date-time when this Challenge expires </summary> 
        ...
        ///<summary> Details about the Challenge. </summary> 
        [JsonProperty("details")]
        public object Details { get; private set; }

        ///<summary> Hidden details about the Challenge </summary> 
        [JsonProperty("hidden_details")]
        public object HiddenDetails { get; private set; }

        ///<summary> Metadata of the challenge. </summary> 
