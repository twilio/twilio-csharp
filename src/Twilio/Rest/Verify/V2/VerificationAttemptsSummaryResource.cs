...
namespace Twilio.Rest.Verify.V2
{
    public class VerificationAttemptsSummaryResource : Resource
    {
        ...
        public static TwilioResponse<VerificationAttemptsSummaryResource> FetchWithHeaders(FetchVerificationAttemptsSummaryOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
            return new TwilioResponse<VerificationAttemptsSummaryResource>(resource, response.Headers, response.StatusCode);
        }
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<VerificationAttemptsSummaryResource>> FetchWithHeadersAsync(FetchVerificationAttemptsSummaryOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<VerificationAttemptsSummaryResource> FetchWithHeaders(
                    string verifyServiceSid = null, 
                    DateTime? dateCreatedAfter = null, 
                    DateTime? dateCreatedBefore = null, 
                    string country = null, 
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<VerificationAttemptsSummaryResource>> FetchWithHeadersAsync(string verifyServiceSid = null, DateTime? dateCreatedAfter = null, DateTime? dateCreatedBefore = null, string country = null, VerificationAttemptsSummaryResource.ChannelsEnum channel = null, string destinationPrefix = null, ITwilioRestClient client = null)
        {
            var options = new FetchVerificationAttemptsSummaryOptions(){ VerifyServiceSid = verifyServiceSid,DateCreatedAfter = dateCreatedAfter,DateCreatedBefore = dateCreatedBefore,Country = country,Channel = channel,DestinationPrefix = destinationPrefix };
