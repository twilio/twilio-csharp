...
namespace Twilio.Rest.Intelligence.V2
{
    public class TranscriptResource : Resource
    {
        ...
        public static TwilioResponse<TranscriptResource> CreateWithHeaders(CreateTranscriptOptions options, ITwilioRestClient client = null) 
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildCreateRequest(options, client));
            var resource = FromJson(response.Content);
            return new TwilioResponse<TranscriptResource>(resource, response.Headers, response.StatusCode);
        }

        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<TranscriptResource>> CreateWithHeadersAsync(CreateTranscriptOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildCreateRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<TranscriptResource> CreateWithHeaders(
            string serviceSid,
            object channel,
            string customerKey = null,
            DateTime? mediaStartTime = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<TranscriptResource>> CreateWithHeadersAsync(
            string serviceSid,
            object channel,
            string customerKey = null,
            DateTime? mediaStartTime = null,
        ...
        public static TwilioResponse<bool> DeleteWithHeaders(DeleteTranscriptOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildDeleteRequest(options, client));
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<bool>> DeleteWithHeadersAsync(DeleteTranscriptOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildDeleteRequest(options, client));
            var success = (int)response.StatusCode >= 200 && (int)response.StatusCode < 400;
        ...
        public static TwilioResponse<TranscriptResource> FetchWithHeaders(FetchTranscriptOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<TranscriptResource>> FetchWithHeadersAsync(FetchTranscriptOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildFetchRequest(options, client));
            var resource = FromJson(response.Content);
        ...
        public static TwilioResponse<TranscriptResource> FetchWithHeaders(
                    string pathSid, 
                ITwilioRestClient client = null)
        {
            var options = new FetchTranscriptOptions(pathSid){  };
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<TwilioResponse<TranscriptResource>> FetchWithHeadersAsync(string pathSid, ITwilioRestClient client = null)
        {
            var options = new FetchTranscriptOptions(pathSid){  };
        ...
        public static ResourceSetResponse<TranscriptResource> ReadWithHeaders(ReadTranscriptOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = client.Request(BuildReadRequest(options, client));
            var page = Page<TranscriptResource>.FromJson("transcripts", response.Content);
            var records = new ResourceSet<TranscriptResource>(page, options, client);
            return new ResourceSetResponse<TranscriptResource>(records, response.Headers, response.StatusCode);
        }

        public static ResourceSetResponse<TranscriptResource> ReadWithHeaders(
            string serviceSid = null,
            string beforeStartTime = null,
            string afterStartTime = null,
            string beforeDateCreated = null,
        ...
        #if !NET35
        public static async System.Threading.Tasks.Task<ResourceSetResponse<TranscriptResource>> ReadWithHeadersAsync(ReadTranscriptOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
            var response = await client.RequestAsync(BuildReadRequest(options, client));
