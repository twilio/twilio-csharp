...
namespace Twilio.Rest.Intelligence.V2
{
    ...
    public class FetchPrebuiltOperatorOptions : IOptions<PrebuiltOperatorResource>
    {
        ...
        public FetchPrebuiltOperatorOptions(string pathSid)
        {
            PathSid = pathSid;
        }
    ...
    public class ReadPrebuiltOperatorOptions : ReadOptions<PrebuiltOperatorResource>
    {
        ...
        public PrebuiltOperatorResource.AvailabilityEnum Availability { get; set; }
