...
namespace Twilio.Rest.Supersim.V1.NetworkAccessProfile
{
    ...
    public class NetworkAccessProfileNetworkResource : Resource
    {
        ...
        public static ResourceSet<NetworkAccessProfileNetworkResource> Read(ReadNetworkAccessProfileNetworkOptions options,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of NetworkAccessProfileNetwork </returns>
        public static ResourceSet<NetworkAccessProfileNetworkResource> Read(string pathNetworkAccessProfileSid,
                                                                            int? pageSize = null,
                                                                            long? limit = null,
                                                                            ITwilioRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of NetworkAccessProfileNetwork </returns>
        public static async System.Threading.Tasks.Task<ResourceSet<NetworkAccessProfileNetworkResource>> ReadAsync(string pathNetworkAccessProfileSid,
                                                                                                                    int? pageSize = null,
                                                                                                                    long? limit = null,
                                                                                                                    ITwilioRestClient client = null)
        {
        ...
        public static Page<NetworkAccessProfileNetworkResource> NextPage(Page<NetworkAccessProfileNetworkResource> page,
        ...
        public static Page<NetworkAccessProfileNetworkResource> PreviousPage(Page<NetworkAccessProfileNetworkResource> page,
                                                                             ITwilioRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of NetworkAccessProfileNetwork </returns>
        public static NetworkAccessProfileNetworkResource Fetch(FetchNetworkAccessProfileNetworkOptions options,
                                                                ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of NetworkAccessProfileNetwork </returns>
        public static NetworkAccessProfileNetworkResource Fetch(string pathNetworkAccessProfileSid,
                                                                string pathSid,
                                                                ITwilioRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of NetworkAccessProfileNetwork </returns>
        public static async System.Threading.Tasks.Task<NetworkAccessProfileNetworkResource> FetchAsync(string pathNetworkAccessProfileSid,
                                                                                                        string pathSid,
                                                                                                        ITwilioRestClient client = null)
        {
            var options = new FetchNetworkAccessProfileNetworkOptions(pathNetworkAccessProfileSid, pathSid);
