...
namespace Twilio.Rest.Supersim.V1.Sim
{
    public class BillingPeriodResource : Resource
    {
        ...
        ///<summary> The SID of the Account the Super SIM belongs to </summary> 
        ...
        ///<summary> The start time of the Billing Period </summary> 
        [JsonProperty("start_time")]
        public DateTime? StartTime { get; private set; }

        ///<summary> The end time of the Billing Period </summary> 
