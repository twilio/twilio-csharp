...
namespace Twilio.Rest.Video.V1
{
    public class CompositionSettingsResource : Resource
    {
        ...
        ///<summary> The URL of the AWS S3 bucket where the compositions are stored </summary> 
        [JsonProperty("aws_s3_url")]
        public Uri AwsS3Url { get; private set; }

        ///<summary> Whether all compositions are written to the aws_s3_url </summary> 
        ...
        ///<summary> Whether all compositions are stored in an encrypted form </summary> 
