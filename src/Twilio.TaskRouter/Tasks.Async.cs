...
namespace Twilio.TaskRouter
{
    public partial class TaskRouterClient
    {
        ...
        public virtual void AddTask(string workspaceSid, string attributes, string workflowSid, int? timeout, Action<Task> callback)
        {
        ...
        public virtual void DeleteTask(string workspaceSid, string taskSid, Action<DeleteStatus> callback)
        {
            ...
            request.Resource = "Accounts/{AccountSid}/Workspaces/{WorkspaceSid}/Tasks/{TaskSid}.json";
