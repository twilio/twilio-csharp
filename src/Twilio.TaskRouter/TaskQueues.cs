...
namespace Twilio.TaskRouter
{
    public partial class TaskRouterClient
    {
        ...
        public virtual TaskQueue AddTaskQueue(string workspaceSid, string friendlyName, string assignmentActivitySid, string reservationActivitySid)
        {
            ...
            request.Resource = "Workspaces/{WorkspaceSid}/TaskQueues.json";
        ...
        public virtual DeleteStatus DeleteTaskQueue(string workspaceSid, string taskQueueSid)
        {
            ...
            request.Resource = "Workspaces/{WorkspaceSid}/TaskQueues/{TaskQueueSid}.json";
        ...
        public virtual TaskQueue UpdateTaskQueue(string workspaceSid, string taskQueueSid, string friendlyName, string assignmentActivitySid, string reservationActivitySid, string targetWorkers)
        {
            Require.Argument("WorkspaceSid", workspaceSid);
            Require.Argument("TaskQueueSid", taskQueueSid);
