...
namespace Twilio
{
    public partial class TwilioRestClient
    {
        ...
        public virtual async Task<OutgoingCallerId> GetOutgoingCallerId(string outgoingCallerIdSid)
        {
            ...
            return await Execute<OutgoingCallerId>(request);
        }
        ...
        /// </summary>
        public virtual async Task<OutgoingCallerIdResult> ListOutgoingCallerIds()
        {
            return await ListOutgoingCallerIds(null, null, null, null);
        }
        ...
        /// <returns></returns>
        public virtual async Task<OutgoingCallerIdResult> ListOutgoingCallerIds(string phoneNumber, string friendlyName, int? pageNumber, int? count)
        {
            var request = new RestRequest();
            ...
            return await Execute<OutgoingCallerIdResult>(request);
        }
        ...
        public virtual async Task<ValidationRequestResult> AddOutgoingCallerId(string phoneNumber, string friendlyName, int? callDelay, string extension)
        {
            ...
            return await AddOutgoingCallerId(phoneNumber, options);
        }
        ...
        public virtual async Task<ValidationRequestResult> AddOutgoingCallerId(string phoneNumber, OutgoingCallerIdOptions options)
        {
            ...
            return await Execute<ValidationRequestResult>(request);
        }
        ...
        public virtual async Task<OutgoingCallerId> UpdateOutgoingCallerIdName(string outgoingCallerIdSid, string friendlyName)
        {
        ...
        public virtual async Task<DeleteStatus> DeleteOutgoingCallerId(string outgoingCallerIdSid)
        {
            Require.Argument("OutgoingCallerIdSid", outgoingCallerIdSid);
