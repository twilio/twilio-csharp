...
namespace Twilio
{
	public partial class TwilioRestClient
	{
        ...
        public virtual async Task<Account> GetAccount(string accountSid)
		{
			var request = new RestRequest();
			request.Resource = "Accounts/{AccountSid}.json";
		...
		/// </summary>
        public virtual async Task<AccountResult> ListSubAccounts()
		{
			var request = new RestRequest();
        ...
        public virtual async Task<AccountResult> ListSubAccounts(string friendlyName)
        {
            var request = new RestRequest();
            request.Resource = "Accounts.json";
        ...
        public virtual async Task<Account> CreateSubAccount(string friendlyName)
		{
        ...
        public virtual async Task<Account> ChangeSubAccountStatus(string subAccountSid, AccountStatus status)
		{
        ...
        public virtual async Task<Account> UpdateAccountName(string friendlyName)
		{
			var request = new RestRequest(Method.POST);
			request.Resource = "Accounts/{AccountSid}.json";
			request.AddParameter("FriendlyName", friendlyName);
