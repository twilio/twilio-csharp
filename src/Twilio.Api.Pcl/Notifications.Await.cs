...
namespace Twilio
{
	public partial class TwilioRestClient
	{
        ...
        public virtual async Task<Notification> GetNotification(string notificationSid)
		{
		...
		/// </summary>
        public virtual async Task<NotificationResult> ListNotifications()
		{
			return await ListNotifications(null, null, null, null);
		}
        ...
        public virtual async Task<NotificationResult> ListNotifications(int? log, DateTime? messageDate, int? pageNumber, int? count)
		{
			var request = new RestRequest();
        ...
        public virtual async Task<DeleteStatus> DeleteNotification(string notificationSid)
		{
