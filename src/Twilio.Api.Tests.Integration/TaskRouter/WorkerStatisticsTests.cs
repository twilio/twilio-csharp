...
namespace Twilio.Api.Tests.Integration
{
    ...
    public class WorkerStatisticsTests
    {
        ...
        private Mock<TwilioTaskRouterClient> mockClient;

        [SetUp]
        public void Setup()
        {
            mockClient = new Mock<TwilioTaskRouterClient>(Credentials.AccountSid, Credentials.AuthToken);
        ...
        public void ShouldGetWorkerStatistics()
        {
            ...
            Assert.AreEqual("Accounts/{AccountSid}/Workspaces/{WorkspaceSid}/Workers/{WorkerSid}/Statistics.json", savedRequest.Resource);
        ...
        public void ShouldListWorkersStatistics()
        {
            ...
            Assert.IsNotNull(savedRequest);
            Assert.AreEqual("Accounts/{AccountSid}/Workspaces/{WorkspaceSid}/Workers/Statistics.json", savedRequest.Resource);
            Assert.AreEqual(Method.GET, savedRequest.Method);
