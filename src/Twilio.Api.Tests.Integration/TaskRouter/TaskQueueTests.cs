...
namespace Twilio.Api.Tests.Integration
{
    ...
    public class TaskQueueTests
    {
        ...
        public void ShouldAddNewTaskQueue()
        {
            ...
            Assert.AreEqual("Accounts/{AccountSid}/Workspaces/{WorkspaceSid}/TaskQueues.json", savedRequest.Resource);
        ...
        public void ShouldDeleteTaskQueue()
        {
            ...
            Assert.IsNotNull(savedRequest);
            Assert.AreEqual("Accounts/{AccountSid}/Workspaces/{WorkspaceSid}/TaskQueues/{TaskQueueSid}.json", savedRequest.Resource);
