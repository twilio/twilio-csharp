...
namespace Twilio.Tests.Trunking.V1 {
    ...
    public class TrunkTest : TwilioTest {
        ...
        public void TestFetchRequest() {
            ...
            try {
                TrunkResource.Fetch("TRaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
        ...
        public void TestFetchResponse() {
            ...
            Assert.NotNull(TrunkResource.Fetch("TRaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
        ...
        public void TestDeleteRequest() {
            ...
            try {
                TrunkResource.Delete("TRaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
            twilioRestClient.Received().Request(request);
        }
        ...
        public void TestCreateRequest() {
            ...
            try {
                TrunkResource.Create().ExecuteAsync(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
            twilioRestClient.Received().Request(request);
        }
        ...
        public void TestReadRequest() {
            ...
            try {
                TrunkResource.Read().ExecuteAsync(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
            twilioRestClient.Received().Request(request);
        }
        ...
        public void TestReadFullResponse() {
            ...
            Assert.NotNull(TrunkResource.Read()
                  .ExecuteAsync(twilioRestClient));
        }
        ...
        public void TestUpdateRequest() {
            ...
            try {
                TrunkResource.Update("TRaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
            twilioRestClient.Received().Request(request);
        }
