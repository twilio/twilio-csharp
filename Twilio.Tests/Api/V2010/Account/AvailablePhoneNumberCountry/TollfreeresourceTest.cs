...
namespace Twilio.Tests.Api.V2010.Account.AvailablePhoneNumberCountry {
    ...
    public class TollFreeTest : TwilioTest {
        ...
        public void TestReadRequest() {
            ...
            try {
                TollFreeResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "US").Execute(twilioRestClient);
        ...
        public void TestReadFullResponse() {
            ...
            var response = TollFreeResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "US").Execute(twilioRestClient);
