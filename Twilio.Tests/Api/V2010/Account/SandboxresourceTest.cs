...
namespace Twilio.Tests.Api.V2010.Account {
    ...
    public class SandboxTest : TwilioTest {
        ...
        public void TestFetchRequest() {
            ...
            try {
                SandboxResource.Fetch("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
        ...
        public void TestFetchResponse() {
            ...
            Assert.NotNull(SandboxResource.Fetch("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")"
        ...
        public void TestUpdateRequest() {
            ...
            try {
                SandboxResource.Update("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
            twilioRestClient.Received().Request(request);
        }
