...
namespace Twilio.Tests.Api.V2010.Account.Call {
    ...
    public class FeedbackSummaryTest : TwilioTest {
        ...
        public void TestCreateRequest() {
            ...
            try {
                FeedbackSummaryResource.Create("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", MarshalConverter.LocalDateFromString("2008-01-02"), MarshalConverter.LocalDateFromString("2008-01-02")).ExecuteAsync(twilioRestClient);
        ...
        public void TestFetchRequest() {
            ...
            try {
                FeedbackSummaryResource.Fetch("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "FSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
            twilioRestClient.Received().Request(request);
        }
        ...
        public void TestFetchResponse() {
            ...
            Assert.NotNull(FeedbackSummaryResource.Fetch("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "FSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
        ...
        public void TestDeleteRequest() {
            ...
            try {
                FeedbackSummaryResource.Delete("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "FSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
            twilioRestClient.Received().Request(request);
        }
