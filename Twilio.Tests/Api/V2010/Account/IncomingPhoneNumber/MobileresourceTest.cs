...
namespace Twilio.Tests.Api.V2010.Account.IncomingPhoneNumber {
    ...
    public class MobileTest {
        ...
        public void TestReadRequest() {
            ...
            try {
                MobileResource.read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").execute();
        ...
        public void TestReadFullResponse() {
            ...
            assertNotNull(MobileResource.read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").execute());
        }
        ...
        public void TestCreateRequest() {
            ...
            try {
                MobileResource.create("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", new com.twilio.types.PhoneNumber("+987654321")).execute();
                fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
        }
