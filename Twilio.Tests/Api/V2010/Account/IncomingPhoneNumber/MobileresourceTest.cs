...
namespace Twilio.Tests.Api.V2010.Account.IncomingPhoneNumber {
    ...
    public class MobileTest : TwilioTest {
        ...
        public void TestReadRequest() {
            ...
            try {
                MobileResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
        ...
        public void TestReadFullResponse() {
            ...
            Assert.NotNull(MobileResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")"
        ...
        public void TestCreateRequest() {
            ...
            try {
                MobileResource.Create("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", new Twilio.Types.PhoneNumber("+987654321")).ExecuteAsync(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
            twilioRestClient.Received().Request(request);
        }
