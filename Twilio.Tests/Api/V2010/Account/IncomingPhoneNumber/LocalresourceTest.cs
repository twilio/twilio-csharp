...
namespace None {
    ...
    public class LocalTest {
        ...
        public void testReadRequest() {
            ...
            try {
                LocalResource.read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").execute();
        ...
        public void testReadFullResponse() {
            ...
            assertNotNull(LocalResource.read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").execute());
        }
        ...
        public void testCreateRequest() {
            ...
            try {
                LocalResource.create("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", new com.twilio.types.PhoneNumber("+987654321")).execute();
                fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
        }
