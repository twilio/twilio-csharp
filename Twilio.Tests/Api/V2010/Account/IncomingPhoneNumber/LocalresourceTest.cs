...
namespace Twilio.Tests.Api.V2010.Account.IncomingPhoneNumber {
    ...
    public class LocalTest : TwilioTest {
        ...
        public void TestReadRequest() {
            ...
            try {
                LocalResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Execute(twilioRestClient);
        ...
        public void TestReadFullResponse() {
            ...
            var response = LocalResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Execute(twilioRestClient);
        ...
        public void TestCreateRequest() {
            ...
            try {
                LocalResource.Create("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", new Twilio.Types.PhoneNumber("+987654321")).Execute(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (AggregateException ae) {
                ae.Handle((e) =>
                {
        ...
        public void TestCreateResponse() {
            ...
            var response = LocalResource.Create("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", new Twilio.Types.PhoneNumber("+987654321")).Execute(twilioRestClient);
            Assert.NotNull(response);
        }
    }
}