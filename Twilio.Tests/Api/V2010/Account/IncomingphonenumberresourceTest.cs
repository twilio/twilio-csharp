...
namespace None {
    ...
    public class IncomingPhoneNumberTest {
        ...
        public void testFetchRequest() {
            ...
            try {
                IncomingPhoneNumberResource.fetch("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").execute();
                fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
        }
        ...
        public void testReadRequest() {
            ...
            try {
                IncomingPhoneNumberResource.read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").execute();
                fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
        }
        ...
        public void testCreateRequest() {
            ...
            try {
                IncomingPhoneNumberResource.create("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", new com.twilio.types.PhoneNumber("+987654321")).execute();
                fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
        }
