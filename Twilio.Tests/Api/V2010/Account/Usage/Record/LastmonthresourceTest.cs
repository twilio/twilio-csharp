...
namespace Twilio.Tests.Api.V2010.Account.Usage.Record {
    ...
    public class LastMonthTest : TwilioTest {
        ...
        public void TestReadRequest() {
            ...
            try {
                LastMonthResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
        ...
        public void TestReadFullResponse() {
            ...
            Assert.NotNull(LastMonthResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")"
