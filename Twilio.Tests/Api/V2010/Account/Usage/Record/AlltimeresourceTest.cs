...
namespace Twilio.Tests.Api.V2010.Account.Usage.Record {
    ...
    public class AllTimeTest : TwilioTest {
        ...
        public void TestReadRequest() {
            ...
            try {
                AllTimeResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Execute(twilioRestClient);
        ...
        public void TestReadFullResponse() {
            ...
            var response = AllTimeResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Execute(twilioRestClient);
