...
namespace Twilio.Tests.Api.V2010.Account.Usage.Record {
    ...
    public class MonthlyTest : TwilioTest {
        ...
        public void TestReadRequest() {
            ...
            try {
                MonthlyResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Execute(twilioRestClient);
        ...
        public void TestReadFullResponse() {
            ...
            var response = MonthlyResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Execute(twilioRestClient);
