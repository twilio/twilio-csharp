...
namespace Twilio.Tests.Api.V2010.Account.Usage.Record {
    ...
    public class MonthlyTest : TwilioTest {
        ...
        public void TestReadRequest() {
            ...
            try {
                MonthlyResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
        ...
        public void TestReadFullResponse() {
            ...
            Assert.NotNull(MonthlyResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
