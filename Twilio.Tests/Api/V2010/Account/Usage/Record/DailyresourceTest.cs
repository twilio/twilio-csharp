...
namespace Twilio.Tests.Api.V2010.Account.Usage.Record {
    ...
    public class DailyTest : TwilioTest {
        ...
        public void TestReadRequest() {
            ...
            try {
                DailyResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
        ...
        public void TestReadFullResponse() {
            ...
            Assert.NotNull(DailyResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")"
