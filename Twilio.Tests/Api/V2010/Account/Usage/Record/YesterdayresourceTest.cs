...
namespace Twilio.Tests.Api.V2010.Account.Usage.Record {
    ...
    public class YesterdayTest : TwilioTest {
        ...
        public void TestReadRequest() {
            ...
            try {
                YesterdayResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
        ...
        public void TestReadFullResponse() {
            ...
            Assert.NotNull(YesterdayResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
