...
namespace Twilio.Tests.Api.V2010.Account.Usage {
    ...
    public class RecordTest : TwilioTest {
        ...
        public void TestReadRequest() {
            ...
            try {
                RecordResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
        ...
        public void TestReadFullResponse() {
            ...
            Assert.NotNull(RecordResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
