...
namespace Twilio.Tests.Api.V2010 {
    ...
    public class AccountTest : TwilioTest {
        ...
        public void TestCreateRequest() {
            ...
            try {
                AccountResource.Create().Execute(twilioRestClient);
        ...
        public void TestCreateResponse() {
            ...
            var response = AccountResource.Create().Execute(twilioRestClient);
        }
        ...
        public void TestFetchRequest() {
            ...
            try {
                AccountResource.Fetch("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Execute(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (AggregateException ae) {
                ae.Handle((e) =>
                {
        ...
        public void TestFetchResponse() {
            ...
            var response = AccountResource.Fetch("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Execute(twilioRestClient);
        ...
        public void TestReadRequest() {
            ...
            try {
                AccountResource.Read().Execute(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (AggregateException ae) {
                ae.Handle((e) =>
                {
        ...
        public void TestReadFullResponse() {
            ...
            var response = AccountResource.Read().Execute(twilioRestClient);
            Assert.NotNull(response);
        }
        ...
        public void TestUpdateRequest() {
            ...
            try {
                AccountResource.Update("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Execute(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (AggregateException ae) {
                ae.Handle((e) =>
                {
        ...
        public void TestUpdateResponse() {
            ...
            var response = AccountResource.Update("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Execute(twilioRestClient);
        }
    }
}