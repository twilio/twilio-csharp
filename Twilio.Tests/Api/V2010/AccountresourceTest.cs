...
namespace Twilio.Tests.Api.V2010 {
    ...
    public class AccountTest : TwilioTest {
        ...
        public void TestCreateRequest() {
            ...
            try {
                AccountResource.Create().ExecuteAsync(twilioRestClient);
        ...
        public void TestFetchRequest() {
            ...
            try {
                AccountResource.Fetch("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
            twilioRestClient.Received().Request(request);
        }
        ...
        public void TestFetchResponse() {
            ...
            Assert.NotNull(AccountResource.Fetch("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
        ...
        public void TestReadRequest() {
            ...
            try {
                AccountResource.Read().ExecuteAsync(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
            twilioRestClient.Received().Request(request);
        }
        ...
        public void TestReadFullResponse() {
            ...
            Assert.NotNull(AccountResource.Read()
                  .ExecuteAsync(twilioRestClient));
        }
        ...
        public void TestUpdateRequest() {
            ...
            try {
                AccountResource.Update("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
            twilioRestClient.Received().Request(request);
        }
