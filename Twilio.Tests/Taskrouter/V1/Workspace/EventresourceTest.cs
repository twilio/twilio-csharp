...
namespace Twilio.Tests.Taskrouter.V1.Workspace {
    ...
    public class EventTest : TwilioTest {
        ...
        public void TestFetchRequest() {
            ...
            try {
                EventResource.Fetch("WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "EVaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
        ...
        public void TestFetchResponse() {
            ...
            Assert.NotNull(EventResource.Fetch("WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "EVaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
        ...
        public void TestReadRequest() {
            ...
            try {
                EventResource.Read("WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
            twilioRestClient.Received().Request(request);
        }
        ...
        public void TestReadFullResponse() {
            ...
            Assert.NotNull(EventResource.Read("WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
                  .ExecuteAsync(twilioRestClient));
        }
