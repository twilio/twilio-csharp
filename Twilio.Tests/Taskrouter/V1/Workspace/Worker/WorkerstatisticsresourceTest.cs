...
namespace Twilio.Tests.Taskrouter.V1.Workspace.Worker {
    ...
    public class WorkerStatisticsTest : TwilioTest {
        ...
        public void TestFetchRequest() {
            ...
            try {
                WorkerStatisticsResource.Fetch("WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "WKaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
        ...
        public void TestFetchResponse() {
            ...
            Assert.NotNull(WorkerStatisticsResource.Fetch("WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "WKaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
