...
namespace Twilio.Tests.Taskrouter.V1.Workspace.Worker {
    ...
    public class WorkersStatisticsTest : TwilioTest {
        ...
        public void TestFetchRequest() {
            ...
            try {
                WorkersStatisticsResource.Fetch("WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
        ...
        public void TestFetchResponse() {
            ...
            Assert.NotNull(WorkersStatisticsResource.Fetch("WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")"
