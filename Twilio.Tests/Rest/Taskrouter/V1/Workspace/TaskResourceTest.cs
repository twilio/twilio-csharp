...
namespace Twilio.Tests.Rest.Taskrouter.V1.Workspace 
{
    ...
    public class TaskTest : TwilioTest 
    {
        ...
        public void TestCreateRequest()
        {
            ...
            try
            {
                TaskResource.Creator("WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "Attributes", "WWaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Create(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (AggregateException ae)
            {
        ...
        public void TestCreateResponse()
        {
            ...
            var response = TaskResource.Creator("WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "Attributes", "WWaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Create(twilioRestClient);
            Assert.NotNull(response);
        }
    }
}