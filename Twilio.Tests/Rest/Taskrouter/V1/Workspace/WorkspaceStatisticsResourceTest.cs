...
namespace Twilio.Tests.Rest.Taskrouter.V1.Workspace 
{
    ...
    public class WorkspaceStatisticsTest : TwilioTest 
    {
        ...
        public void TestFetchRequest()
        {
            ...
            try
            {
                WorkspaceStatisticsResource.Fetcher("WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Fetch(twilioRestClient);
        ...
        public void TestFetchResponse()
        {
            ...
            var response = WorkspaceStatisticsResource.Fetcher("WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Fetch(twilioRestClient);
