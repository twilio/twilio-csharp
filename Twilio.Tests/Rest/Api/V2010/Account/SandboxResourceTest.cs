...
namespace Twilio.Tests.Rest.Api.V2010.Account {
    ...
    public class SandboxTest : TwilioTest {
        ...
        public void TestFetchRequest() {
            ...
            try {
                SandboxResource.Fetcher("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Fetch(twilioRestClient);
        ...
        public void TestFetchResponse() {
            ...
            var response = SandboxResource.Fetcher("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Fetch(twilioRestClient);
        ...
        public void TestUpdateRequest() {
            ...
            try {
                SandboxResource.Updater("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Update(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (AggregateException ae) {
                ae.Handle((e) =>
                {
        ...
        public void TestUpdateResponse() {
            ...
            var response = SandboxResource.Updater("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Update(twilioRestClient);
            Assert.NotNull(response);
        }
    }
}