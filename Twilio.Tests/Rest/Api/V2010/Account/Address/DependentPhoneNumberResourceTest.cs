...
namespace Twilio.Tests.Rest.Api.V2010.Account.Address 
{
    ...
    public class DependentPhoneNumberTest : TwilioTest 
    {
        ...
        public void TestReadRequest()
        {
            ...
            try
            {
                DependentPhoneNumberResource.Reader("ADaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Read(twilioRestClient);
        ...
        public void TestReadFullResponse()
        {
            ...
            var response = DependentPhoneNumberResource.Reader("ADaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Read(twilioRestClient);
