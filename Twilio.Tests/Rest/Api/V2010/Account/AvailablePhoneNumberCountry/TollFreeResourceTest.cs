...
namespace Twilio.Tests.Rest.Api.V2010.Account.AvailablePhoneNumberCountry {
    ...
    public class TollFreeTest : TwilioTest {
        ...
        public void TestReadRequest() {
            ...
            try {
                TollFreeResource.Reader("US", accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Read(twilioRestClient);
        ...
        public void TestReadFullResponse() {
            ...
            var response = TollFreeResource.Reader("US", accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Read(twilioRestClient);
