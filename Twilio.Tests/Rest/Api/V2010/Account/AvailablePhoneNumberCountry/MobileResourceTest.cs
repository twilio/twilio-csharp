...
namespace Twilio.Tests.Rest.Api.V2010.Account.AvailablePhoneNumberCountry 
{
    ...
    public class MobileTest : TwilioTest 
    {
        ...
        public void TestReadRequest()
        {
            ...
            try
            {
                MobileResource.Reader("US", accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Read(twilioRestClient);
        ...
        public void TestReadFullResponse()
        {
            ...
            var response = MobileResource.Reader("US", accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Read(twilioRestClient);
