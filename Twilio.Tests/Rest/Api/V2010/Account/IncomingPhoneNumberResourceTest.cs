...
namespace Twilio.Tests.Rest.Api.V2010.Account {
    ...
    public class IncomingPhoneNumberTest : TwilioTest {
        ...
        public void TestUpdateRequest() {
            ...
            try {
                IncomingPhoneNumberResource.Updater("PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", ownerAccountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Update(twilioRestClient);
        ...
        public void TestUpdateResponse() {
            ...
            var response = IncomingPhoneNumberResource.Updater("PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", ownerAccountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Update(twilioRestClient);
        ...
        public void TestFetchRequest() {
            ...
            try {
                IncomingPhoneNumberResource.Fetcher("PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", ownerAccountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Fetch(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (AggregateException ae) {
                ae.Handle((e) =>
                {
        ...
        public void TestFetchResponse() {
            ...
            var response = IncomingPhoneNumberResource.Fetcher("PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", ownerAccountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Fetch(twilioRestClient);
            Assert.NotNull(response);
        }
        ...
        public void TestDeleteRequest() {
            ...
            try {
                IncomingPhoneNumberResource.Deleter("PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", ownerAccountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Delete(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (AggregateException ae) {
                ae.Handle((e) =>
                {
        ...
        public void TestReadRequest() {
            ...
            try {
                IncomingPhoneNumberResource.Reader(ownerAccountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Read(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (AggregateException ae) {
                ae.Handle((e) =>
                {
        ...
        public void TestReadFullResponse() {
            ...
            var response = IncomingPhoneNumberResource.Reader(ownerAccountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Read(twilioRestClient);
            Assert.NotNull(response);
        }
        ...
        public void TestCreateRequest() {
            ...
            try {
                IncomingPhoneNumberResource.Creator(new Twilio.Types.PhoneNumber("+987654321"), ownerAccountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Create(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (AggregateException ae) {
                ae.Handle((e) =>
                {
        ...
        public void TestCreateResponse() {
            ...
            var response = IncomingPhoneNumberResource.Creator(new Twilio.Types.PhoneNumber("+987654321"), ownerAccountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Create(twilioRestClient);
            Assert.NotNull(response);
        }
    }
}