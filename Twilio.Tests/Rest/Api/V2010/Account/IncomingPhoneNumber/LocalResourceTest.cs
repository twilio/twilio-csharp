...
namespace Twilio.Tests.Rest.Api.V2010.Account.IncomingPhoneNumber 
{
    ...
    public class LocalTest : TwilioTest 
    {
        ...
        public void TestReadRequest()
        {
            ...
            try
            {
                LocalResource.Reader().Read(twilioRestClient);
        ...
        public void TestReadFullResponse()
        {
            ...
            var response = LocalResource.Reader().Read(twilioRestClient);
        ...
        public void TestCreateRequest()
        {
            ...
            try
            {
                LocalResource.Creator(new Twilio.Types.PhoneNumber("+987654321")).Create(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (AggregateException ae)
            {
        ...
        public void TestCreateResponse()
        {
            ...
            var response = LocalResource.Creator(new Twilio.Types.PhoneNumber("+987654321")).Create(twilioRestClient);
            Assert.NotNull(response);
        }
    }
}