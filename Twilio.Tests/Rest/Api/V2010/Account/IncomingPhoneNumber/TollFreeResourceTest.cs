...
namespace Twilio.Tests.Rest.Api.V2010.Account.IncomingPhoneNumber {
    ...
    public class TollFreeTest : TwilioTest {
        ...
        public void TestReadRequest() {
            ...
            try {
                TollFreeResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Execute(twilioRestClient);
        ...
        public void TestReadFullResponse() {
            ...
            var response = TollFreeResource.Read("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Execute(twilioRestClient);
        ...
        public void TestCreateRequest() {
            ...
            try {
                TollFreeResource.Create("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", new Twilio.Types.PhoneNumber("+987654321")).Execute(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (AggregateException ae) {
                ae.Handle((e) =>
                {
        ...
        public void TestCreateResponse() {
            ...
            var response = TollFreeResource.Create("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", new Twilio.Types.PhoneNumber("+987654321")).Execute(twilioRestClient);
            Assert.NotNull(response);
        }
    }
}