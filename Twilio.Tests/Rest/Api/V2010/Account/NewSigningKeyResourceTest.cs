...
namespace Twilio.Tests.Rest.Api.V2010.Account 
{
    ...
    public class NewSigningKeyTest : TwilioTest 
    {
        ...
        public void TestCreateRequest()
        {
            ...
            try
            {
                NewSigningKeyResource.Creator(accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Create(twilioRestClient);
        ...
        public void TestCreateResponse()
        {
            ...
            var response = NewSigningKeyResource.Creator(accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Create(twilioRestClient);
