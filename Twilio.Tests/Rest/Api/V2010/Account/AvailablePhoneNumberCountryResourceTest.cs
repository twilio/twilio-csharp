...
namespace Twilio.Tests.Rest.Api.V2010.Account 
{
    ...
    public class AvailablePhoneNumberCountryTest : TwilioTest 
    {
        ...
        public void TestReadRequest()
        {
            ...
            try
            {
                AvailablePhoneNumberCountryResource.Reader(accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Read(twilioRestClient);
        ...
        public void TestReadFullResponse()
        {
            ...
            var response = AvailablePhoneNumberCountryResource.Reader(accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Read(twilioRestClient);
        ...
        public void TestFetchRequest()
        {
            ...
            try
            {
                AvailablePhoneNumberCountryResource.Fetcher("US", accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Fetch(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (AggregateException ae)
            {
        ...
        public void TestFetchResponse()
        {
            ...
            var response = AvailablePhoneNumberCountryResource.Fetcher("US", accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Fetch(twilioRestClient);
            Assert.NotNull(response);
        }
    }
}