...
namespace Twilio.Tests.Rest.Api.V2010.Account {
    ...
    public class AvailablePhoneNumberCountryTest : TwilioTest {
        ...
        public void TestReadRequest() {
            ...
            try {
                AvailablePhoneNumberCountryResource.Reader("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Read(twilioRestClient);
        ...
        public void TestReadFullResponse() {
            ...
            var response = AvailablePhoneNumberCountryResource.Reader("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Read(twilioRestClient);
        ...
        public void TestFetchRequest() {
            ...
            try {
                AvailablePhoneNumberCountryResource.Fetcher("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "US").Fetch(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (AggregateException ae) {
                ae.Handle((e) =>
                {
        ...
        public void TestFetchResponse() {
            ...
            var response = AvailablePhoneNumberCountryResource.Fetcher("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "US").Fetch(twilioRestClient);
            Assert.NotNull(response);
        }
    }
}