...
namespace Twilio.Tests.Rest.Api.V2010.Account {
    ...
    public class NewKeyTest : TwilioTest {
        ...
        public void TestCreateRequest() {
            ...
            try {
                NewKeyResource.Creator("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Create(twilioRestClient);
        ...
        public void TestCreateResponse() {
            ...
            var response = NewKeyResource.Creator("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Create(twilioRestClient);
