...
namespace Twilio.Tests.Rest.Api.V2010.Account.Usage {
    ...
    public class RecordTest : TwilioTest {
        ...
        public void TestReadRequest() {
            ...
            try {
                RecordResource.Reader(accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Read(twilioRestClient);
        ...
        public void TestReadFullResponse() {
            ...
            var response = RecordResource.Reader(accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Read(twilioRestClient);
