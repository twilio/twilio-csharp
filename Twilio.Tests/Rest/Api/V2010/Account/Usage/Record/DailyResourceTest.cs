...
namespace Twilio.Tests.Rest.Api.V2010.Account.Usage.Record 
{
    ...
    public class DailyTest : TwilioTest 
    {
        ...
        public void TestReadRequest()
        {
            ...
            try
            {
                DailyResource.Reader(accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Read(twilioRestClient);
        ...
        public void TestReadFullResponse()
        {
            ...
            var response = DailyResource.Reader(accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Read(twilioRestClient);
