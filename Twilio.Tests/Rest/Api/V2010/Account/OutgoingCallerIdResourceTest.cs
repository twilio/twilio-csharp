...
namespace Twilio.Tests.Rest.Api.V2010.Account 
{
    ...
    public class OutgoingCallerIdTest : TwilioTest 
    {
        ...
        public void TestFetchRequest()
        {
            ...
            try
            {
                OutgoingCallerIdResource.Fetcher("PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Fetch(twilioRestClient);
        ...
        public void TestFetchResponse()
        {
            ...
            var response = OutgoingCallerIdResource.Fetcher("PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Fetch(twilioRestClient);
        ...
        public void TestUpdateRequest()
        {
            ...
            try
            {
                OutgoingCallerIdResource.Updater("PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Update(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (AggregateException ae)
            {
        ...
        public void TestUpdateResponse()
        {
            ...
            var response = OutgoingCallerIdResource.Updater("PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Update(twilioRestClient);
            Assert.NotNull(response);
        }
        ...
        public void TestDeleteRequest()
        {
            ...
            try
            {
                OutgoingCallerIdResource.Deleter("PNaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Delete(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (AggregateException ae)
            {
        ...
        public void TestReadRequest()
        {
            ...
            try
            {
                OutgoingCallerIdResource.Reader().Read(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (AggregateException ae)
            {
        ...
        public void TestReadFullResponse()
        {
            ...
            var response = OutgoingCallerIdResource.Reader().Read(twilioRestClient);
            Assert.NotNull(response);
        }
