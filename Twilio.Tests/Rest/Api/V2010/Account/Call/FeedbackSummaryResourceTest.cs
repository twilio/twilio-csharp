...
namespace Twilio.Tests.Rest.Api.V2010.Account.Call {
    ...
    public class FeedbackSummaryTest : TwilioTest {
        ...
        public void TestCreateRequest() {
            ...
            try {
                FeedbackSummaryResource.Creator(MarshalConverter.DateTimeFromString("2008-01-02"), MarshalConverter.DateTimeFromString("2008-01-02"), accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Create(twilioRestClient);
        ...
        public void TestCreateResponse() {
            ...
            var response = FeedbackSummaryResource.Creator(MarshalConverter.DateTimeFromString("2008-01-02"), MarshalConverter.DateTimeFromString("2008-01-02"), accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Create(twilioRestClient);
        ...
        public void TestFetchRequest() {
            ...
            try {
                FeedbackSummaryResource.Fetcher("FSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Fetch(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (AggregateException ae) {
                ae.Handle((e) =>
                {
        ...
        public void TestFetchResponse() {
            ...
            var response = FeedbackSummaryResource.Fetcher("FSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Fetch(twilioRestClient);
            Assert.NotNull(response);
        }
        ...
        public void TestDeleteRequest() {
            ...
            try {
                FeedbackSummaryResource.Deleter("FSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", accountSid: "ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Delete(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (AggregateException ae) {
                ae.Handle((e) =>
                {
