...
namespace Twilio.Tests.Rest.Api.V2010 
{
    ...
    public class AccountTest : TwilioTest 
    {
        ...
        public void TestFetchRequest()
        {
            ...
            try
            {
                AccountResource.Fetcher().Fetch(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (AggregateException ae)
            {
        ...
        public void TestFetchResponse()
        {
            ...
            var response = AccountResource.Fetcher().Fetch(twilioRestClient);
            Assert.NotNull(response);
        }
        ...
        public void TestUpdateRequest()
        {
            ...
            try
            {
                AccountResource.Updater().Update(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            }
            catch (AggregateException ae)
            {
        ...
        public void TestUpdateResponse()
        {
            ...
            var response = AccountResource.Updater().Update(twilioRestClient);
            Assert.NotNull(response);
        }
    }
}