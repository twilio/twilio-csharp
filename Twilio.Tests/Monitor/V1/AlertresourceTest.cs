...
namespace Twilio.Tests.Monitor.V1 {
    ...
    public class AlertTest : TwilioTest {
        ...
        public void TestFetchRequest() {
            ...
            try {
                AlertResource.Fetch("NOaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
        ...
        public void TestFetchResponse() {
            ...
            Assert.NotNull(AlertResource.Fetch("NOaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")"
        ...
        public void TestDeleteRequest() {
            ...
            try {
                AlertResource.Delete("NOaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").ExecuteAsync(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
            twilioRestClient.Received().Request(request);
        }
        ...
        public void TestReadRequest() {
            ...
            try {
                AlertResource.Read().ExecuteAsync(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (TwilioException e) {}
            twilioRestClient.Received().Request(request);
        }
        ...
        public void TestReadFullResponse() {
            ...
            Assert.NotNull(AlertResource.Read()"
                  .ExecuteAsync(twilioRestClient));
        }
