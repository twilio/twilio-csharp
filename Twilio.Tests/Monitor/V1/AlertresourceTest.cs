...
namespace Twilio.Tests.Monitor.V1 {
    ...
    public class AlertTest : TwilioTest {
        ...
        public void TestFetchRequest() {
            ...
            try {
                AlertResource.Fetch("NOaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Execute(twilioRestClient);
        ...
        public void TestFetchResponse() {
            ...
            var response = AlertResource.Fetch("NOaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Execute(twilioRestClient);
        ...
        public void TestDeleteRequest() {
            ...
            try {
                AlertResource.Delete("NOaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").Execute(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (AggregateException ae) {
                ae.Handle((e) =>
                {
        ...
        public void TestReadRequest() {
            ...
            try {
                AlertResource.Read().Execute(twilioRestClient);
                Assert.Fail("Expected TwilioException to be thrown for 500");
            } catch (AggregateException ae) {
                ae.Handle((e) =>
                {
        ...
        public void TestReadFullResponse() {
            ...
            var response = AlertResource.Read().Execute(twilioRestClient);
            Assert.NotNull(response);
        }
