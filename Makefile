...
cover:
	dotnet sonarscanner begin /k:"twilio_twilio-csharp" /d:sonar.host.url=https://sonarcloud.io /o:"twilio" /d:sonar.login="${{ secrets.SONAR_TOKEN }}" /d:sonar.language="cs" /d:sonar.exclusions="src/Twilio/Rest/**/*.*,test/Twilio.Test/**/*.*" /d:sonar.cs.opencover.reportsPaths="test/lcov.net451.opencover.xml"
