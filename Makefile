...
cover:
	dotnet sonarscanner begin /k:"$(PROJECT_NAME)" /o:"twilio" /d:sonar.host.url=https://sonarcloud.io /d:sonar.login="${SONAR_TOKEN}"  /d:sonar.language="cs" /d:sonar.exclusions="$(SONAR_EXCLUSIONS)" /d:sonar.cs.opencover.reportsPaths="test/lcov.net451.opencover.xml"
